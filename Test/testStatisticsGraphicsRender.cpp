...
int main(int argc, char** argv) {
  ...
  GraphicStatisticsForegroundPtr statfg = GraphicStatisticsForeground::create();
  ...
  statfg->addElement(RenderAction::statDrawTime, GraphicStatisticsForeground::OSG_ANALOG,
      Vec2f(0.0, 0.0), Vec2f(-1.0, 0.25), highColor, lowColor, currentColor, 0.0, 0.0,
      GraphicStatisticsForeground::OSG_RECIPROC | GraphicStatisticsForeground::OSG_OVERFLOW_RESIZE |
          GraphicStatisticsForeground::OSG_SMOOTH,
      100, "FPS");
  statfg->addElement(RenderAction::statDrawTime, GraphicStatisticsForeground::OSG_BAR,
      //  GraphicStatisticsForeground::OSG_ANALOG,
      Vec2f(0.0, -1.0), Vec2f(0.4, 0.2), highColor, lowColor, currentColor, 0.0, 0.0,
      GraphicStatisticsForeground::OSG_RECIPROC | GraphicStatisticsForeground::OSG_OVERFLOW_RESIZE |
          GraphicStatisticsForeground::OSG_SMOOTH,
      100, "FPS");
  statfg->addElement(RenderAction::statDrawTime, GraphicStatisticsForeground::OSG_LINE_CHART,
      Vec2f(-1.0, 0.0), Vec2f(0.4, 0.2), highColor, lowColor, currentColor, 0.0, 0.0,
      GraphicStatisticsForeground::OSG_RECIPROC | GraphicStatisticsForeground::OSG_OVERFLOW_RESIZE |
          GraphicStatisticsForeground::OSG_SMOOTH | GraphicStatisticsForeground::OSG_ENABLE_POINTS |
          GraphicStatisticsForeground::OSG_MAX_TEXT | GraphicStatisticsForeground::OSG_MIN_TEXT,
      100, "FPS");

  statfg->addElement(RenderAction::statDrawTime, GraphicStatisticsForeground::OSG_CHART,
      Vec2f(-1.0, -1.0), Vec2f(0.4, 0.2), highColor, lowColor, currentColor, 0.0, 0.0,
      GraphicStatisticsForeground::OSG_RECIPROC | GraphicStatisticsForeground::OSG_OVERFLOW_RESIZE |
          GraphicStatisticsForeground::OSG_SMOOTH,
      100, "FPS");
