...
TransformPtr _tree1_trans, _tree2_trans, _tree3_trans, _tree4_trans, _tree5_trans, _tree6_trans,
    _tree7_trans, _tree8_trans, _tree9_trans;
...
int main(int argc, char** argv) {
  ...
  TransformPtr _stone_trans1, _stone_trans2, _stone_trans3, _stone_trans4, _stone_trans5,
      _stone_trans6, _stone_trans7, _stone_trans8, _stone_trans9;
  ...
  // can be 0.0 ... 1.0. ShadowSmoothness also used to define the light size for PCSS_SHADOW_MAP
...
void Animate() {
  ...
  beginEditCP(dir2_trans);
  {
    dir2_trans->getMatrix().setTranslate(
        -40.0 * sin(rotb), -40.0 * cos(rotb), 50.0 + 25.0 * sin(rotd));
  }
  endEditCP(dir2_trans);
