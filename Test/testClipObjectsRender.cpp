...
Test clipTests[] = {{0, "No Clipping      "}, {1, "Intersect mode   "}, {2, "Subtract mode    "}};
...
#if 1
    beginEditCP(
        clipObjects, DVRClipObjects::ClipModeFieldMask | DVRClipObjects::ClipObjectsFieldMask);
...
NodePtr createClipObjects() {
  ...
  GeometryPtr cl[] = {makeBoxGeo(4, 4, 4, 2, 2, 2), makeSphereGeo(2, 2.5),
