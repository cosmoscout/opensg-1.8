...
void setupRegComb(Matrix& m, bool usetex) {
  ...
  rchunk->setCombinerRGB(0, source, GL_UNSIGNED_IDENTITY_NV, GL_RGB, // variable A
  ...
  rchunk->setCombinerRGB(1, source, GL_UNSIGNED_IDENTITY_NV, GL_RGB, // variable A
      GL_CONSTANT_COLOR0_NV, GL_EXPAND_NORMAL_NV, GL_RGB,            // variable B
  ...
  rchunk->setCombinerRGB(2, source, GL_UNSIGNED_IDENTITY_NV, GL_RGB, // variable A
  ...
  //
  rchunk->setFinalCombiner(GL_CONSTANT_COLOR0_NV, GL_UNSIGNED_IDENTITY_NV, GL_RGB, // variable A
...
int main(int argc, char** argv) {
  ...
  UInt8 imgdata1[] = {255, 0, 0, 0, 255, 0, 0, 0, 255, 255, 255, 255};
