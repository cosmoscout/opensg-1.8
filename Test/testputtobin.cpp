...
int main(int argc, char** argv) {
  ...
  OSG::UChar8 img[2 * 2 * 3] = {11, 12, 13, 21, 22, 23, 31, 32, 33, 41, 42, 43};

  OSG::ImagePtr pImage = OSG::Image::create();
  pImage->set(OSG::Image::OSG_RGB_PF, 2, 2, 1, 1, 1, 0.0, img);
  ...
  if (sfimager.getValue()->getWidth() != 2 || sfimager.getValue()->getHeight() != 2)
