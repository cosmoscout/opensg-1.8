...
int main(int argc, char** argv) {
  ...
  // share->setIncludes("Material, TextureChunk"); // this one just shares equal materials and
  // texture chunks. share->setExcludes("GeoPTypesUI8, GeoPLengthsUI32, GeoIndicesUI32,
  // GeoPositions3f, GeoNormals3f, GeoTexCoords2f"); // share all except some geo properties.
