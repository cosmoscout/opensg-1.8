...
void addPort(Pnt3f* vpproj, Pnt4f vppos, bool left, ViewportPtr v, NodePtr projgeo, NodePtr tnode,
    NodePtr root, BackgroundPtr back, ProjectionCameraDecoratorPtr& deco, TextureChunkPtr& tex) {
  ...
  texs->push_back(
      Vec2f((vppos[2] - vppos[0]) / (Real32)imgw, (vppos[3] - vppos[1]) / (Real32)imgh));
...
int main(int argc, char** argv) {
  ...
  glutInitDisplayMode(GLUT_RGB | GLUT_DEPTH | GLUT_DOUBLE | (stereobuffer ? GLUT_STEREO : 0));
  ...
  Pnt3f vpproj[3][4] = {
      {Pnt3f(-166.735, -146.218, -264.509), Pnt3f(166.735, -146.218, -264.509),
          Pnt3f(166.735, 140.118, -295.97), Pnt3f(-166.735, 140.118, -295.97)},
      {Pnt3f(118.215, -146.218, -289.467), Pnt3f(312.146, -146.218, -18.187),
          Pnt3f(337.739, 140.118, -36.4828), Pnt3f(143.808, 140.118, -307.763)},
      {Pnt3f(-312.146, -146.218, -18.187), Pnt3f(-118.215, -146.218, -289.467),
          Pnt3f(-143.808, 140.118, -307.763), Pnt3f(-337.739, 140.118, -36.4828)},
  };
#endif
  ...
  NodePtr projgeoleft = Node::create(), projgeoright = Node::create();
  ...
  if (!stereobuffer) {
    for (i = 0, ideco = 0; i < nplanes; ++i, ++ideco) {
      ...
      addPort(vpproj[i], vppos[i], true, v, projgeoleft, tnode, vp->getRoot(), vp->getBackground(),
    ...
    for (i = 0, ideco = 0; i < nplanes; ++i, ++ideco) {
      ...
      addPort(vpproj[i], vppos[i], false, v, projgeoright, tnode, vp->getRoot(),
          vp->getBackground(), decos[ideco], textures[ideco]);
