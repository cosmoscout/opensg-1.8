...
int main(int argc, char** argv) {
  ...
  if (argc > 1) {
    ...
    UChar8 cubedata[] = {0, 255, 255, 0, 128, 128, 0, 64, 64, 255, 255, 255, 255, 0, 255, 128, 0,
        128, 64, 0, 64, 255, 255, 255, 255, 255, 0, 128, 128, 0, 64, 64, 0, 255, 255, 255, 0, 0,
        255, 0, 0, 128, 0, 0, 64, 255, 255, 255, 0, 255, 0, 0, 128, 0, 0, 64, 0, 255, 255, 255, 255,
        0, 0, 128, 0, 0, 64, 0, 0, 255, 255, 255};

    cubeimage = Image::create();
    beginEditCP(cubeimage);
    cubeimage->set(
        Image::OSG_RGB_PF, 2, 2, 1, 1, 1, 0, cubedata, Image::OSG_UINT8_IMAGEDATA, true, 6);
    endEditCP(cubeimage);
    is_cube = true;
  }
  ...
  traverse(scene, osgTypedFunctionFunctor1CPtrRef<Action::ResultE, NodePtr>(setMaterial));
