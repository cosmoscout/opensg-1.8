...
void key(unsigned char key, int x, int y) {
  ...
  case 'r':
    ...
    break;
  case 'd':
    ract->setAutoFrustum(!ract->getAutoFrustum());
    std::cerr << "autoFrustum: " << (ract->getAutoFrustum() ? "true" : "false") << std::endl;
    break;
  case 'f':
    ract->setVolumeDrawing(!ract->getVolumeDrawing());
    std::cerr << "VolumeDrawing: " << (ract->getVolumeDrawing() ? "true" : "false") << std::endl;
    break;
  }
}
