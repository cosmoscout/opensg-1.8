...
int main(int argc, char** argv) {
  ...
  Line  lines[nlines];
  Pnt3f pnts[nlines * 2] = {Pnt3f(0, 0, 0), Pnt3f(0, 1, 0), Pnt3f(0, 0, 0), Pnt3f(2, 1, 0),
      Pnt3f(2, 0, 0), Pnt3f(2, 1, 0), Pnt3f(-2, 0, 0), Pnt3f(0, 2, 0), Pnt3f(-4, 2, 0),
      Pnt3f(0, 2, 0), Pnt3f(-3, 0, 0), Pnt3f(-2, 1, 0), Pnt3f(3, 4, 0), Pnt3f(1, 3, 0),
      Pnt3f(-1, 0, 0), Pnt3f(-1, 1, 0), Pnt3f(-4, 0, 0), Pnt3f(-3, 1, 0), Pnt3f(-4, 6, 0),
      Pnt3f(0, 6, 0)};
  ...
  for (i = 0; i < nlines; i++) {
    std::cout << "Line: (" << lines[i].getPosition() << ") (" << lines[i].getDirection() << ")"
              << std::endl;
    ...
    if (res) {
      ...
      bool es = (b.isOnSurface(ep) || b.intersect(ep)), xs = b.isOnSurface(xp);
  ...
  for (i = 0; i < nlines; i++) {
    ...
    if (res) {
      ...
      bool es = (s.isOnSurface(ep) || s.intersect(ep)), xs = s.isOnSurface(xp);
  ...
  for (i = 0; i < nlines; i++) {
    ...
    if (res) {
      ...
      bool es = (c.isOnSurface(ep) || c.intersect(ep)), xs = c.isOnSurface(xp);
  ...
  Matrix matrix;
  matrix.setValue(0.7071, 0, 0, 0, 0, 0.7071, 0, 0, 0, 0, -1.27, -3.959, 0, 0, -0.7071, 0);
