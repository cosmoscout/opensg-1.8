...
template <class ObjectTypeT>
inline Pointer<ObjectTypeT>::Pointer(void)
    : _pObject(NULL) {
}
template <class ObjectTypeT>
inline Pointer<ObjectTypeT>::~Pointer(void) {
...
template <class ObjectTypeT>
inline ObjectTypeT* Pointer<ObjectTypeT>::operator->(void) {
  return _pObject;
}

template <class ObjectTypeT>
inline const ObjectTypeT* Pointer<ObjectTypeT>::operator->(void) const {
  return _pObject;
}
...
template <class ObjectTypeT>
inline Pointer<ObjectTypeT>::operator ObjectTypeT*(void) {
  return _pObject;
}

template <class ObjectTypeT>
inline void Pointer<ObjectTypeT>::operator=(const Pointer& source) {
  if (this != &source) {
...
template <class ObjectTypeT>
inline void Pointer<ObjectTypeT>::operator=(ObjectTypeT* source) {
...
class A {
 ...
 public:
  ...
  void bar(A*) {
    fprintf(stderr, "A::bar %d\n", aid);
  }
  Int32 fooI(void) {
    fprintf(stderr, "A::fooI %d\n", aid);
    return 0;
  }
  Int32 barI(A*) {
    fprintf(stderr, "A::barI %d\n", aid);
    return 0;
  }

  void fooO(void) {
    fprintf(stderr, "A::fooO %d\n", aid);
  }
  void barO(A&) {
    fprintf(stderr, "A::barO %d\n", aid);
  }

  void fooP(void) {
    fprintf(stderr, "A::fooP %d\n", aid);
  }
  void barP(Pointer<A>&) {
    fprintf(stderr, "A::barP %d\n", aid);
  }

  Int32 fooIP(void) {
    fprintf(stderr, "A::fooIP %d\n", aid);
    return 0;
  }
  Int32 barIP(Pointer<A>&) {
    fprintf(stderr, "A::barIP %d\n", aid);
    return 0;
  }

  Int32 fooIO(void) {
    fprintf(stderr, "A::fooIO %d\n", aid);
    return 0;
  }
  Int32 barIO(A&) {
    fprintf(stderr, "A::barIO %d\n", aid);
    return 0;
  }
...
class B : public A {
 public:
  ...
  static void foo(A*) {
    fprintf(stderr, "B::foo\n");
  };
  static Int32 fooI(A*) {
    fprintf(stderr, "B::fooI\n");
    return 0;
  };

  static void fooO(A&) {
    fprintf(stderr, "B::fooO\n");
  };
  static Int32 fooIO(A&) {
    fprintf(stderr, "B::fooIO\n");
    return 0;
  };

  static void fooP(Pointer<A>&) {
    fprintf(stderr, "B::fooP\n");
  };
  static void fooOP(Pointer<A>) {
    fprintf(stderr, "B::fooP\n");
  };

  static Int32 fooIP(Pointer<A>&) {
    fprintf(stderr, "B::fooIP\n");
    return 0;
  };
...
typedef TypedVoidFunctor2Base<CPtrRefCallArg<Pointer<A>>, ArgsT>    Functor2P;
typedef TypedFunctor2Base<Int32, CPtrRefCallArg<Pointer<A>>, ArgsT> Functor2IP;
...
void testfunctor1(void) {
  ...
  funcVecI.push_back(osgTypedFunctionFunctor1Ptr<Int32, A>(fooI));
  funcVecI.push_back(osgTypedFunctionFunctor1Ptr<Int32, A>(B::fooI));
  funcVecI.push_back(osgTypedMethodFunctor1Ptr<Int32, A>(&A::fooI));
  funcVecI.push_back(osgTypedMethodFunctor1ObjPtr<Int32, A1, A>(&a2, &A1::barI));
...
void testfunctor2(void) {
  ...
  funcVecI.push_back(osgTypedFunctionFunctor2Ptr<Int32, A, Int32&>(bar));
  funcVecI.push_back(osgTypedFunctionFunctor2Ptr<Int32, A, Int32&>(&B::bar));

  funcVecI.push_back(osgTypedMethodFunctor2Ptr<Int32, A, Int32&>(&A::foo2));

  funcVecI.push_back(osgTypedMethodFunctor2ObjPtr<Int32, A1, A, Int32&>(&a2, &A1::bar2));
  ...
  funcVec.push_back(osgTypedFunctionVoidFunctor2Ptr<A, Int32&>(foobar));
  funcVec.push_back(osgTypedFunctionVoidFunctor2Ptr<A, Int32&>(&B::foobar));
  funcVec.push_back(osgTypedMethodVoidFunctor2Ptr<A, Int32&>(&A::foo1));
  funcVec.push_back(osgTypedMethodVoidFunctor2ObjPtr<A1, A, Int32&>(&a2, &A1::bar1));
...
void testfunctor2a(void) {
  ...
  funcVecI.push_back(osgTypedFunctionFunctor2Ref<Int32, A, Int32&>(barO));
  funcVecI.push_back(osgTypedFunctionFunctor2Ref<Int32, A, Int32&>(&B::barO));

  funcVecI.push_back(osgTypedMethodFunctor2Ref<Int32, A, Int32&>(&A::foo2O));
  ...
  funcVec.push_back(osgTypedFunctionVoidFunctor2Ref<A, Int32&>(foobarO));
  funcVec.push_back(osgTypedFunctionVoidFunctor2Ref<A, Int32&>(&B::foobarO));

  funcVec.push_back(osgTypedMethodVoidFunctor2Ref<A, Int32&>(&A::foo1O));
...
void testpointer1(void) {
  ...
  funcVec.push_back(osgTypedFunctionVoidFunctor1CPtrRef<Pointer<A>>(fooP));
  funcVec.push_back(osgTypedFunctionVoidFunctor1CPtrRef<Pointer<A>>(&B::fooP));

  funcVec.push_back(osgTypedMethodVoidFunctor1CPtrRef<Pointer<A>>(&A::fooP));

  funcVec.push_back(osgTypedMethodVoidFunctor1ObjCPtrRef<Pointer<A1>, Pointer<A>>(pA1, &A1::barP));
...
void testpointer1o(void) {
  ...
  funcVec.push_back(osgTypedFunctionVoidFunctor1CPtr<Pointer<A>>(fooOP));
  funcVec.push_back(osgTypedFunctionVoidFunctor1CPtr<Pointer<A>>(&B::fooOP));

  funcVec.push_back(osgTypedMethodVoidFunctor1CPtr<Pointer<A>>(&A::fooP));

  funcVec.push_back(osgTypedMethodVoidFunctor1ObjCPtr<Pointer<A1>, Pointer<A>>(pA1, &A1::barOP));
...
void testpointer2(void) {
  ...
  funcVec.push_back(osgTypedFunctionVoidFunctor2CPtrRef<Pointer<A>, Int32&>(foobarP));

  funcVec.push_back(osgTypedFunctionVoidFunctor2CPtrRef<Pointer<A>, Int32&>(&B::foobarP));

  funcVec.push_back(osgTypedMethodVoidFunctor2CPtrRef<Pointer<A>, Int32&>(&A::foo1P));

  funcVec.push_back(
      osgTypedMethodVoidFunctor2ObjCPtrRef<Pointer<A1>, Pointer<A>, Int32&>(pA1, &A1::bar1P));
  ...
  */
  ...
  funcVecI.push_back(
      osgTypedMethodFunctor2BaseCPtrRef<Int32, Pointer<B>, Pointer<A>, Int32&>(&B::foo2P));
  ...
  */
  ...
  funcVecI.push_back(osgTypedFunctionFunctor2CPtrRef<Int32, Pointer<A>, Int32&>(barP));
  funcVecI.push_back(osgTypedFunctionFunctor2CPtrRef<Int32, Pointer<A>, Int32&>(&B::barP));
