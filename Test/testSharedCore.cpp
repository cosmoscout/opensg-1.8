...
int main(int argc, char* argv[]) {
  ...
  if (argc >= 2 && *(argv[1]) == '1') {
    ...
    GeometryPtr::dcast(planeNode2->getCore())
        ->setPositions(GeometryPtr::dcast(planeNode1->getCore())->getPositions());
