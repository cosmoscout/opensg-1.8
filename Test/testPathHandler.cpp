...
int main(int argc, char** argv) {
  ...
  */
  ...
  SLOG << "Looking for tie.wrl: " << std::endl
       << ph.findFile("../../../Experimental/VRMLLoader/tie.wrl") << std::endl;

  SLOG << "Looking for std.wrl: " << std::endl << ph.findFile("std.wrl") << std::endl;

  SLOG << "Looking for polyp.tif: " << std::endl << ph.findFile("polyp.tif") << std::endl;
