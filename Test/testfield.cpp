...
int main(int argc, char** argv) {
  ...
  SFBitVector* pSB = (SFBitVector*)FieldFactory::the().createField("SFBitVector");

  MFBitVector* pMB = (MFBitVector*)FieldFactory::the().createField("MFBitVector");

  SFTime* pST = (SFTime*)FieldFactory::the().createField("SFTime");

  MFTime* pMT = (MFTime*)FieldFactory::the().createField("MFTime");
