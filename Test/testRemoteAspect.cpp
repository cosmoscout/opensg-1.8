...
void server(void) {
  ...
  RemoteAspect::Functor changed =
      osgTypedFunctionFunctor2CPtrRef<bool, FieldContainerPtr, RemoteAspect*>(changedFunction);

  RemoteAspect::Functor destroyed =
      osgTypedFunctionFunctor2CPtrRef<bool, FieldContainerPtr, RemoteAspect*>(destroyedFunction);

  RemoteAspect::Functor created =
      osgTypedFunctionFunctor2CPtrRef<bool, FieldContainerPtr, RemoteAspect*>(createdFunction);
