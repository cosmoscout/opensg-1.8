...
MPThreadType MyThread::_type("MyThread", "Thread", (CreateThreadF)MyThread::create, NULL);
...
MyThread* MyThread::get(Char8* szName) {
  BaseThread* pThread = ThreadManager::the()->getThread(szName, "MyThread");
...
int main(int argc, char** argv) {
  ...
  if (pThread1 == NULL || pThread2 == NULL || pThread3 == NULL || pThread4 == NULL) {
