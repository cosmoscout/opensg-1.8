...
template <>
struct FieldDataTraits<DVRGeometryPtr> : public FieldTraitsRecurseMapper<DVRGeometryPtr, true> {
...
#define OSGDVRGEOMETRYFIELDS_HEADER_CVSID                                                          \
