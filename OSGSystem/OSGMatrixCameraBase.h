...
typedef osgIF<MatrixCameraBase::isNodeCore, CoredNodePtr<MatrixCamera>,
    FieldContainer::attempt_to_create_CoredNodePtr_on_non_NodeCore_FC>::_IRet MatrixCameraNodePtr;

typedef RefPtr<MatrixCameraPtr> MatrixCameraRefPtr;

OSG_END_NAMESPACE

#define OSGMATRIXCAMERABASE_HEADER_CVSID                                                           \
