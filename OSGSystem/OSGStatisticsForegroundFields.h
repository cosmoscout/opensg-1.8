...
struct FieldDataTraits<StatisticsForegroundPtr>
  ...
  static const char* getSName(void) {
    return "SFStatisticsForegroundPtr";
  }
  static const char* getMName(void) {
    return "MFStatisticsForegroundPtr";
  }
};

#if !defined(OSG_DOC_DEV_TRAITS)
/*! \class  FieldTraitsRecurseMapper<StatisticsForegroundPtr, true>
    \hideinhierarchy
 */
#endif
...
#define OSGSTATISTICSFOREGROUNDFIELDS_HEADER_CVSID                                                 \
