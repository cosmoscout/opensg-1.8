...
/*! \var Matrix          MatrixCameraDecoratorBase::_sfPreViewing
    The matrix to multiply to the right of the viewing matrix, i.e.          applied before the
   viewing matrix.
*/
/*! \var Matrix          MatrixCameraDecoratorBase::_sfPostViewing
    The matrix to multiply to the left of the viewing matrix, i.e.          applied after the
   viewing matrix.
*/
/*! \var Matrix          MatrixCameraDecoratorBase::_sfPreProjectionTranslation
    The matrix to multiply to the right of the projectionTranslation matrix, i.e.          applied
   before the projectionTranslation matrix.
*/
/*! \var Matrix          MatrixCameraDecoratorBase::_sfPostProjectionTranslation
    The matrix to multiply to the left of the projectionTranslation matrix, i.e.          applied
   before the projectionTranslation matrix.
*/
/*! \var Matrix          MatrixCameraDecoratorBase::_sfPreProjection
    The matrix to multiply to the right of the projection matrix, i.e.          applied before the
   projection matrix.
*/
/*! \var Matrix          MatrixCameraDecoratorBase::_sfPostProjection
    The matrix to multiply to the left of the projection matrix, i.e.          applied before the
   projection matrix.
*/
...
FieldDescription* MatrixCameraDecoratorBase::_desc[] = {
    new FieldDescription(SFMatrix::getClassType(), "preViewing", PreViewingFieldId,
        PreViewingFieldMask, false, (FieldAccessMethod)&MatrixCameraDecoratorBase::getSFPreViewing),
    new FieldDescription(SFMatrix::getClassType(), "postViewing", PostViewingFieldId,
        PostViewingFieldMask, false,
        (FieldAccessMethod)&MatrixCameraDecoratorBase::getSFPostViewing),
    new FieldDescription(SFMatrix::getClassType(), "preProjectionTranslation",
        PreProjectionTranslationFieldId, PreProjectionTranslationFieldMask, false,
        (FieldAccessMethod)&MatrixCameraDecoratorBase::getSFPreProjectionTranslation),
    new FieldDescription(SFMatrix::getClassType(), "postProjectionTranslation",
        PostProjectionTranslationFieldId, PostProjectionTranslationFieldMask, false,
        (FieldAccessMethod)&MatrixCameraDecoratorBase::getSFPostProjectionTranslation),
    new FieldDescription(SFMatrix::getClassType(), "preProjection", PreProjectionFieldId,
        PreProjectionFieldMask, false,
        (FieldAccessMethod)&MatrixCameraDecoratorBase::getSFPreProjection),
    new FieldDescription(SFMatrix::getClassType(), "postProjection", PostProjectionFieldId,
        PostProjectionFieldMask, false,
        (FieldAccessMethod)&MatrixCameraDecoratorBase::getSFPostProjection)};

FieldContainerType MatrixCameraDecoratorBase::_type("MatrixCameraDecorator", "CameraDecorator",
    NULL, (PrototypeCreateF)&MatrixCameraDecoratorBase::createEmpty,
    MatrixCameraDecorator::initMethod, _desc, sizeof(_desc));
...
void MatrixCameraDecoratorBase::executeSync(FieldContainer& other, const BitVector& whichField) {
  this->executeSyncImpl((MatrixCameraDecoratorBase*)&other, whichField);
}
#else
void MatrixCameraDecoratorBase::executeSync(
    FieldContainer& other, const BitVector& whichField, const SyncInfo& sInfo) {
  this->executeSyncImpl((MatrixCameraDecoratorBase*)&other, whichField, sInfo);
}
void MatrixCameraDecoratorBase::execBeginEdit(
...
void MatrixCameraDecoratorBase::copyToBin(BinaryDataHandler& pMem, const BitVector& whichField) {
...
void MatrixCameraDecoratorBase::copyFromBin(BinaryDataHandler& pMem, const BitVector& whichField) {
...
#if !defined(OSG_FIXED_MFIELDSYNC)
void MatrixCameraDecoratorBase::executeSyncImpl(
    MatrixCameraDecoratorBase* pOther, const BitVector& whichField) {
...
void MatrixCameraDecoratorBase::execBeginEditImpl(
    const BitVector& whichField, UInt32 uiAspect, UInt32 uiContainerSize) {
...
DataType FieldDataTraits<MatrixCameraDecoratorPtr>::_type(
    "MatrixCameraDecoratorPtr", "CameraDecoratorPtr");
#endif
