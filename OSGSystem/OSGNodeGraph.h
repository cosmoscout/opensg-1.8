...
class NodeGraph {
 ...
 private:
  ...
  class NodeList {
   ...
   public:
    ...
    inline NodeList* down(void) {
      return _down;
    }
    inline void setDown(NodeList* down) {
      _down = down;
    }
    inline int degree(void) {
      return _degree;
    }
    inline void setDegree(int degree) {
      _degree = degree;
    }
    inline Node* first(void) {
      return _first;
    }
    inline Node* last(void) {
      return _last;
    }
 ...
 public:
  ...
  inline bool setNode(int index, int v0, int v1, int v2) {
  ...
  int createPathVec(std::vector<Path>& stripVec, bool createStrips = true, bool createFans = true,
