...
ProgramChunk::ProgramChunk(void)
  ...
  _funcGenPrograms = Window::registerFunction(OSG_DLSYM_UNDERSCORE "glGenProgramsARB", extension);
  _funcProgramString =
      Window::registerFunction(OSG_DLSYM_UNDERSCORE "glProgramStringARB", extension);
  _funcBindProgram = Window::registerFunction(OSG_DLSYM_UNDERSCORE "glBindProgramARB", extension);
  _funcDeletePrograms =
      Window::registerFunction(OSG_DLSYM_UNDERSCORE "glDeleteProgramsARB", extension);
  _funcProgramLocalParameter4fv =
      Window::registerFunction(OSG_DLSYM_UNDERSCORE "glProgramLocalParameter4fvARB", extension);
  _funcGetProgramiv = Window::registerFunction(OSG_DLSYM_UNDERSCORE "glGetProgramivARB", extension);
}
...
void ProgramChunk::dump(UInt32, const BitVector) const {
 ...
 */
bool ProgramChunk::addParameter(const char* name, Int16 index) {
  if (index < 0)
    return true;
...
void ProgramChunk::handleGL(Window* win, UInt32 idstatus, GLenum target, UInt32 extension) {
  ...
  if (mode == Window::destroy) {
    ...
    void(OSG_APIENTRY * deletePrograms)(GLsizei num, const GLuint* progs) = (void(OSG_APIENTRY*)(
        GLsizei num, const GLuint* progs))win->getFunction(_funcDeletePrograms);
    ...
    if (mode == Window::initialize) {
      ...
      void(OSG_APIENTRY * genPrograms)(GLsizei n, GLuint * prog) =
          (void(OSG_APIENTRY*)(GLsizei n, GLuint * prog)) win->getFunction(_funcGenPrograms);
      genPrograms(1, &id);
    ...
    void(OSG_APIENTRY * bindProgram)(GLenum target, GLuint prog) =
        (void(OSG_APIENTRY*)(GLenum target, GLuint prog))win->getFunction(_funcBindProgram);
    ...
    if (mode != Window::needrefresh) {
      ...
      void(OSG_APIENTRY * programString)(GLenum target, GLenum format, GLsizei lesn,
          const void* string) = (void(OSG_APIENTRY*)(GLenum target, GLenum format, GLsizei len,
          const void* string))win->getFunction(_funcProgramString);
      ...
      programString(target, GL_PROGRAM_FORMAT_ASCII_ARB, getProgram().size(), getProgram().c_str());
      ...
      if (err == GL_INVALID_OPERATION) {
        ...
        SWARNING << "ProgramChunk::programString postcheck failed:" << gluErrorString(err)
                 << endLog;
      }
    ...
    void(OSG_APIENTRY * programLocalParameter4fv)(
        GLenum target, GLuint index, const GLfloat* params) = (void(OSG_APIENTRY*)(GLenum target,
        GLuint index, const GLfloat* params))win->getFunction(_funcProgramLocalParameter4fv);
    ...
    SWARNING << "ProgramChunk(" << this << "::handleGL: Illegal mode: " << mode << " for id " << id
             << std::endl;
  }
}
...
void ProgramChunk::activate(DrawActionBase* action, UInt32) {
  ...
  // get "glBindProgramARB" function pointer
  void(OSG_APIENTRY * bindProgram)(GLenum target, GLuint prog) =
      (void(OSG_APIENTRY*)(GLenum target, GLuint prog))action->getWindow()->getFunction(
          _funcBindProgram);
...
void ProgramChunk::changeFrom(DrawActionBase* action, StateChunk* old_chunk, UInt32) {
