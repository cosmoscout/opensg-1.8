...
class OSG_SYSTEMLIB_DLLMAPPING SurfaceBase : public Geometry {
 ...
 protected:
  ...
  void executeSyncImpl(SurfaceBase* pOther, const BitVector& whichField);

  virtual void executeSync(FieldContainer& other, const BitVector& whichField);
#else
  void executeSyncImpl(SurfaceBase* pOther, const BitVector& whichField, const SyncInfo& sInfo);
...
typedef osgIF<SurfaceBase::isNodeCore, CoredNodePtr<Surface>,
    FieldContainer::attempt_to_create_CoredNodePtr_on_non_NodeCore_FC>::_IRet SurfaceNodePtr;

typedef RefPtr<SurfacePtr> SurfaceRefPtr;

OSG_END_NAMESPACE

#define OSGSURFACEBASE_HEADER_CVSID                                                                \
