...
void ShaderParameterVec2f::initMethod(void) {
}
...
ShaderParameterVec2f::ShaderParameterVec2f(const ShaderParameterVec2f& source)
    : Inherited(source) {
}
...
void ShaderParameterVec2f::dump(UInt32, const BitVector) const {
