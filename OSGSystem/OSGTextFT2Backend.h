 ...
 */
class OSG_SYSTEMLIB_DLLMAPPING TextFT2Backend : public TextBackend {
  /*==========================  PUBLIC  =================================*/
 public:
...
#define OSGTEXTFT2BACKEND_HEADER_CVSID                                                             \
  "@(#)$Id: OSGTextFT2Backend.h,v 1.1 2005/03/03 13:43:06 a-m-z Exp $"
