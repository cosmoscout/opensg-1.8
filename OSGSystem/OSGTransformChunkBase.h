...
typedef osgIF<TransformChunkBase::isNodeCore, CoredNodePtr<TransformChunk>,
    FieldContainer::attempt_to_create_CoredNodePtr_on_non_NodeCore_FC>::_IRet TransformChunkNodePtr;

typedef RefPtr<TransformChunkPtr> TransformChunkRefPtr;

OSG_END_NAMESPACE

#define OSGTRANSFORMCHUNKBASE_HEADER_CVSID                                                         \
