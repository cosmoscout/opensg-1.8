...
FieldContainerType LightEnvBase::_type("LightEnv", "NodeCore", NULL,
    (PrototypeCreateF)&LightEnvBase::createEmpty, LightEnv::initMethod, NULL, 0);
...
void LightEnvBase::executeSync(FieldContainer& other, const BitVector& whichField) {
  this->executeSyncImpl((LightEnvBase*)&other, whichField);
}
#else
void LightEnvBase::executeSync(
    FieldContainer& other, const BitVector& whichField, const SyncInfo& sInfo) {
  this->executeSyncImpl((LightEnvBase*)&other, whichField, sInfo);
}
void LightEnvBase::execBeginEdit(
...
void LightEnvBase::copyToBin(BinaryDataHandler& pMem, const BitVector& whichField) {
  Inherited::copyToBin(pMem, whichField);
}

void LightEnvBase::copyFromBin(BinaryDataHandler& pMem, const BitVector& whichField) {
  Inherited::copyFromBin(pMem, whichField);
}

#if !defined(OSG_FIXED_MFIELDSYNC)
void LightEnvBase::executeSyncImpl(LightEnvBase* pOther, const BitVector& whichField) {

  Inherited::executeSyncImpl(pOther, whichField);
}
#else
void LightEnvBase::executeSyncImpl(
    LightEnvBase* pOther, const BitVector& whichField, const SyncInfo& sInfo) {

  Inherited::executeSyncImpl(pOther, whichField, sInfo);
}

void LightEnvBase::execBeginEditImpl(
    const BitVector& whichField, UInt32 uiAspect, UInt32 uiContainerSize) {
