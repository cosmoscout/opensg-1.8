...
FieldDescription* PipelineComposerBase::_desc[] = {
    ...
    new FieldDescription(SFUInt32::getClassType(), "tileSize", TileSizeFieldId, TileSizeFieldMask,
        false, (FieldAccessMethod)&PipelineComposerBase::getSFTileSize),
    new FieldDescription(SFBool::getClassType(), "pipelined", PipelinedFieldId, PipelinedFieldMask,
        false, (FieldAccessMethod)&PipelineComposerBase::getSFPipelined)};

FieldContainerType PipelineComposerBase::_type("PipelineComposer", "ImageComposer", NULL,
    (PrototypeCreateF)&PipelineComposerBase::createEmpty, PipelineComposer::initMethod, _desc,
    sizeof(_desc));
...
void PipelineComposerBase::executeSync(FieldContainer& other, const BitVector& whichField) {
  this->executeSyncImpl((PipelineComposerBase*)&other, whichField);
}
#else
void PipelineComposerBase::executeSync(
    FieldContainer& other, const BitVector& whichField, const SyncInfo& sInfo) {
  this->executeSyncImpl((PipelineComposerBase*)&other, whichField, sInfo);
}
void PipelineComposerBase::execBeginEdit(
...
void PipelineComposerBase::copyToBin(BinaryDataHandler& pMem, const BitVector& whichField) {
...
void PipelineComposerBase::copyFromBin(BinaryDataHandler& pMem, const BitVector& whichField) {
...
#if !defined(OSG_FIXED_MFIELDSYNC)
void PipelineComposerBase::executeSyncImpl(
    PipelineComposerBase* pOther, const BitVector& whichField) {
...
void PipelineComposerBase::execBeginEditImpl(
    const BitVector& whichField, UInt32 uiAspect, UInt32 uiContainerSize) {
