...
class OSG_SYSTEMLIB_DLLMAPPING TTVectorFontGlyph : public virtual FontGlyph,
 ...
 protected:
  ...
  Int32 processArc(FontGlyphContour* glyphContour, TT_Outline outline, Int32 start, Int32 contour,
      Real32** normalStack, Int32& numnStack, Int32& counter, Int32 step = 1, bool dryRun = false);
