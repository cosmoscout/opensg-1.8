...
inline MultiFunctorStore::MultiFunctorStore(void)
    : _funcStore()
    , _funcMap()
    , _defaultFunc()
...
inline bool MultiFunctorStore::empty(void) const {
...
inline void MultiFunctorStore::regFunctor(
...
inline void MultiFunctorStore::unregFunctor(const FieldContainerType& refType) {
...
inline void MultiFunctorStore::regDefaultFunctor(const Functor& refFunc) {
  _defaultFunc        = refFunc;
  _bHasDefaultFunctor = true;
}

inline void MultiFunctorStore::unregDefaultFunctor(void) {
  _bHasDefaultFunctor = false;
}
...
inline MultiFunctorStore::Functor* MultiFunctorStore::getFunctor(
...
inline MultiFunctorStore::Functor* MultiFunctorStore::getDefaultFunctor(void) {
  Functor* pRetFunc = NULL;
...
#define OSGMULTIFUNCTORSTORE_INLINE_CVSID                                                          \
  "@(#)$Id: OSGMultiFunctorStore.inl,v 1.5 2004/04/20 13:47:08 neumannc Exp $"
