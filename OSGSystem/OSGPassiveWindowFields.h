...
template <>
struct FieldDataTraits<PassiveWindowPtr> : public FieldTraitsRecurseMapper<PassiveWindowPtr, true> {
  ...
  static const char* getSName(void) {
    return "SFPassiveWindowPtr";
  }
  static const char* getMName(void) {
    return "MFPassiveWindowPtr";
  }
};

#if !defined(OSG_DOC_DEV_TRAITS)
/*! \class  FieldTraitsRecurseMapper<PassiveWindowPtr, true>
    \hideinhierarchy
 */
#endif
...
#define OSGPASSIVEWINDOWFIELDS_HEADER_CVSID                                                        \
