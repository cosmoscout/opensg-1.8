...
template <>
struct FieldDataTraits<MatrixCameraPtr> : public FieldTraitsRecurseMapper<MatrixCameraPtr, true> {
  ...
  static const char* getSName(void) {
    return "SFMatrixCameraPtr";
  }
  static const char* getMName(void) {
    return "MFMatrixCameraPtr";
  }
};
...
#define OSGMATRIXCAMERAFIELDS_HEADER_CVSID                                                         \
