...
/*! \var bool            BalancedMultiWindowBase::_sfBestCut
    If true horizontal and vertical cuts are testet. Otherwise the longes side of a viewport is
   split.
*/
...
FieldDescription* BalancedMultiWindowBase::_desc[] = {
    new FieldDescription(SFBool::getClassType(), "balance", BalanceFieldId, BalanceFieldMask, false,
        (FieldAccessMethod)&BalancedMultiWindowBase::getSFBalance),
    new FieldDescription(SFBool::getClassType(), "bestCut", BestCutFieldId, BestCutFieldMask, false,
        (FieldAccessMethod)&BalancedMultiWindowBase::getSFBestCut),
    new FieldDescription(SFBool::getClassType(), "showBalancing", ShowBalancingFieldId,
        ShowBalancingFieldMask, false,
    ...
    new FieldDescription(SFUInt32::getClassType(), "tileSize", TileSizeFieldId, TileSizeFieldMask,
        false, (FieldAccessMethod)&BalancedMultiWindowBase::getSFTileSize),
...
FieldContainerType BalancedMultiWindowBase::_type("BalancedMultiWindow", "MultiDisplayWindow", NULL,
    (PrototypeCreateF)&BalancedMultiWindowBase::createEmpty, BalancedMultiWindow::initMethod, _desc,
    sizeof(_desc));
...
void BalancedMultiWindowBase::executeSync(FieldContainer& other, const BitVector& whichField) {
  this->executeSyncImpl((BalancedMultiWindowBase*)&other, whichField);
}
#else
void BalancedMultiWindowBase::executeSync(
    FieldContainer& other, const BitVector& whichField, const SyncInfo& sInfo) {
  this->executeSyncImpl((BalancedMultiWindowBase*)&other, whichField, sInfo);
}
void BalancedMultiWindowBase::execBeginEdit(
...
void BalancedMultiWindowBase::copyToBin(BinaryDataHandler& pMem, const BitVector& whichField) {
...
void BalancedMultiWindowBase::copyFromBin(BinaryDataHandler& pMem, const BitVector& whichField) {
...
#if !defined(OSG_FIXED_MFIELDSYNC)
void BalancedMultiWindowBase::executeSyncImpl(
    BalancedMultiWindowBase* pOther, const BitVector& whichField) {
...
void BalancedMultiWindowBase::execBeginEditImpl(
    const BitVector& whichField, UInt32 uiAspect, UInt32 uiContainerSize) {
...
DataType FieldDataTraits<BalancedMultiWindowPtr>::_type(
    "BalancedMultiWindowPtr", "MultiDisplayWindowPtr");
#endif
