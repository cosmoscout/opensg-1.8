...
template <>
struct FieldDataTraits<MaterialPtr> : public FieldTraitsRecurseMapper<MaterialPtr, true> {
  ...
  static const char* getSName(void) {
    return "SFMaterialPtr";
  }
  static const char* getMName(void) {
    return "MFMaterialPtr";
  }
};
...
#define OSGMATERIALFIELDS_HEADER_CVSID                                                             \
