...
FieldDescription* SHLChunkBase::_desc[] = {
    new FieldDescription(SFBool::getClassType(), "cgFrontEnd", CgFrontEndFieldId,
        CgFrontEndFieldMask, false, (FieldAccessMethod)&SHLChunkBase::getSFCgFrontEnd),
    new FieldDescription(SFBool::getClassType(), "pointSize", PointSizeFieldId, PointSizeFieldMask,
        false, (FieldAccessMethod)&SHLChunkBase::getSFPointSize),
    new FieldDescription(MFGLenum::getClassType(), "programParameterNames",
        ProgramParameterNamesFieldId, ProgramParameterNamesFieldMask, false,
        (FieldAccessMethod)&SHLChunkBase::getMFProgramParameterNames),
    new FieldDescription(MFUInt32::getClassType(), "programParameterValues",
        ProgramParameterValuesFieldId, ProgramParameterValuesFieldMask, false,
...
FieldContainerType SHLChunkBase::_type("SHLChunk", "ShaderChunk", NULL,
    (PrototypeCreateF)&SHLChunkBase::createEmpty, SHLChunk::initMethod, _desc, sizeof(_desc));
...
void SHLChunkBase::executeSync(FieldContainer& other, const BitVector& whichField) {
  this->executeSyncImpl((SHLChunkBase*)&other, whichField);
}
#else
void SHLChunkBase::executeSync(
    FieldContainer& other, const BitVector& whichField, const SyncInfo& sInfo) {
  this->executeSyncImpl((SHLChunkBase*)&other, whichField, sInfo);
}
void SHLChunkBase::execBeginEdit(
...
void SHLChunkBase::copyToBin(BinaryDataHandler& pMem, const BitVector& whichField) {
...
void SHLChunkBase::copyFromBin(BinaryDataHandler& pMem, const BitVector& whichField) {
...
#if !defined(OSG_FIXED_MFIELDSYNC)
void SHLChunkBase::executeSyncImpl(SHLChunkBase* pOther, const BitVector& whichField) {
...
#else
void SHLChunkBase::executeSyncImpl(
    SHLChunkBase* pOther, const BitVector& whichField, const SyncInfo& sInfo) {
...
void SHLChunkBase::execBeginEditImpl(
    const BitVector& whichField, UInt32 uiAspect, UInt32 uiContainerSize) {
