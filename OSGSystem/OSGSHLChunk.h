...
class OSG_SYSTEMLIB_DLLMAPPING SHLChunk : public SHLChunkBase {
 ...
 public:
  ...
  static void updateParameterLocation(
      Window* win, GLuint program, const ShaderParameterPtr& parameter);

  void updateParameterLocations(Window* win, const MFShaderParameterPtr& parameters);

  void updateParameters(Window* win, const MFShaderParameterPtr& parameters, bool useProgram = true,
      bool force = false, bool keepProgramActive = false);
  ...
  typedef void (*parametercbfp)(
      OSGGLGETUNIFORMLOCATIONARBPROC getUniformLocation, DrawActionBase* action, GLuint program);

  typedef void (*osgparametercbfp)(
 ...
 private:
  ...
  static void updateWorldMatrix(
      const ShaderParameterPtr& parameter, DrawActionBase* action, GLuint program);
  static void updateInvWorldMatrix(
      const ShaderParameterPtr& parameter, DrawActionBase* action, GLuint program);
  static void updateTransInvWorldMatrix(
      const ShaderParameterPtr& parameter, DrawActionBase* action, GLuint program);
  ...
  static void updateViewMatrix(
      const ShaderParameterPtr& parameter, DrawActionBase* action, GLuint program);
  static void updateInvViewMatrix(
      const ShaderParameterPtr& parameter, DrawActionBase* action, GLuint program);
  static void updateStereoLeftEye(
      const ShaderParameterPtr& parameter, DrawActionBase* action, GLuint program);
  static void updateClusterId(
      const ShaderParameterPtr& parameter, DrawActionBase* action, GLuint program);
  static void updateActiveLightsMask(
      const ShaderParameterPtr& parameter, DrawActionBase* action, GLuint program);
  static void updateLight0Active(
      const ShaderParameterPtr& parameter, DrawActionBase* action, GLuint program);
  static void updateLight1Active(
      const ShaderParameterPtr& parameter, DrawActionBase* action, GLuint program);
  static void updateLight2Active(
      const ShaderParameterPtr& parameter, DrawActionBase* action, GLuint program);
  static void updateLight3Active(
      const ShaderParameterPtr& parameter, DrawActionBase* action, GLuint program);
  static void updateLight4Active(
      const ShaderParameterPtr& parameter, DrawActionBase* action, GLuint program);
  static void updateLight5Active(
      const ShaderParameterPtr& parameter, DrawActionBase* action, GLuint program);
  static void updateLight6Active(
      const ShaderParameterPtr& parameter, DrawActionBase* action, GLuint program);
  static void updateLight7Active(
      const ShaderParameterPtr& parameter, DrawActionBase* action, GLuint program);

  std::vector<std::pair<std::pair<parametercbfp, osgparametercbfp>, ShaderParameterPtr>>
