...
char PrimitiveIterator::cvsid[] =
    "@(#)$Id: OSGPrimitiveIterator.cpp,v 1.17 2001/11/01 05:55:06 vossg Exp $";
...
bool PrimitiveIterator::operator<(const PrimitiveIterator& other) const {
  return _geo == other._geo && _primIndex <= other._primIndex;
}
...
*/
bool PrimitiveIterator::operator==(const PrimitiveIterator& other) const {
  return _ended == other._ended && _geo == other._geo && _primIndex == other._primIndex;
}
