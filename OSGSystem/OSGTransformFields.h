...
template <>
struct FieldDataTraits<TransformPtr> : public FieldTraitsRecurseMapper<TransformPtr, true> {
  ...
  static const char* getSName(void) {
    return "SFTransformPtr";
  }
  static const char* getMName(void) {
    return "MFTransformPtr";
  }
};
...
#define OSGTRANSFORMFIELDS_HEADER_CVSID                                                            \
