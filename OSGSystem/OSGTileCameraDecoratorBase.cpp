...
FieldDescription* TileCameraDecoratorBase::_desc[] = {
    ...
    new FieldDescription(SFReal32::getClassType(), "top", TopFieldId, TopFieldMask, true,
        (FieldAccessMethod)&TileCameraDecoratorBase::getSFTop),
    new FieldDescription(SFUInt32::getClassType(), "fullWidth", FullWidthFieldId,
        FullWidthFieldMask, false, (FieldAccessMethod)&TileCameraDecoratorBase::getSFFullWidth),
    new FieldDescription(SFUInt32::getClassType(), "fullHeight", FullHeightFieldId,
        FullHeightFieldMask, true, (FieldAccessMethod)&TileCameraDecoratorBase::getSFFullHeight)};

FieldContainerType TileCameraDecoratorBase::_type("TileCameraDecorator", "CameraDecorator", NULL,
    (PrototypeCreateF)&TileCameraDecoratorBase::createEmpty, TileCameraDecorator::initMethod, _desc,
    sizeof(_desc));
...
void TileCameraDecoratorBase::executeSync(FieldContainer& other, const BitVector& whichField) {
  this->executeSyncImpl((TileCameraDecoratorBase*)&other, whichField);
}
#else
void TileCameraDecoratorBase::executeSync(
    FieldContainer& other, const BitVector& whichField, const SyncInfo& sInfo) {
  this->executeSyncImpl((TileCameraDecoratorBase*)&other, whichField, sInfo);
}
void TileCameraDecoratorBase::execBeginEdit(
...
void TileCameraDecoratorBase::copyToBin(BinaryDataHandler& pMem, const BitVector& whichField) {
...
void TileCameraDecoratorBase::copyFromBin(BinaryDataHandler& pMem, const BitVector& whichField) {
...
#if !defined(OSG_FIXED_MFIELDSYNC)
void TileCameraDecoratorBase::executeSyncImpl(
    TileCameraDecoratorBase* pOther, const BitVector& whichField) {
...
void TileCameraDecoratorBase::execBeginEditImpl(
    const BitVector& whichField, UInt32 uiAspect, UInt32 uiContainerSize) {
...
DataType FieldDataTraits<TileCameraDecoratorPtr>::_type(
    "TileCameraDecoratorPtr", "CameraDecoratorPtr");
#endif
