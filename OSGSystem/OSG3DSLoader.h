...
class LObject {
 public:
  ...
  // with valid data when reading from file. If you're about to add an importer for another format
  // you'LL have to use these methods call this to set the name of the object
...
class LMaterial : public LObject {
 public:
  ...
  // this methods should not be used by the "user", they're used internally to fill the class
  // with valid data when reading from file. If you're about to add an importer for another format
  // you'LL have to use these methods sets the material ID to "value"
...
class L3DS : public LImporter {
 ...
 protected:
  ...
  // reads the face list, face materials, smoothing groups... and fill rthe information into the
  // mesh
