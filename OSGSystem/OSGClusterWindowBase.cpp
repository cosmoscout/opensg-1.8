...
FieldDescription* ClusterWindowBase::_desc[] = {
    new FieldDescription(MFString::getClassType(), "servers", ServersFieldId, ServersFieldMask,
        false, (FieldAccessMethod)&ClusterWindowBase::getMFServers),
    new FieldDescription(SFString::getClassType(), "connectionType", ConnectionTypeFieldId,
        ConnectionTypeFieldMask, false, (FieldAccessMethod)&ClusterWindowBase::getSFConnectionType),
    new FieldDescription(SFString::getClassType(), "connectionInterface",
        ConnectionInterfaceFieldId, ConnectionInterfaceFieldMask, false,
        (FieldAccessMethod)&ClusterWindowBase::getSFConnectionInterface),
    new FieldDescription(SFString::getClassType(), "connectionDestination",
        ConnectionDestinationFieldId, ConnectionDestinationFieldMask, false,
        (FieldAccessMethod)&ClusterWindowBase::getSFConnectionDestination),
    new FieldDescription(SFString::getClassType(), "connectionParams", ConnectionParamsFieldId,
        ConnectionParamsFieldMask, false,
        (FieldAccessMethod)&ClusterWindowBase::getSFConnectionParams),
    new FieldDescription(SFUInt32::getClassType(), "servicePort", ServicePortFieldId,
        ServicePortFieldMask, false, (FieldAccessMethod)&ClusterWindowBase::getSFServicePort),
    new FieldDescription(SFString::getClassType(), "serviceAddress", ServiceAddressFieldId,
        ServiceAddressFieldMask, false, (FieldAccessMethod)&ClusterWindowBase::getSFServiceAddress),
    new FieldDescription(SFString::getClassType(), "serviceInterface", ServiceInterfaceFieldId,
        ServiceInterfaceFieldMask, false,
        (FieldAccessMethod)&ClusterWindowBase::getSFServiceInterface),
    new FieldDescription(SFWindowPtr::getClassType(), "clientWindow", ClientWindowFieldId,
        ClientWindowFieldMask, false, (FieldAccessMethod)&ClusterWindowBase::getSFClientWindow),
    new FieldDescription(SFUInt32::getClassType(), "interleave", InterleaveFieldId,
        InterleaveFieldMask, false, (FieldAccessMethod)&ClusterWindowBase::getSFInterleave),
    new FieldDescription(SFUInt32::getClassType(), "frameCount", FrameCountFieldId,
        FrameCountFieldMask, false, (FieldAccessMethod)&ClusterWindowBase::getSFFrameCount),
    new FieldDescription(SFImageComposerPtr::getClassType(), "composer", ComposerFieldId,
        ComposerFieldMask, false, (FieldAccessMethod)&ClusterWindowBase::getSFComposer),
    new FieldDescription(MFString::getClassType(), "autostart", AutostartFieldId,
        AutostartFieldMask, false, (FieldAccessMethod)&ClusterWindowBase::getMFAutostart),
    new FieldDescription(MFDisplayCalibrationPtr::getClassType(), "calibration", CalibrationFieldId,
        CalibrationFieldMask, false, (FieldAccessMethod)&ClusterWindowBase::getMFCalibration),
    new FieldDescription(MFDisplayFilterForegroundPtr::getClassType(), "filter", FilterFieldId,
        FilterFieldMask, false, (FieldAccessMethod)&ClusterWindowBase::getMFFilter),
...
FieldContainerType ClusterWindowBase::_type("ClusterWindow", "Window", NULL,
    (PrototypeCreateF)&ClusterWindowBase::createEmpty, ClusterWindow::initMethod, _desc,
    sizeof(_desc));
...
void ClusterWindowBase::executeSync(FieldContainer& other, const BitVector& whichField) {
  this->executeSyncImpl((ClusterWindowBase*)&other, whichField);
}
#else
void ClusterWindowBase::executeSync(
    FieldContainer& other, const BitVector& whichField, const SyncInfo& sInfo) {
  this->executeSyncImpl((ClusterWindowBase*)&other, whichField, sInfo);
}
void ClusterWindowBase::execBeginEdit(
...
void ClusterWindowBase::copyToBin(BinaryDataHandler& pMem, const BitVector& whichField) {
...
void ClusterWindowBase::copyFromBin(BinaryDataHandler& pMem, const BitVector& whichField) {
...
#if !defined(OSG_FIXED_MFIELDSYNC)
void ClusterWindowBase::executeSyncImpl(ClusterWindowBase* pOther, const BitVector& whichField) {
...
#else
void ClusterWindowBase::executeSyncImpl(
    ClusterWindowBase* pOther, const BitVector& whichField, const SyncInfo& sInfo) {
...
void ClusterWindowBase::execBeginEditImpl(
    const BitVector& whichField, UInt32 uiAspect, UInt32 uiContainerSize) {
