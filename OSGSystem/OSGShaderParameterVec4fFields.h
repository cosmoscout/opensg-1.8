...
struct FieldDataTraits<ShaderParameterVec4fPtr>
  ...
  static const char* getSName(void) {
    return "SFShaderParameterVec4fPtr";
  }
  static const char* getMName(void) {
    return "MFShaderParameterVec4fPtr";
  }
};
...
#define OSGSHADERPARAMETERVEC4FFIELDS_HEADER_CVSID                                                 \
  "@(#)$Id: OSGShaderParameterVec4fFields.h,v 1.5 2006/02/20 17:04:38 dirk Exp $"
