...
void SimpleSceneManager::initialize(void) {
  ...
  if (_win->getPort().size() == 0) {
    ...
    sf->addElement(DrawActionBase::statCullTestedNodes, "Nodes culltested      %d");
    sf->addElement(DrawActionBase::statCulledNodes, "Nodes culled          %d");
    sf->addElement(RenderAction::statNOcclusionMode, "Occlusion culling     %s");
    sf->addElement(RenderAction::statNOcclusionTests, "Occlusion tests       %d");
    sf->addElement(RenderAction::statNOcclusionCulled, "Occlusion culled      %d");
    sf->addElement(RenderAction::statNGeometries, "Nodes drawn           %d");
    sf->addElement(RenderAction::statNTransGeometries, "Transp. Nodes drawn   %d");
    sf->addElement(RenderAction::statNMaterials, "Material changes      %d");
    sf->addElement(RenderAction::statNMatrices, "Matrix changes        %d");
...
#endif
    sf->addElement(Drawable::statNTriangles, "Triangles drawn       %d");
    sf->addElement(Drawable::statNLines, "Lines drawn           %d");
    sf->addElement(Drawable::statNPoints, "Points drawn          %d");
    sf->addElement(Drawable::statNVertices, "Vertices transformed  %d");
    sf->addElement(RenderAction::statNTextures, "Textures used         %d");
    sf->addElement(RenderAction::statNTexBytes, "Textures size (bytes) %d");
    endEditCP(sf);
