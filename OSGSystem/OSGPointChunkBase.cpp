...
/*! \var Real32          PointChunkBase::_sfMinSize
    Minimum point size for attenuation, less than 0 for disabling it. See ARB_point_parameters
   extension.
*/
...
FieldDescription* PointChunkBase::_desc[] = {
    ...
    new FieldDescription(SFReal32::getClassType(), "minSize", MinSizeFieldId, MinSizeFieldMask,
        false, (FieldAccessMethod)&PointChunkBase::getSFMinSize),
    new FieldDescription(SFReal32::getClassType(), "maxSize", MaxSizeFieldId, MaxSizeFieldMask,
        false, (FieldAccessMethod)&PointChunkBase::getSFMaxSize),
    ...
    new FieldDescription(SFReal32::getClassType(), "fadeThreshold", FadeThresholdFieldId,
        FadeThresholdFieldMask, false, (FieldAccessMethod)&PointChunkBase::getSFFadeThreshold),
    new FieldDescription(SFBool::getClassType(), "sprite", SpriteFieldId, SpriteFieldMask, false,
        (FieldAccessMethod)&PointChunkBase::getSFSprite),
    new FieldDescription(SFGLenum::getClassType(), "rMode", RModeFieldId, RModeFieldMask, false,
        (FieldAccessMethod)&PointChunkBase::getSFRMode)};

FieldContainerType PointChunkBase::_type("PointChunk", "StateChunk", NULL,
    (PrototypeCreateF)&PointChunkBase::createEmpty, PointChunk::initMethod, _desc, sizeof(_desc));
...
void PointChunkBase::executeSync(FieldContainer& other, const BitVector& whichField) {
  this->executeSyncImpl((PointChunkBase*)&other, whichField);
}
#else
void PointChunkBase::executeSync(
    FieldContainer& other, const BitVector& whichField, const SyncInfo& sInfo) {
  this->executeSyncImpl((PointChunkBase*)&other, whichField, sInfo);
}
void PointChunkBase::execBeginEdit(
...
void PointChunkBase::copyToBin(BinaryDataHandler& pMem, const BitVector& whichField) {
...
void PointChunkBase::copyFromBin(BinaryDataHandler& pMem, const BitVector& whichField) {
...
#if !defined(OSG_FIXED_MFIELDSYNC)
void PointChunkBase::executeSyncImpl(PointChunkBase* pOther, const BitVector& whichField) {
...
#else
void PointChunkBase::executeSyncImpl(
    PointChunkBase* pOther, const BitVector& whichField, const SyncInfo& sInfo) {
...
void PointChunkBase::execBeginEditImpl(
    const BitVector& whichField, UInt32 uiAspect, UInt32 uiContainerSize) {
