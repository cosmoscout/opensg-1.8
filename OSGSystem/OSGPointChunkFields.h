...
typedef FCPtr<StateChunkPtr, PointChunk> PointChunkPtr;
...
template <>
struct FieldDataTraits<PointChunkPtr> : public FieldTraitsRecurseMapper<PointChunkPtr, true> {
  ...
  static const char* getSName(void) {
    return "SFPointChunkPtr";
  }
  static const char* getMName(void) {
    return "MFPointChunkPtr";
  }
};
...
#define OSGPOINTCHUNKFIELDS_HEADER_CVSID                                                           \
