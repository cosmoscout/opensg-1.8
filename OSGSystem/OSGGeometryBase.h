...
#else
  void executeSyncImpl(GeometryBase* pOther, const BitVector& whichField, const SyncInfo& sInfo);
...
typedef osgIF<GeometryBase::isNodeCore, CoredNodePtr<Geometry>,
    FieldContainer::attempt_to_create_CoredNodePtr_on_non_NodeCore_FC>::_IRet GeometryNodePtr;

typedef RefPtr<GeometryPtr> GeometryRefPtr;

OSG_END_NAMESPACE

#define OSGGEOMETRYBASE_HEADER_CVSID                                                               \
