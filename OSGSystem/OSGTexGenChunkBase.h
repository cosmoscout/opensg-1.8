...
#else
  void executeSyncImpl(TexGenChunkBase* pOther, const BitVector& whichField, const SyncInfo& sInfo);
...
typedef osgIF<TexGenChunkBase::isNodeCore, CoredNodePtr<TexGenChunk>,
    FieldContainer::attempt_to_create_CoredNodePtr_on_non_NodeCore_FC>::_IRet TexGenChunkNodePtr;

typedef RefPtr<TexGenChunkPtr> TexGenChunkRefPtr;

OSG_END_NAMESPACE

#define OSGTEXGENCHUNKBASE_HEADER_CVSID                                                            \
