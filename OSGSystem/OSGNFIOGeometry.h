...
class NFIOGeometry : public NFIOBase {
 ...
 private:
  ...
  template <class VecType, class GeoPropType>
  void writeQuantizedVectors(const GeoPropType& prop, const std::string& fieldName,
...
#define OSGNFIOGEOMETRY_HEADER_CVSID                                                               \
  "@(#)$Id: OSGNFIOGeometry.h,v 1.1 2004/01/08 18:00:04 a-m-z Exp $"
