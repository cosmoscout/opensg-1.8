...
typedef FCPtr<CameraDecoratorPtr, StereoCameraDecorator> StereoCameraDecoratorPtr;
...
struct FieldDataTraits<StereoCameraDecoratorPtr>
  ...
  static const char* getSName(void) {
    return "SFStereoCameraDecoratorPtr";
  }
  static const char* getMName(void) {
    return "MFStereoCameraDecoratorPtr";
  }
};
...
#define OSGSTEREOCAMERADECORATORFIELDS_HEADER_CVSID                                                \
