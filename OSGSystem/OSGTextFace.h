 ...
 */
class OSG_SYSTEMLIB_DLLMAPPING TextFace : public MemoryObject {
  /*==========================  PUBLIC  =================================*/
 public:
   ...
   */
  virtual void layout(
      const std::wstring& text, const TextLayoutParam& param, TextLayoutResult& result) = 0;
 ...
 protected:
   ...
   * by this method.
   */
  void justifyLine(const TextLayoutParam& param, const std::vector<UInt32>& spaceIndices,
