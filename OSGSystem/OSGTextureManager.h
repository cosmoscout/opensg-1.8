...
class OSG_SYSTEMLIB_DLLMAPPING TextureManager {
 public:
  //! Texture mode
  enum TextureMode { TM_3D = 0, TM_2D, TM_2D_Multi, NUM_TEXTURE_MODES };
  ...
  Int32 registerTexture(ImagePtr image, UInt32 internalFormat, UInt32 externalFormat,
      bool doBricking = 1, Int32 textureStage0 = 0, Int32 textureStage1 = -1);
 ...
 private:
  ...
  //! Calculate bricking
  static Vec3f calcBrickSubdivision(
