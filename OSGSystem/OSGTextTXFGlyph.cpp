...
TextTXFGlyph::TextTXFGlyph()
    ...
    , _scale(1.f)
    , _texCoord() {
  _texCoord[COORD_LEFT] = _texCoord[COORD_BOTTOM] = _texCoord[COORD_RIGHT] = _texCoord[COORD_TOP] =
      0.f;
}
...
// Author: pdaehne
//----------------------------------------------------------------------
void TextTXFGlyph::calculateCoordinates(UInt32 textureWidth, UInt32 textureHeight) {
