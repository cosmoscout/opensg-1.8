...
void PointLight::setAttenuation(Real32 rConstant, Real32 rLinear, Real32 rQuadratic) {
...
void PointLight::dump(UInt32 uiIndent, const BitVector bvFlags) const {
...
void PointLight::initMethod(void) {
  DrawAction::registerEnterDefault(getClassType(),
      osgTypedMethodFunctor2BaseCPtrRef<Action::ResultE, PointLightPtr, CNodePtr, Action*>(
          &PointLight::drawEnter));

  DrawAction::registerLeaveDefault(getClassType(),
      osgTypedMethodFunctor2BaseCPtrRef<Action::ResultE, PointLightPtr, CNodePtr, Action*>(
          &PointLight::drawLeave));
