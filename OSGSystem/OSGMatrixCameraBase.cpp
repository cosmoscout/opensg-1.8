...
FieldDescription* MatrixCameraBase::_desc[] = {
    new FieldDescription(SFMatrix::getClassType(), "ProjectionMatrix", ProjectionMatrixFieldId,
        ProjectionMatrixFieldMask, false,
        (FieldAccessMethod)&MatrixCameraBase::getSFProjectionMatrix),
    new FieldDescription(SFMatrix::getClassType(), "ModelviewMatrix", ModelviewMatrixFieldId,
        ModelviewMatrixFieldMask, false,
        (FieldAccessMethod)&MatrixCameraBase::getSFModelviewMatrix)};

FieldContainerType MatrixCameraBase::_type("MatrixCamera", "Camera", NULL,
    (PrototypeCreateF)&MatrixCameraBase::createEmpty, MatrixCamera::initMethod, _desc,
    sizeof(_desc));
...
void MatrixCameraBase::executeSync(FieldContainer& other, const BitVector& whichField) {
  this->executeSyncImpl((MatrixCameraBase*)&other, whichField);
}
#else
void MatrixCameraBase::executeSync(
    FieldContainer& other, const BitVector& whichField, const SyncInfo& sInfo) {
  this->executeSyncImpl((MatrixCameraBase*)&other, whichField, sInfo);
}
void MatrixCameraBase::execBeginEdit(
...
void MatrixCameraBase::copyToBin(BinaryDataHandler& pMem, const BitVector& whichField) {
...
void MatrixCameraBase::copyFromBin(BinaryDataHandler& pMem, const BitVector& whichField) {
...
#if !defined(OSG_FIXED_MFIELDSYNC)
void MatrixCameraBase::executeSyncImpl(MatrixCameraBase* pOther, const BitVector& whichField) {
...
#else
void MatrixCameraBase::executeSyncImpl(
    MatrixCameraBase* pOther, const BitVector& whichField, const SyncInfo& sInfo) {
...
void MatrixCameraBase::execBeginEditImpl(
    const BitVector& whichField, UInt32 uiAspect, UInt32 uiContainerSize) {
