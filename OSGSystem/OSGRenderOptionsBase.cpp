...
FieldDescription* RenderOptionsBase::_desc[] = {
    new FieldDescription(SFBool::getClassType(), "statistic", StatisticFieldId, StatisticFieldMask,
        false, (FieldAccessMethod)&RenderOptionsBase::getSFStatistic),
    new FieldDescription(SFGLenum::getClassType(), "polygonMode", PolygonModeFieldId,
        PolygonModeFieldMask, false, (FieldAccessMethod)&RenderOptionsBase::getSFPolygonMode),
    new FieldDescription(SFBool::getClassType(), "twoSidedLighting", TwoSidedLightingFieldId,
        TwoSidedLightingFieldMask, false,
        (FieldAccessMethod)&RenderOptionsBase::getSFTwoSidedLighting),
    new FieldDescription(SFBool::getClassType(), "specTexLighting", SpecTexLightingFieldId,
        SpecTexLightingFieldMask, false,
        (FieldAccessMethod)&RenderOptionsBase::getSFSpecTexLighting),
    new FieldDescription(SFBool::getClassType(), "sortTrans", SortTransFieldId, SortTransFieldMask,
        false, (FieldAccessMethod)&RenderOptionsBase::getSFSortTrans),
    new FieldDescription(SFBool::getClassType(), "zWriteTrans", ZWriteTransFieldId,
        ZWriteTransFieldMask, false, (FieldAccessMethod)&RenderOptionsBase::getSFZWriteTrans),
    new FieldDescription(SFBool::getClassType(), "localLights", LocalLightsFieldId,
        LocalLightsFieldMask, false, (FieldAccessMethod)&RenderOptionsBase::getSFLocalLights),
    new FieldDescription(SFBool::getClassType(), "correctTwoSidedLighting",
        CorrectTwoSidedLightingFieldId, CorrectTwoSidedLightingFieldMask, false,
        (FieldAccessMethod)&RenderOptionsBase::getSFCorrectTwoSidedLighting),
    new FieldDescription(SFBool::getClassType(), "occlusionCulling", OcclusionCullingFieldId,
        OcclusionCullingFieldMask, false,
        (FieldAccessMethod)&RenderOptionsBase::getSFOcclusionCulling),
    new FieldDescription(SFInt32::getClassType(), "occlusionCullingMode",
        OcclusionCullingModeFieldId, OcclusionCullingModeFieldMask, false,
        (FieldAccessMethod)&RenderOptionsBase::getSFOcclusionCullingMode),
    new FieldDescription(SFUInt32::getClassType(), "occlusionCullingPixels",
        OcclusionCullingPixelsFieldId, OcclusionCullingPixelsFieldMask, false,
        (FieldAccessMethod)&RenderOptionsBase::getSFOcclusionCullingPixels),
    new FieldDescription(SFBool::getClassType(), "antialiasing", AntialiasingFieldId,
        AntialiasingFieldMask, false, (FieldAccessMethod)&RenderOptionsBase::getSFAntialiasing),
    new FieldDescription(SFReal32::getClassType(), "antialiasingDistance",
        AntialiasingDistanceFieldId, AntialiasingDistanceFieldMask, false,
        (FieldAccessMethod)&RenderOptionsBase::getSFAntialiasingDistance),
    new FieldDescription(SFReal32::getClassType(), "antialiasingScale", AntialiasingScaleFieldId,
        AntialiasingScaleFieldMask, false,
        (FieldAccessMethod)&RenderOptionsBase::getSFAntialiasingScale),
    new FieldDescription(SFUInt32::getClassType(), "antialiasingTrigger",
        AntialiasingTriggerFieldId, AntialiasingTriggerFieldMask, false,
        (FieldAccessMethod)&RenderOptionsBase::getSFAntialiasingTrigger),
    new FieldDescription(SFBool::getClassType(), "frustumCulling", FrustumCullingFieldId,
        FrustumCullingFieldMask, false, (FieldAccessMethod)&RenderOptionsBase::getSFFrustumCulling),
    new FieldDescription(SFBool::getClassType(), "backfaceCulling", BackfaceCullingFieldId,
        BackfaceCullingFieldMask, false,
        (FieldAccessMethod)&RenderOptionsBase::getSFBackfaceCulling),
    new FieldDescription(SFBool::getClassType(), "smallFeatureCulling", SmallFeatureCullingFieldId,
        SmallFeatureCullingFieldMask, false,
        (FieldAccessMethod)&RenderOptionsBase::getSFSmallFeatureCulling),
    new FieldDescription(SFReal32::getClassType(), "smallFeaturePixels", SmallFeaturePixelsFieldId,
        SmallFeaturePixelsFieldMask, false,
        (FieldAccessMethod)&RenderOptionsBase::getSFSmallFeaturePixels),
    new FieldDescription(SFUInt32::getClassType(), "smallFeatureThreshold",
        SmallFeatureThresholdFieldId, SmallFeatureThresholdFieldMask, false,
        (FieldAccessMethod)&RenderOptionsBase::getSFSmallFeatureThreshold),
    new FieldDescription(SFBool::getClassType(), "firstFrame", FirstFrameFieldId,
        FirstFrameFieldMask, false, (FieldAccessMethod)&RenderOptionsBase::getSFFirstFrame)};

FieldContainerType RenderOptionsBase::_type("RenderOptions", "Attachment", NULL,
    (PrototypeCreateF)&RenderOptionsBase::createEmpty, RenderOptions::initMethod, _desc,
    sizeof(_desc));
...
void RenderOptionsBase::executeSync(FieldContainer& other, const BitVector& whichField) {
  this->executeSyncImpl((RenderOptionsBase*)&other, whichField);
}
#else
void RenderOptionsBase::executeSync(
    FieldContainer& other, const BitVector& whichField, const SyncInfo& sInfo) {
  this->executeSyncImpl((RenderOptionsBase*)&other, whichField, sInfo);
}
void RenderOptionsBase::execBeginEdit(
...
void RenderOptionsBase::copyToBin(BinaryDataHandler& pMem, const BitVector& whichField) {
...
void RenderOptionsBase::copyFromBin(BinaryDataHandler& pMem, const BitVector& whichField) {
...
#if !defined(OSG_FIXED_MFIELDSYNC)
void RenderOptionsBase::executeSyncImpl(RenderOptionsBase* pOther, const BitVector& whichField) {
...
#else
void RenderOptionsBase::executeSyncImpl(
...
void RenderOptionsBase::execBeginEditImpl(
    const BitVector& whichField, UInt32 uiAspect, UInt32 uiContainerSize) {
