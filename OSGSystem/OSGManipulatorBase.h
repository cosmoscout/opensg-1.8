...
class OSG_SYSTEMLIB_DLLMAPPING ManipulatorBase : public Transform {
 ...
 protected:
  ...
  void executeSyncImpl(ManipulatorBase* pOther, const BitVector& whichField);

  virtual void executeSync(FieldContainer& other, const BitVector& whichField);
#else
  void executeSyncImpl(ManipulatorBase* pOther, const BitVector& whichField, const SyncInfo& sInfo);
...
typedef osgIF<ManipulatorBase::isNodeCore, CoredNodePtr<Manipulator>,
    FieldContainer::attempt_to_create_CoredNodePtr_on_non_NodeCore_FC>::_IRet ManipulatorNodePtr;

typedef RefPtr<ManipulatorPtr> ManipulatorRefPtr;

OSG_END_NAMESPACE

#define OSGMANIPULATORBASE_HEADER_CVSID                                                            \
  "@(#)$Id: OSGManipulatorBase.h,v 1.5 2006/02/20 17:04:35 dirk Exp $"
