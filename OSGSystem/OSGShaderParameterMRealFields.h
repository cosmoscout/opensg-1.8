...
#if !defined(OSG_DOC_DEV_TRAITS)
/*! \class  FieldTraitsRecurseMapper<ShaderParameterMRealPtr, true>
    \hideinhierarchy
 */
#endif
...
typedef SField<ShaderParameterMRealPtr> SFShaderParameterMRealPtr;
#endif

#ifndef OSG_COMPILESHADERPARAMETERMREALINST
OSG_DLLEXPORT_DECL1(SField, ShaderParameterMRealPtr, OSG_SYSTEMLIB_DLLTMPLMAPPING)
#endif

#if !defined(OSG_DO_DOC) || defined(OSG_DOC_FIELD_TYPEDEFS)
/*! \ingroup GrpSystemFieldMulti */

typedef MField<ShaderParameterMRealPtr> MFShaderParameterMRealPtr;
#endif

#ifndef OSG_COMPILESHADERPARAMETERMREALINST
OSG_DLLEXPORT_DECL1(MField, ShaderParameterMRealPtr, OSG_SYSTEMLIB_DLLTMPLMAPPING)
#endif
