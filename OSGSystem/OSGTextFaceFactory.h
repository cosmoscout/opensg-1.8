...
class OSG_SYSTEMLIB_DLLMAPPING TextFaceFactory {
 ...
 public:
   ...
   */
  TextVectorFace* createVectorFace(
      const std::string& family, TextFace::Style style = TextFace::STYLE_PLAIN);
   ...
   */
  TextPixmapFace* createPixmapFace(
      const std::string& family, TextFace::Style style = TextFace::STYLE_PLAIN, UInt32 size = 32);
  ...
  TextTXFFace* createTXFFace(const std::string& family,
      TextFace::Style style = TextFace::STYLE_PLAIN, const TextTXFParam& param = TextTXFParam());
...
#define OSGTEXTFACEFACTORY_HEADER_CVSID                                                            \
  "@(#)$Id: OSGTextFaceFactory.h,v 1.2 2006/10/27 13:52:13 a-m-z Exp $"
