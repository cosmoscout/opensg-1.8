...
FieldDescription* TextureBackgroundBase::_desc[] = {
    ...
    new FieldDescription(SFTextureChunkPtr::getClassType(), "texture", TextureFieldId,
        TextureFieldMask, false, (FieldAccessMethod)&TextureBackgroundBase::getSFTexture),
    new FieldDescription(MFPnt2f::getClassType(), "texCoords", TexCoordsFieldId, TexCoordsFieldMask,
        false, (FieldAccessMethod)&TextureBackgroundBase::getMFTexCoords),
    new FieldDescription(SFReal32::getClassType(), "radialDistortion", RadialDistortionFieldId,
        RadialDistortionFieldMask, false,
        (FieldAccessMethod)&TextureBackgroundBase::getSFRadialDistortion),
    new FieldDescription(SFVec2f::getClassType(), "centerOfDistortion", CenterOfDistortionFieldId,
        CenterOfDistortionFieldMask, false,
        (FieldAccessMethod)&TextureBackgroundBase::getSFCenterOfDistortion),
    new FieldDescription(SFUInt16::getClassType(), "hor", HorFieldId, HorFieldMask, false,
        (FieldAccessMethod)&TextureBackgroundBase::getSFHor),
    new FieldDescription(SFUInt16::getClassType(), "vert", VertFieldId, VertFieldMask, false,
...
FieldContainerType TextureBackgroundBase::_type("TextureBackground", "Background", NULL,
    (PrototypeCreateF)&TextureBackgroundBase::createEmpty, TextureBackground::initMethod, _desc,
    sizeof(_desc));
...
void TextureBackgroundBase::executeSync(FieldContainer& other, const BitVector& whichField) {
  this->executeSyncImpl((TextureBackgroundBase*)&other, whichField);
}
#else
void TextureBackgroundBase::executeSync(
    FieldContainer& other, const BitVector& whichField, const SyncInfo& sInfo) {
  this->executeSyncImpl((TextureBackgroundBase*)&other, whichField, sInfo);
}
void TextureBackgroundBase::execBeginEdit(
...
void TextureBackgroundBase::copyToBin(BinaryDataHandler& pMem, const BitVector& whichField) {
...
void TextureBackgroundBase::copyFromBin(BinaryDataHandler& pMem, const BitVector& whichField) {
...
#if !defined(OSG_FIXED_MFIELDSYNC)
void TextureBackgroundBase::executeSyncImpl(
    TextureBackgroundBase* pOther, const BitVector& whichField) {
...
void TextureBackgroundBase::execBeginEditImpl(
    const BitVector& whichField, UInt32 uiAspect, UInt32 uiContainerSize) {
