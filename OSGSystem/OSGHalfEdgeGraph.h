...
class OSG_SYSTEMLIB_DLLMAPPING HalfEdgeGraph {
 ...
 private:
  ...
  class HalfEdge {
   ...
   public:
    ...
    inline void   setVertex(IndexT startVertexIndex, IndexT endVertexIndex);
  ...
  inline void dropOutTriangle(Triangle& triangle, TriangleList* degreeBag);
 ...
 protected:
  inline HalfEdge* getHalfEdge(UInt32 startVertexIndex, UInt32 endVertexIndex);
  inline void      addHalfEdge(HalfEdge& halfEdge, UInt32 startVertexIndex, UInt32 endVertexIndex);
  inline HalfEdge* findGateEdge(Triangle* triangleOut, Triangle* triangleIn);
 ...
 public:
  ...
  UInt32 calcOptPrim(UInt32 iteration = 1, bool doStrip = true, bool doFan = true,
