...
void ScanParseSkel::handleError(const Char8* szErrorText) {
  FWARNING(
      ("-----> %s in Line %d, read '%s'\n", szErrorText, _pLexer->lineno(), _pLexer->YYText()));
}
...
bool ScanParseSkel::verifyHeader(const Char8* szHeader) {
  ...
  if (_szReferenceHeader != NULL) {
    if (strncmp(szHeader, _szReferenceHeader, stringlen(_szReferenceHeader)) != 0) {
      SLOG << "Error : Header [" << szHeader << "] does not "
           << "match reference [" << _szReferenceHeader << "]" << std::endl;
...
void ScanParseSkel::beginEventInDecl(const Char8*, const UInt32, const Char8*) {
}

void ScanParseSkel::beginEventOutDecl(const Char8*, const UInt32, const Char8*) {
}

void ScanParseSkel::endEventDecl(void) {
}

void ScanParseSkel::beginFieldDecl(const Char8*, const UInt32, const Char8*) {
}

void ScanParseSkel::endFieldDecl(void) {
}

void ScanParseSkel::beginExposedFieldDecl(const Char8*, const UInt32, const Char8*) {
}

void ScanParseSkel::endExposedFieldDecl(void) {
}

void ScanParseSkel::addExternEventInDecl(const Char8*, const UInt32, const Char8*) {
}

void ScanParseSkel::addExternEventOutDecl(const Char8*, const UInt32, const Char8*) {
}

void ScanParseSkel::addExternFieldDecl(const Char8*, const UInt32, const Char8*) {
}

void ScanParseSkel::addExternExposedFieldDecl(const Char8*, const UInt32, const Char8*) {
}

/*-------------------------------------------------------------------------*/
/*                               Fields                                    */

void ScanParseSkel::beginField(const Char8*, const UInt32) {
}
...
void ScanParseSkel::beginNode(const Char8* szNodeTypename, const Char8* szNodename) {
  fprintf(stderr, "Calling default begin node %s %s\n", szNodeTypename, szNodename);
}
...
void ScanParseSkel::metaElement(const Char8* szMetaKey, const Char8* szMetaValue) {
  fprintf(stderr, "META %s %s\n", szMetaKey, szMetaValue);
}

void ScanParseSkel::importElement(
...
void ScanParseSkel::exportElement(const Char8* szNodeName, const Char8* szExportAs) {
...
void ScanParseSkel::addMatrix3dValue(Real64 m00, Real64 m10, Real64 m20, Real64 m01, Real64 m11,
    Real64 m21, Real64 m02, Real64 m12, Real64 m22) {
  addFieldValue(_tmpString1.c_str());
}

void ScanParseSkel::addMatrix3fValue(Real32 m00, Real32 m10, Real32 m20, Real32 m01, Real32 m11,
...
void ScanParseSkel::addRoute(const Char8*, const Char8*, const Char8*, const Char8*) {
}
