...
inline const StatCollector* NewActionBase::getStatistics(void) const {
  return _pStatistics;
}

inline StatCollector* NewActionBase::getStatistics(void) {
  return _pStatistics;
}

inline void NewActionBase::setStatistics(StatCollector* pStatistics) {
...
inline UInt32 NewActionBase::getTravMask(void) const {
  return _travMask;
}
...
inline void NewActionBase::setTravMask(UInt32 travMask) {
  _travMask = travMask;
}
...
inline bool NewActionBase::getChildrenListEnabled(void) const {
...
inline void NewActionBase::setChildrenListEnabled(bool enabled) {
...
inline const ChildrenList& NewActionBase::getChildrenList(void) const {
...
inline ChildrenList& NewActionBase::getChildrenList(void) {
  return _childrenList;
}
...
inline const ExtraChildrenList& NewActionBase::getExtraChildrenList(void) const {
...
inline ExtraChildrenList& NewActionBase::getExtraChildrenList(void) {
  return _extraChildrenList;
}
...
inline UInt32 NewActionBase::getNumPasses(void) const {
  return _numPasses;
}

inline void NewActionBase::setNumPasses(UInt32 numPasses) {
...
inline NewActionBase::ExtendActorStoreConstIt NewActionBase::beginExtend(void) const {
...
inline NewActionBase::ExtendActorStoreIt NewActionBase::beginExtend(void) {
  return _extendActors.begin();
}
...
inline NewActionBase::ExtendActorStoreConstIt NewActionBase::endExtend(void) const {
...
inline NewActionBase::ExtendActorStoreIt NewActionBase::endExtend(void) {
  return _extendActors.end();
}
...
inline NewActionBase::BasicActorStoreConstIt NewActionBase::beginBasic(void) const {
...
inline NewActionBase::BasicActorStoreIt NewActionBase::beginBasic(void) {
  return _basicActors.begin();
}
...
inline NewActionBase::BasicActorStoreConstIt NewActionBase::endBasic(void) const {
...
inline NewActionBase::BasicActorStoreIt NewActionBase::endBasic(void) {
  return _basicActors.end();
}

OSG_END_NAMESPACE

#define OSGNEWACTIONBASE_INLINE_CVSID                                                              \
  "@(#)$Id: OSGNewActionBase.inl,v 1.3 2004/09/17 14:09:43 neumannc Exp $"
