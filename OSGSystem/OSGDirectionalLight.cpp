...
void DirectionalLight::dump(UInt32 uiIndent, const BitVector bvFlags) const {
...
void DirectionalLight::initMethod(void) {
  DrawAction::registerEnterDefault(getClassType(),
      osgTypedMethodFunctor2BaseCPtrRef<Action::ResultE, DirectionalLightPtr, CNodePtr, Action*>(
          &DirectionalLight::drawEnter));

  DrawAction::registerLeaveDefault(getClassType(),
      osgTypedMethodFunctor2BaseCPtrRef<Action::ResultE, DirectionalLightPtr, CNodePtr, Action*>(
          &DirectionalLight::drawLeave));
  ...
  RenderAction::registerLeaveDefault(
      getClassType(), osgTypedMethodFunctor2BaseCPtrRef<OSG::Action::ResultE, DirectionalLightPtr,
                          CNodePtr, Action*>(&DirectionalLight::renderLeave));
}
