...
/*! \var Real32          ViewportBase::_sfLeft
    The left edge of the viewport. Values between 0 and 1 are relative to the size of 	the Window,
   values &gt; 1 are absolute pixel coordinates, value == -1 means the  	left border. All other
   values are illegal.
*/
/*! \var Real32          ViewportBase::_sfRight
    The right edge of the viewport. Values between 0 and 1 are relative to the size of 	the Window,
   values &gt; 1 are absolute pixel coordinates, value == -1 means the  	right border. All other
   values are illegal.
*/
/*! \var Real32          ViewportBase::_sfBottom
    The bottom edge of the viewport. Values between 0 and 1 are relative to the size of 	the
   Window, values &gt; 1 are absolute pixel coordinates, value == -1 means the  	bottom border.
   All other values are illegal.
*/
/*! \var Real32          ViewportBase::_sfTop
    The top edge of the viewport. Values between 0 and 1 are relative to the size of 	the Window,
   values &gt; 1 are absolute pixel coordinates, value == -1 means the  	top border. All other
   values are illegal.
*/
...
FieldDescription* ViewportBase::_desc[] = {
    new FieldDescription(SFReal32::getClassType(), "left", LeftFieldId, LeftFieldMask, false,
        (FieldAccessMethod)&ViewportBase::getSFLeft),
    new FieldDescription(SFReal32::getClassType(), "right", RightFieldId, RightFieldMask, false,
        (FieldAccessMethod)&ViewportBase::getSFRight),
    new FieldDescription(SFReal32::getClassType(), "bottom", BottomFieldId, BottomFieldMask, false,
        (FieldAccessMethod)&ViewportBase::getSFBottom),
    new FieldDescription(SFReal32::getClassType(), "top", TopFieldId, TopFieldMask, false,
        (FieldAccessMethod)&ViewportBase::getSFTop),
    new FieldDescription(SFWindowPtr::getClassType(), "parent", ParentFieldId, ParentFieldMask,
        false, (FieldAccessMethod)&ViewportBase::getSFParent),
    new FieldDescription(SFCameraPtr::getClassType(), "camera", CameraFieldId, CameraFieldMask,
        false, (FieldAccessMethod)&ViewportBase::getSFCamera),
    new FieldDescription(SFNodePtr::getClassType(), "root", RootFieldId, RootFieldMask, false,
        (FieldAccessMethod)&ViewportBase::getSFRoot),
    new FieldDescription(SFBackgroundPtr::getClassType(), "background", BackgroundFieldId,
        BackgroundFieldMask, false, (FieldAccessMethod)&ViewportBase::getSFBackground),
    new FieldDescription(MFForegroundPtr::getClassType(), "foregrounds", ForegroundsFieldId,
        ForegroundsFieldMask, false, (FieldAccessMethod)&ViewportBase::getMFForegrounds),
    new FieldDescription(SFUInt32::getClassType(), "travMask", TravMaskFieldId, TravMaskFieldMask,
        false, (FieldAccessMethod)&ViewportBase::getSFTravMask),
    new FieldDescription(SFReal32::getClassType(), "drawTime", DrawTimeFieldId, DrawTimeFieldMask,
        true, (FieldAccessMethod)&ViewportBase::getSFDrawTime)};

FieldContainerType ViewportBase::_type("Viewport", "AttachmentContainer", NULL,
    (PrototypeCreateF)&ViewportBase::createEmpty, Viewport::initMethod, _desc, sizeof(_desc));
...
void ViewportBase::executeSync(FieldContainer& other, const BitVector& whichField) {
  this->executeSyncImpl((ViewportBase*)&other, whichField);
}
#else
void ViewportBase::executeSync(
    FieldContainer& other, const BitVector& whichField, const SyncInfo& sInfo) {
  this->executeSyncImpl((ViewportBase*)&other, whichField, sInfo);
}
void ViewportBase::execBeginEdit(
...
void ViewportBase::copyToBin(BinaryDataHandler& pMem, const BitVector& whichField) {
...
void ViewportBase::copyFromBin(BinaryDataHandler& pMem, const BitVector& whichField) {
...
#if !defined(OSG_FIXED_MFIELDSYNC)
void ViewportBase::executeSyncImpl(ViewportBase* pOther, const BitVector& whichField) {
...
#else
void ViewportBase::executeSyncImpl(
    ViewportBase* pOther, const BitVector& whichField, const SyncInfo& sInfo) {
...
void ViewportBase::execBeginEditImpl(
    const BitVector& whichField, UInt32 uiAspect, UInt32 uiContainerSize) {
