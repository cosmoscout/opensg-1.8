...
FieldDescription* OffCenterPerspectiveCameraBase::_desc[] = {new FieldDescription(
    SFVec2f::getClassType(), "principalPoint", PrincipalPointFieldId, PrincipalPointFieldMask,
    false, (FieldAccessMethod)&OffCenterPerspectiveCameraBase::getSFPrincipalPoint)};

FieldContainerType OffCenterPerspectiveCameraBase::_type("OffCenterPerspectiveCamera",
    "PerspectiveCamera", NULL, (PrototypeCreateF)&OffCenterPerspectiveCameraBase::createEmpty,
    OffCenterPerspectiveCamera::initMethod, _desc, sizeof(_desc));
...
void OffCenterPerspectiveCameraBase::executeSync(
...
void OffCenterPerspectiveCameraBase::execBeginEdit(
...
OffCenterPerspectiveCameraBase::OffCenterPerspectiveCameraBase(
    const OffCenterPerspectiveCameraBase& source)
...
void OffCenterPerspectiveCameraBase::copyToBin(
...
void OffCenterPerspectiveCameraBase::copyFromBin(
    BinaryDataHandler& pMem, const BitVector& whichField) {
...
#if !defined(OSG_FIXED_MFIELDSYNC)
void OffCenterPerspectiveCameraBase::executeSyncImpl(
    OffCenterPerspectiveCameraBase* pOther, const BitVector& whichField) {
...
void OffCenterPerspectiveCameraBase::execBeginEditImpl(
    const BitVector& whichField, UInt32 uiAspect, UInt32 uiContainerSize) {
...
DataType FieldDataTraits<OffCenterPerspectiveCameraPtr>::_type(
    "OffCenterPerspectiveCameraPtr", "PerspectiveCameraPtr");
#endif
