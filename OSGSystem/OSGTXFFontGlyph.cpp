...
bool TXFFontGlyph::setSizes(Real32* OSG_CHECK_ARG(_boundingBox), Real32& OSG_CHECK_ARG(_advance)) {
  return true;
}

bool TXFFontGlyph::setSizes(Int32* OSG_CHECK_ARG(_boundingBox), Int32& OSG_CHECK_ARG(_advance)) {
  return true;
}
