 ...
 */
class OSG_SYSTEMLIB_DLLMAPPING TextPixmapGlyph : public TextGlyph {
 ...
 public:
   ...
   */
  void putPixmap(Int32 x, Int32 y, UInt8* tex, UInt32 width, UInt32 height) const;
...
#define OSGTEXTPIXMAPGLYPH_HEADER_CVSID                                                            \
  "@(#)$Id: OSGTextPixmapGlyph.h,v 1.1 2005/03/03 13:43:07 a-m-z Exp $"
