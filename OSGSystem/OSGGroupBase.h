...
#else
  void executeSyncImpl(GroupBase* pOther, const BitVector& whichField, const SyncInfo& sInfo);
...
typedef osgIF<GroupBase::isNodeCore, CoredNodePtr<Group>,
    FieldContainer::attempt_to_create_CoredNodePtr_on_non_NodeCore_FC>::_IRet GroupNodePtr;

typedef RefPtr<GroupPtr> GroupRefPtr;

OSG_END_NAMESPACE

#define OSGGROUPBASE_HEADER_CVSID                                                                  \
