...
inline UInt32 TextureChunk::getStaticClassId(void) {
  return getStaticClass()->getId();
}

inline const StateChunkClass* TextureChunk::getStaticClass(void) {
  return &TextureChunk::_class;
}

inline void TextureChunk::setImage(ImagePtr& pImage) {
  addRefCP(pImage);
...
inline void TextureChunk::imageContentChanged(
    Int32 minx, Int32 maxx, Int32 miny, Int32 maxy, Int32 minz, Int32 maxz) {
  TextureChunkPtr tc(*this);

  beginEditCP(tc, DirtyMinXFieldMask | DirtyMaxXFieldMask | DirtyMinYFieldMask |
                      DirtyMaxYFieldMask | DirtyMinZFieldMask | DirtyMaxZFieldMask);
  ...
  endEditCP(tc, DirtyMinXFieldMask | DirtyMaxXFieldMask | DirtyMinYFieldMask | DirtyMaxYFieldMask |
...
inline void TextureChunk::activeTexture(Window* win, UInt16 texture) {
  void(OSG_APIENTRY * ActiveTexture)(GLenum target) =
      (void(OSG_APIENTRY*)(GLenum target))win->getFunction(_funcActiveTexture);
...
inline bool TextureChunk::activateTexture(Window* win, UInt16 texture) {
...
inline void TextureChunk::setShaderOffsetMatrix(Real32 m11, Real32 m12, Real32 m21, Real32 m22) {
...
#define OSGTEXTURECHUNK_INLINE_CVSID                                                               \
