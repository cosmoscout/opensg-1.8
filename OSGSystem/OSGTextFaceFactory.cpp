...
// Author: pdaehne
//----------------------------------------------------------------------
TextVectorFace* TextFaceFactory::createVectorFace(const string& family, TextFace::Style style) {
...
// Author: pdaehne
//----------------------------------------------------------------------
TextPixmapFace* TextFaceFactory::createPixmapFace(
...
// Author: pdaehne
//----------------------------------------------------------------------
TextTXFFace* TextFaceFactory::createTXFFace(
