...
/*! \var GLenum          StencilChunkBase::_sfStencilFunc
    The stencilFunc defines how fragments which do not fulfill a certain condition are handled. See
   glStencilFunc() for details. GL_NONE is used to disable stencil.
*/
...
/*! \var UInt32          StencilChunkBase::_sfBitMask
    Controls writing of individual bits in stencil planes, with 0 means write protected and 1 write
   enabled.
*/
...
FieldDescription* StencilChunkBase::_desc[] = {
    new FieldDescription(SFGLenum::getClassType(), "stencilFunc", StencilFuncFieldId,
        StencilFuncFieldMask, false, (FieldAccessMethod)&StencilChunkBase::getSFStencilFunc),
    new FieldDescription(SFInt32::getClassType(), "stencilValue", StencilValueFieldId,
        StencilValueFieldMask, false, (FieldAccessMethod)&StencilChunkBase::getSFStencilValue),
    new FieldDescription(SFUInt32::getClassType(), "stencilMask", StencilMaskFieldId,
        StencilMaskFieldMask, false, (FieldAccessMethod)&StencilChunkBase::getSFStencilMask),
    new FieldDescription(SFGLenum::getClassType(), "stencilOpFail", StencilOpFailFieldId,
        StencilOpFailFieldMask, false, (FieldAccessMethod)&StencilChunkBase::getSFStencilOpFail),
    new FieldDescription(SFGLenum::getClassType(), "stencilOpZFail", StencilOpZFailFieldId,
        StencilOpZFailFieldMask, false, (FieldAccessMethod)&StencilChunkBase::getSFStencilOpZFail),
    new FieldDescription(SFGLenum::getClassType(), "stencilOpZPass", StencilOpZPassFieldId,
        StencilOpZPassFieldMask, false, (FieldAccessMethod)&StencilChunkBase::getSFStencilOpZPass),
    new FieldDescription(SFInt32::getClassType(), "clearBuffer", ClearBufferFieldId,
        ClearBufferFieldMask, false, (FieldAccessMethod)&StencilChunkBase::getSFClearBuffer),
    new FieldDescription(SFUInt32::getClassType(), "bitMask", BitMaskFieldId, BitMaskFieldMask,
        false, (FieldAccessMethod)&StencilChunkBase::getSFBitMask)};

FieldContainerType StencilChunkBase::_type("StencilChunk", "StateChunk", NULL,
    (PrototypeCreateF)&StencilChunkBase::createEmpty, StencilChunk::initMethod, _desc,
    sizeof(_desc));
...
void StencilChunkBase::executeSync(FieldContainer& other, const BitVector& whichField) {
  this->executeSyncImpl((StencilChunkBase*)&other, whichField);
}
#else
void StencilChunkBase::executeSync(
    FieldContainer& other, const BitVector& whichField, const SyncInfo& sInfo) {
  this->executeSyncImpl((StencilChunkBase*)&other, whichField, sInfo);
}
void StencilChunkBase::execBeginEdit(
...
void StencilChunkBase::copyToBin(BinaryDataHandler& pMem, const BitVector& whichField) {
...
void StencilChunkBase::copyFromBin(BinaryDataHandler& pMem, const BitVector& whichField) {
...
#if !defined(OSG_FIXED_MFIELDSYNC)
void StencilChunkBase::executeSyncImpl(StencilChunkBase* pOther, const BitVector& whichField) {
...
#else
void StencilChunkBase::executeSyncImpl(
    StencilChunkBase* pOther, const BitVector& whichField, const SyncInfo& sInfo) {
...
void StencilChunkBase::execBeginEditImpl(
    const BitVector& whichField, UInt32 uiAspect, UInt32 uiContainerSize) {
