...
class AbstractGeoProperty : public GeoPropertyDesc::Inherited
...
#endif
{
 ...
 public:
  ...
  virtual bool insertValue(const GenericType& val, const UInt32 index) = 0;
...
*/
template <class GeoPropertyDesc>
class GeoProperty : public GeoPropertyDesc::Inherited {
  /*==========================  PRIVATE  ================================*/
 private:
  // Cannot name type Inherited because of MS compiler probs
 ...
 public:
  ...
  static const BitVector GeoPropDataFieldMask = 1 << static_cast<Int32>(GeoPropDataFieldId);
 ...
 protected:
  ...
  void executeSyncImpl(GeoProperty* pOther, const BitVector& whichField, const SyncInfo& sInfo);
