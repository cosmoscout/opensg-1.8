...
inline BillboardPtr BillboardBase::create(void) {
  ...
  if (getClassType().getPrototype() != OSG::NullFC) {
    fc = BillboardPtr::dcast(getClassType().getPrototype()->shallowCopy());
  }
...
inline SFVec3f* BillboardBase::getSFAxisOfRotation(void) {
  return &_sfAxisOfRotation;
}

//! Get the Billboard::_sfFocusOnCamera field.
inline SFBool* BillboardBase::getSFFocusOnCamera(void) {
  return &_sfFocusOnCamera;
}

//! Get the Billboard::_sfAlignToScreen field.
inline SFBool* BillboardBase::getSFAlignToScreen(void) {
  return &_sfAlignToScreen;
}

//! Get the Billboard::_sfMinAngle field.
inline SFReal32* BillboardBase::getSFMinAngle(void) {
  return &_sfMinAngle;
}

//! Get the Billboard::_sfMaxAngle field.
inline SFReal32* BillboardBase::getSFMaxAngle(void) {
  return &_sfMaxAngle;
}

//! Get the value of the Billboard::_sfAxisOfRotation field.
inline Vec3f& BillboardBase::getAxisOfRotation(void) {
  return _sfAxisOfRotation.getValue();
}

//! Get the value of the Billboard::_sfAxisOfRotation field.
inline const Vec3f& BillboardBase::getAxisOfRotation(void) const {
  return _sfAxisOfRotation.getValue();
}

//! Set the value of the Billboard::_sfAxisOfRotation field.
inline void BillboardBase::setAxisOfRotation(const Vec3f& value) {
  _sfAxisOfRotation.setValue(value);
}

//! Get the value of the Billboard::_sfFocusOnCamera field.
inline bool& BillboardBase::getFocusOnCamera(void) {
  return _sfFocusOnCamera.getValue();
}

//! Get the value of the Billboard::_sfFocusOnCamera field.
inline const bool& BillboardBase::getFocusOnCamera(void) const {
  return _sfFocusOnCamera.getValue();
}

//! Set the value of the Billboard::_sfFocusOnCamera field.
inline void BillboardBase::setFocusOnCamera(const bool& value) {
  _sfFocusOnCamera.setValue(value);
}

//! Get the value of the Billboard::_sfAlignToScreen field.
inline bool& BillboardBase::getAlignToScreen(void) {
  return _sfAlignToScreen.getValue();
}

//! Get the value of the Billboard::_sfAlignToScreen field.
inline const bool& BillboardBase::getAlignToScreen(void) const {
  return _sfAlignToScreen.getValue();
}

//! Set the value of the Billboard::_sfAlignToScreen field.
inline void BillboardBase::setAlignToScreen(const bool& value) {
  _sfAlignToScreen.setValue(value);
}

//! Get the value of the Billboard::_sfMinAngle field.
inline Real32& BillboardBase::getMinAngle(void) {
  return _sfMinAngle.getValue();
}

//! Get the value of the Billboard::_sfMinAngle field.
inline const Real32& BillboardBase::getMinAngle(void) const {
  return _sfMinAngle.getValue();
}

//! Set the value of the Billboard::_sfMinAngle field.
inline void BillboardBase::setMinAngle(const Real32& value) {
  _sfMinAngle.setValue(value);
}

//! Get the value of the Billboard::_sfMaxAngle field.
inline Real32& BillboardBase::getMaxAngle(void) {
  return _sfMaxAngle.getValue();
}

//! Get the value of the Billboard::_sfMaxAngle field.
inline const Real32& BillboardBase::getMaxAngle(void) const {
  return _sfMaxAngle.getValue();
}

//! Set the value of the Billboard::_sfMaxAngle field.
inline void BillboardBase::setMaxAngle(const Real32& value) {
  _sfMaxAngle.setValue(value);
}

OSG_END_NAMESPACE

#define OSGBILLBOARDBASE_INLINE_CVSID                                                              \
