...
*/
inline Int32 LineIterator::getIndex(void) const {
  return _lineIndex;
}

inline Int32 LineIterator::getPositionIndex(Int32 which) const {
  return Inherited::getPositionIndex(_linePntIndex[which]);
}

inline Pnt3f LineIterator::getPosition(Int32 which) const {
  Int32 ind = getPositionIndex(which);

  return getGeometry()->getPositions()->getValue(ind);
}

inline Int32 LineIterator::getNormalIndex(Int32 which) const {
  return Inherited::getNormalIndex(_linePntIndex[which]);
}

inline Vec3f LineIterator::getNormal(Int32 which) const {
...
inline Int32 LineIterator::getColorIndex(Int32 which) const {
  return Inherited::getColorIndex(_linePntIndex[which]);
}

inline Color3f LineIterator::getColor(Int32 which) const {
...
inline Int32 LineIterator::getSecondaryColorIndex(Int32 which) const {
  return Inherited::getSecondaryColorIndex(_linePntIndex[which]);
}

inline Color3f LineIterator::getSecondaryColor(Int32 which) const {
...
inline Int32 LineIterator::getTexCoordsIndex(Int32 which) const {
  return Inherited::getTexCoordsIndex(_linePntIndex[which]);
}

inline Vec2f LineIterator::getTexCoords(Int32 which) const {
...
inline Int32 LineIterator::getTexCoordsIndex1(Int32 which) const {
  return Inherited::getTexCoordsIndex1(_linePntIndex[which]);
}

inline Vec2f LineIterator::getTexCoords1(Int32 which) const {
...
inline Int32 LineIterator::getTexCoordsIndex2(Int32 which) const {
  return Inherited::getTexCoordsIndex2(_linePntIndex[which]);
}

inline Vec2f LineIterator::getTexCoords2(Int32 which) const {
...
inline Int32 LineIterator::getTexCoordsIndex3(Int32 which) const {
  return Inherited::getTexCoordsIndex3(_linePntIndex[which]);
}

inline Vec2f LineIterator::getTexCoords3(Int32 which) const {
...
inline Int32 LineIterator::getTexCoordsIndex4(Int32 which) const {
  return Inherited::getTexCoordsIndex4(_linePntIndex[which]);
}

inline Vec2f LineIterator::getTexCoords4(Int32 which) const {
...
inline Int32 LineIterator::getTexCoordsIndex5(Int32 which) const {
  return Inherited::getTexCoordsIndex5(_linePntIndex[which]);
}

inline Vec2f LineIterator::getTexCoords5(Int32 which) const {
...
inline Int32 LineIterator::getTexCoordsIndex6(Int32 which) const {
  return Inherited::getTexCoordsIndex6(_linePntIndex[which]);
}

inline Vec2f LineIterator::getTexCoords6(Int32 which) const {
...
inline Int32 LineIterator::getTexCoordsIndex7(Int32 which) const {
  return Inherited::getTexCoordsIndex7(_linePntIndex[which]);
}

inline Vec2f LineIterator::getTexCoords7(Int32 which) const {
...
inline Int32 LineIterator::getIndexIndex(Int32 which) const {
