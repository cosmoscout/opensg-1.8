...
void DVRSimpleShader::dump(UInt32, const BitVector) const {
...
bool DVRSimpleShader::initialize(DVRVolume* volume, DrawActionBase* /*action*/) {
  ...
  static Int16 types[] = {Image::OSG_UINT8_IMAGEDATA, Image::OSG_UINT16_IMAGEDATA,
      Image::OSG_UINT32_IMAGEDATA, Image::OSG_FLOAT16_IMAGEDATA, Image::OSG_FLOAT32_IMAGEDATA, -1};

  UInt16 type = 0;
  while (types[type] != -1 && types[type] != img->getDataType())
    type++;
  ...
  static Int16 formats[] = {Image::OSG_L_PF, Image::OSG_LA_PF, Image::OSG_RGBA_DXT1,
      Image::OSG_RGBA_DXT3, Image::OSG_RGBA_DXT5, Image::OSG_RGBA_PF, Image::OSG_RGB_DXT1,
      Image::OSG_RGB_PF, -1};

  UInt16 format = 0;
  while (formats[format] != -1 && formats[format] != img->getPixelFormat())
    format++;
  ...
  static GLenum intfs[8][3] = {{GL_INTENSITY, GL_INTENSITY16, GL_INTENSITY16},
      {GL_LUMINANCE_ALPHA, GL_LUMINANCE16_ALPHA16, GL_LUMINANCE16_ALPHA16},
      {GL_RGBA, GL_RGBA, GL_RGBA}, {GL_RGBA, GL_RGBA, GL_RGBA}, {GL_RGBA, GL_RGBA, GL_RGBA},
      {GL_RGBA, GL_RGBA16, GL_RGBA16}, {GL_RGB, GL_RGB, GL_RGB}, {GL_RGB, GL_RGB16, GL_RGB16}};
...
void DVRSimpleShader::brickActivate(
