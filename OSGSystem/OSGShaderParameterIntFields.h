...
struct FieldDataTraits<ShaderParameterIntPtr>
  ...
  static const char* getSName(void) {
    return "SFShaderParameterIntPtr";
  }
  static const char* getMName(void) {
    return "MFShaderParameterIntPtr";
  }
};
...
#define OSGSHADERPARAMETERINTFIELDS_HEADER_CVSID                                                   \
  "@(#)$Id: OSGShaderParameterIntFields.h,v 1.5 2006/02/20 17:04:38 dirk Exp $"
