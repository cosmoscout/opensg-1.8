...
BlendChunk::BlendChunk(void)
  ...
  _extImaging           = Window::registerExtension("GL_ARB_imaging");
  _extBlendSubtract     = Window::registerExtension("GL_EXT_blend_subtract");
  _extBlendMinMax       = Window::registerExtension("GL_EXT_blend_minmax");
  _extBlendLogicOp      = Window::registerExtension("GL_EXT_blend_logic_op");
  _extBlendFuncSeparate = Window::registerExtension("GL_EXT_blend_func_separate");
  _funcBlendColor = Window::registerFunction(OSG_DLSYM_UNDERSCORE "glBlendColorEXT", _extBlend);
  _funcBlendEquation =
      Window::registerFunction(OSG_DLSYM_UNDERSCORE "glBlendEquation", _extImaging);
  _funcBlendEquationExt =
      Window::registerFunction(OSG_DLSYM_UNDERSCORE "glBlendEquationEXT", _extBlendLogicOp);
...
void BlendChunk::activate(DrawActionBase* action, UInt32) {
  ...
  if (src != GL_ONE || dest != GL_ZERO || (asrc != OSG_GL_UNUSED && asrc != GL_ONE) ||
    ...
    if (asrc != OSG_GL_UNUSED || adest != OSG_GL_UNUSED) {
      if (asrc == OSG_GL_UNUSED || adest == OSG_GL_UNUSED) {
        ...
        void(OSG_APIENTRY * blendfuncsep)(GLenum, GLenum, GLenum, GLenum) =
            (void(OSG_APIENTRY*)(GLenum, GLenum, GLenum, GLenum))action->getWindow()->getFunction(
    ...
    if ((src >= GL_CONSTANT_COLOR_EXT && src <= GL_ONE_MINUS_CONSTANT_ALPHA_EXT) ||
        (dest >= GL_CONSTANT_COLOR_EXT && dest <= GL_ONE_MINUS_CONSTANT_ALPHA_EXT) ||
        (asrc >= GL_CONSTANT_COLOR_EXT && asrc <= GL_ONE_MINUS_CONSTANT_ALPHA_EXT) ||
        (adest >= GL_CONSTANT_COLOR_EXT && adest <= GL_ONE_MINUS_CONSTANT_ALPHA_EXT)) {
      if (action->getWindow()->hasExtension(_extBlend)) {
        ...
        void(OSG_APIENTRY * blendcolor)(GLclampf red, GLclampf green, GLclampf blue,
            GLclampf alpha) = (void(OSG_APIENTRY*)(GLclampf red, GLclampf green, GLclampf blue,
            GLclampf alpha))action->getWindow()
                                  ->getFunction(_funcBlendColor);

        blendcolor(_sfColor.getValue().red(), _sfColor.getValue().green(),
            _sfColor.getValue().blue(), _sfColor.getValue().alpha());
      }
    }
  ...
  if (_sfEquation.getValue() != GL_NONE) {
    if (action->getWindow()->hasExtension(_extImaging)) {
      ...
      void(OSG_APIENTRY * blendeq)(GLenum mode) =
          (void(OSG_APIENTRY*)(GLenum mode))action->getWindow()->getFunction(_funcBlendEquation);
      ...
      void(OSG_APIENTRY * blendeq)(GLenum mode) =
          (void(OSG_APIENTRY*)(GLenum mode))action->getWindow()->getFunction(_funcBlendEquationExt);
...
void BlendChunk::changeFrom(DrawActionBase* action, StateChunk* old_chunk, UInt32) {
  ...
  if (src != GL_ONE || dest != GL_ZERO || (asrc != OSG_GL_UNUSED && asrc != GL_ONE) ||
    ...
    if (asrc != OSG_GL_UNUSED || adest != OSG_GL_UNUSED) {
      if (asrc == OSG_GL_UNUSED || adest == OSG_GL_UNUSED) {
        ...
        if (osrc != src || odest != dest || oasrc != asrc || oadest != adest) {
          // get "glBlendFuncSeparate" function pointer
          void(OSG_APIENTRY * blendfuncsep)(GLenum, GLenum, GLenum, GLenum) =
              (void(OSG_APIENTRY*)(GLenum, GLenum, GLenum, GLenum))action->getWindow()->getFunction(
                  _funcBlendFuncSeparateExt);
    ...
    if (osrc != GL_ONE || odest != GL_ZERO || (oasrc != OSG_GL_UNUSED && oasrc != GL_ONE) ||
...
bool BlendChunk::operator==(const StateChunk& other) const {
  ...
  if (getSrcFactor() != tother->getSrcFactor() || getDestFactor() != tother->getDestFactor() ||
      getEquation() != tother->getEquation() || getColor() != tother->getColor() ||
      getAlphaFunc() != tother->getAlphaFunc() || getAlphaValue() != tother->getAlphaValue())
    return false;
