...
class OSG_SYSTEMLIB_DLLMAPPING ActorBase {
 ...
 public:
  ...
  inline void setChildActive(UInt32 childIndex, bool active);

  inline PriorityType getChildPriority(UInt32 childIndex) const;
  inline void         setChildPriority(UInt32 childIndex, PriorityType prio);
  ...
  inline void setExtraChildActive(UInt32 childIndex, bool active);

  inline PriorityType getExtraChildPriority(UInt32 childIndex) const;
  inline void         setExtraChildPriority(UInt32 childIndex, PriorityType prio);
