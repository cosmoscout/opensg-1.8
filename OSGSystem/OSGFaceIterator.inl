...
inline Int32 FaceIterator::getIndex(void) const {
  return _faceIndex;
}
...
*/
inline UInt32 FaceIterator::getLength(void) const {
  return _facePntIndex[3] == -1 ? 3 : 4;
}

inline Int32 FaceIterator::getPositionIndex(Int32 which) const {
...
inline Pnt3f FaceIterator::getPosition(Int32 which) const {
...
inline Int32 FaceIterator::getNormalIndex(Int32 which) const {
  if (_facePntIndex[which] >= 0)
...
inline Vec3f FaceIterator::getNormal(Int32 which) const {
...
inline Int32 FaceIterator::getColorIndex(Int32 which) const {
  if (_facePntIndex[which] >= 0)
...
inline Color3f FaceIterator::getColor(Int32 which) const {
...
inline Int32 FaceIterator::getSecondaryColorIndex(Int32 which) const {
  if (_facePntIndex[which] >= 0)
...
inline Color3f FaceIterator::getSecondaryColor(Int32 which) const {
...
inline Int32 FaceIterator::getTexCoordsIndex(Int32 which) const {
  if (_facePntIndex[which] >= 0)
...
inline Vec2f FaceIterator::getTexCoords(Int32 which) const {
...
inline Int32 FaceIterator::getTexCoordsIndex1(Int32 which) const {
  if (_facePntIndex[which] >= 0)
...
inline Vec2f FaceIterator::getTexCoords1(Int32 which) const {
...
inline Int32 FaceIterator::getTexCoordsIndex2(Int32 which) const {
  if (_facePntIndex[which] >= 0)
...
inline Vec2f FaceIterator::getTexCoords2(Int32 which) const {
...
inline Int32 FaceIterator::getTexCoordsIndex3(Int32 which) const {
  if (_facePntIndex[which] >= 0)
...
inline Vec2f FaceIterator::getTexCoords3(Int32 which) const {
...
inline Int32 FaceIterator::getTexCoordsIndex4(Int32 which) const {
  if (_facePntIndex[which] >= 0)
...
inline Vec2f FaceIterator::getTexCoords4(Int32 which) const {
...
inline Int32 FaceIterator::getTexCoordsIndex5(Int32 which) const {
  if (_facePntIndex[which] >= 0)
...
inline Vec2f FaceIterator::getTexCoords5(Int32 which) const {
...
inline Int32 FaceIterator::getTexCoordsIndex6(Int32 which) const {
  if (_facePntIndex[which] >= 0)
...
inline Vec2f FaceIterator::getTexCoords6(Int32 which) const {
...
inline Int32 FaceIterator::getTexCoordsIndex7(Int32 which) const {
  if (_facePntIndex[which] >= 0)
...
inline Vec2f FaceIterator::getTexCoords7(Int32 which) const {
...
inline Int32 FaceIterator::getIndexIndex(Int32 which) const {
  if (_facePntIndex[which] >= 0)
