...
class FieldContainer {
 ...
 protected:
  ...
  virtual void executeSync(
      FieldContainer& other, const BitVector& whichField, const SyncInfo& iSinfo) = 0;

  OSG_SYSTEMLIB_DLLMAPPING
  void executeSyncImpl(FieldContainer* pOther, const BitVector& whichField, const SyncInfo& sInfo);

  OSG_SYSTEMLIB_DLLMAPPING
  virtual void execBeginEdit(
      const BitVector& whichField, UInt32 uiAspect, UInt32 uiContainerSize) = 0;
...
#define OSG_FC_FIRST_FIELD_IDM_DEF(OSG_CLASS, OSG_FIELDNAME)                                       \
  const OSG::UInt32    OSG_CLASS::OSG_FIELDNAME##Id   = Inherited::NextFieldId;                    \
  const OSG::BitVector OSG_CLASS::OSG_FIELDNAME##Mask = Inherited::NextFieldMask;
...
#define OSG_FC_FIRST_FIELD_IDM_INL_TMPL_DEF(OSG_CLASS, OSG_TMPL_PARAM, OSG_FIELDNAME)              \
  template <class OSG_TMPL_PARAM>                                                                  \
  OSG_FC_TMPL_VAR_INL const OSG::UInt32 OSG_CLASS<OSG_TMPL_PARAM>::OSG_FIELDNAME##Id =             \
      Inherited::NextFieldId;                                                                      \
  template <class OSG_TMPL_PARAM>                                                                  \
  OSG_FC_TMPL_VAR_INL const OSG::BitVector OSG_CLASS<OSG_TMPL_PARAM>::OSG_FIELDNAME##Mask =        \
...
#define OSG_FC_FIELD_IDM_DEF(OSG_CLASS, OSG_FIELDNAME, OSG_PREV_FIELDNAME)                         \
  const OSG::UInt32    OSG_CLASS::OSG_FIELDNAME##Id   = OSG_PREV_FIELDNAME##Id + 1;                \
  const OSG::BitVector OSG_CLASS::OSG_FIELDNAME##Mask = OSG_PREV_FIELDNAME##Mask << 1;
...
#define OSG_FC_FIELD_IDM_INL_TMPL_DEF(                                                             \
    OSG_CLASS, OSG_TMPL_PARAM, OSG_FIELDNAME, OSG_PREV_FIELDNAME)                                  \
  template <class OSG_TMPL_PARAM>                                                                  \
  OSG_FC_TMPL_VAR_INL const OSG::UInt32 OSG_CLASS<OSG_TMPL_PARAM>::OSG_FIELDNAME##Id =             \
...
#define OSG_FC_LAST_FIELD_IDM_DEF(OSG_CLASS, OSG_PREV_FIELDNAME)                                   \
  const OSG::UInt32    OSG_CLASS::NextFieldId   = OSG_PREV_FIELDNAME##Id + 1;                      \
  const OSG::BitVector OSG_CLASS::NextFieldMask = OSG_PREV_FIELDNAME##Mask << 1;
...
#define OSG_FC_LAST_FIELD_IDM_INL_TMPL_DEF(OSG_CLASS, OSG_TMPL_PARAM, OSG_PREV_FIELDNAME)          \
  template <class OSG_TMPL_PARAM>                                                                  \
  OSG_FC_TMPL_VAR_INL const OSG::UInt32 OSG_CLASS<OSG_TMPL_PARAM>::NextFieldId =                   \
      OSG_PREV_FIELDNAME##Id + 1;                                                                  \
  template <class OSG_TMPL_PARAM>                                                                  \
  OSG_FC_TMPL_VAR_INL const OSG::BitVector OSG_CLASS<OSG_TMPL_PARAM>::NextFieldMask =              \
      OSG_PREV_FIELDNAME##Mask << 1;
...
#define OSG_FC_FIRST_FIELD_IDM_INL_TMPL_DEF(OSG_CLASS, OSG_TMPL_PARAM, OSG_ELEMNAME)               \
  template <class OSG_TMPL_PARAM>                                                                  \
  OSG_FC_TMPL_VAR_INL const OSG::UInt32 OSG_CLASS<OSG_TMPL_PARAM>::OSG_ELEMNAME##Id;               \
  template <class OSG_TMPL_PARAM>                                                                  \
  OSG_FC_TMPL_VAR_INL const OSG::BitVector OSG_CLASS<OSG_TMPL_PARAM>::OSG_ELEMNAME##Mask;
...
#define OSG_FC_FIRST_FIELD_IDM_INL_TMPL_DEF(OSG_CLASS, OSG_TMPL_PARAM, OSG_ELEMNAME)               \
  template <class OSG_TMPL_PARAM>                                                                  \
  OSG_FC_TMPL_VAR_INL const OSG::BitVector OSG_CLASS<OSG_TMPL_PARAM>::OSG_ELEMNAME##Mask =         \
      (TypeTraits<BitVector>::One << OSG_CLASS<OSG_TMPL_PARAM>::OSG_ELEMNAME##Id);
...
#define OSG_FC_FIELD_IDM_INL_TMPL_DEF(OSG_CLASS, OSG_TMPL_PARAM, OSG_ELEMNAME, OSG_PREV_ELEMNAME)  \
  template <class OSG_TMPL_PARAM>                                                                  \
  OSG_FC_TMPL_VAR_INL const OSG::BitVector OSG_CLASS<OSG_TMPL_PARAM>::OSG_ELEMNAME##Mask =         \
      (TypeTraits<BitVector>::One << OSG_CLASS<OSG_TMPL_PARAM>::OSG_ELEMNAME##);
...
#define OSG_FC_GET_TYPE_INL_TMPL_DEF(OSG_TMPL_PARAM, OSG_CLASS)                                    \
  template <class OSG_TMPL_PARAM>                                                                  \
  inline OSG::FieldContainerType& OSG_CLASS<OSG_TMPL_PARAM>::getType(void) {                       \
    return _type;                                                                                  \
  }                                                                                                \
  template <class OSG_TMPL_PARAM>                                                                  \
  inline const OSG::FieldContainerType& OSG_CLASS<OSG_TMPL_PARAM>::getType(void) const {           \
    return _type;                                                                                  \
  }
...
#define OSG_FC_GET_STATIC_TYPE_INL_DEF(OSG_CLASS)                                                  \
  inline OSG::FieldContainerType& OSG_CLASS::getClassType(void) {                                  \
    return _type;                                                                                  \
  }

#define OSG_FC_GET_STATIC_TYPE_INL_TMPL_DEF(OSG_TMPL_PARAM, OSG_CLASS)                             \
  template <class OSG_TMPL_PARAM>                                                                  \
  inline OSG::FieldContainerType& OSG_CLASS<OSG_TMPL_PARAM>::getClassType(void) {                  \
    return _type;                                                                                  \
  }
...
#define OSG_FC_GET_STATIC_TYPE_ID_INL_DEF(OSG_CLASS)                                               \
  inline OSG::UInt32 OSG_CLASS::getClassTypeId(void) {                                             \
    return _type.getId();                                                                          \
  }
...
#define OSG_FC_CREATE_INL_DEF(OSG_CLASS, OSG_CLASS_PTR)                                            \
  inline OSG_CLASS_PTR OSG_CLASS::create(void) {                                                   \
    OSG_CLASS_PTR fc;                                                                              \
                                                                                                   \
    if (getClassType().getPrototype() != OSG::NullFC)                                              \
      fc = OSG_CLASS_PTR::dcast(getClassType().getPrototype()->shallowCopy());                     \
                                                                                                   \
    return fc;                                                                                     \
  }
...
#define OSG_FC_CREATE_INL_TMPL_DEF(OSG_TMPL_PARAM, OSG_CLASS, OSG_CLASS_PTR)                       \
  template <class OSG_TMPL_PARAM>                                                                  \
  inline typename OSG_CLASS<OSG_TMPL_PARAM>::OSG_CLASS_PTR OSG_CLASS<OSG_TMPL_PARAM>::create(      \
      void) {                                                                                      \
    OSG_CLASS_PTR fc;                                                                              \
                                                                                                   \
    if (getClassType().getPrototype() != OSG::NullFC)                                              \
...
#define OSG_FC_CREATE_EMPTY_INL_DEF(OSG_CLASS, OSG_CLASS_PTR)                                      \
  inline OSG_CLASS_PTR OSG_CLASS::createEmpty(void) {                                              \
...
#define OSG_FC_CREATE_EMPTY_INL_TMPL_DEF(OSG_TMPL_PARAM, OSG_CLASS, OSG_CLASS_PTR)                 \
  template <class OSG_TMPL_PARAM>                                                                  \
  inline typename OSG_CLASS<OSG_TMPL_PARAM>::OSG_CLASS_PTR OSG_CLASS<OSG_TMPL_PARAM>::createEmpty( \
      void) {                                                                                      \
    OSG_CLASS_PTR returnValue;                                                                     \
                                                                                                   \
...
#define OSG_FC_SHALLOWCOPY_INL_TMPL_DEF(OSG_TMPL_PARAM, OSG_CLASS, OSG_CLASS_PTR)                  \
  template <class OSG_TMPL_PARAM>                                                                  \
  inline OSG::FieldContainerPtr OSG_CLASS<OSG_TMPL_PARAM>::shallowCopy(void) const {               \
    OSG_CLASS_PTR returnValue;                                                                     \
                                                                                                   \
...
#define OSG_FC_CREATE_FUNCTIONS_INL_TMPL_DEF(OSG_TMPL_PARAM, OSG_CLASS, OSG_CLASS_PTR)             \
  OSG_FC_SHALLOWCOPY_INL_TMPL_DEF(OSG_TMPL_PARAM, OSG_CLASS, OSG_CLASS_PTR)                        \
  OSG_FC_CREATE_INL_TMPL_DEF(OSG_TMPL_PARAM, OSG_CLASS, OSG_CLASS_PTR)                             \
  OSG_FC_CREATE_EMPTY_INL_TMPL_DEF(OSG_TMPL_PARAM, OSG_CLASS, OSG_CLASS_PTR)
...
#define OSG_FC_GET_SIZE_INL_TMPL_DEF(OSG_TMPL_PARAM, OSG_CLASS)                                    \
  template <class OSG_TMPL_PARAM>                                                                  \
  inline OSG::UInt32 OSG_CLASS<OSG_TMPL_PARAM>::getContainerSize(void) const {                     \
    return sizeof(OSG_CLASS);                                                                      \
  }
