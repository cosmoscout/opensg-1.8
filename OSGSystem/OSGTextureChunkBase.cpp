...
/*! \var GLenum          TextureChunkBase::_sfExternalFormat
    The external texture format - overwrites               external format of image when set to a
   value not equal to               GL_NONE (which is the default).
*/
/*! \var bool            TextureChunkBase::_sfScale
    Specifies whether the image should be scaled to the next power of two,              thus filling
   the whole texture coordinate range, or if it should be put              in the lower left corner,
   leaving the rest of the texture undefined.              This is mainly used for rapidly changing
   non power of two textures, to              get around the scaling overhead.          If set to
   false, NPOTMatrixScale can be used to use the texture matrix to correct     the texture
   coordinates to show the used part of the texture.
*/
/*! \var UInt32          TextureChunkBase::_sfFrame
    Select the frame of the image to be used. See osg::Image about details              concerning
   multi-frame images.              \hint For fast update use GL_LINEAR or GL_NEAREST filters, as
   mipmap              creation is slow right now. \endhint
*/
...
/*! \var GLenum          TextureChunkBase::_sfShaderOperation
    Shader operation of this texture unit, default GL_NONE. If unit 0 uses              GL_NONE,
   shading is switched off.
*/
...
/*! \var UInt8           TextureChunkBase::_sfShaderCullModes
    The CULL_MODES_NV value, coded into a single byte. The first 4 bits of              the byte are
   used to indicate the wnated cull modes, a value of 0               signifies GL_LESS, a value of
   1 GL_GEQUAL. Bit 0 (mask 1) is used for the              S coordinate, bit 1 (mask 2) for T, bit
   2 (mask 4) for R and bit 4               (mask 8) for Q.
*/
...
/*! \var GLenum          TextureChunkBase::_sfTarget
    Texture target. Overwrite automatically determined texture target              based on the
   parameters of the assigned image if set to anything               else than GL_NONE. Used for
   nVidia's rectangle textures. Be careful              when using it!
*/
/*! \var Int32           TextureChunkBase::_sfDirtyLeft
    Left coordinate of the dirty rectangle to use for               imageContentChanged(). This
   doesn't make sense to be stored in files,               it does make sense on a cluster, though,
   that's why it's external.
*/
/*! \var Int32           TextureChunkBase::_sfDirtyMinX
    Minimum X coordinate of the dirty rectangle to use for               imageContentChanged(). This
   doesn't make sense to be stored in files,               it does make sense on a cluster, though,
   that's why it's external.
*/
/*! \var Int32           TextureChunkBase::_sfDirtyMaxX
    Maximum X coordinate of the dirty rectangle to use for               imageContentChanged(). This
   doesn't make sense to be stored in files,               it does make sense on a cluster, though,
   that's why it's external.
*/
/*! \var Int32           TextureChunkBase::_sfDirtyMinY
    Minimum Y coordinate of the dirty rectangle to use for               imageContentChanged(). This
   doesn't make sense to be stored in files,               it does make sense on a cluster, though,
   that's why it's external.
*/
/*! \var Int32           TextureChunkBase::_sfDirtyMaxY
    Maximum Y coordinate of the dirty rectangle to use for               imageContentChanged(). This
   doesn't make sense to be stored in files,               it does make sense on a cluster, though,
   that's why it's external.
*/
/*! \var Int32           TextureChunkBase::_sfDirtyMinZ
    Minimum Z coordinate of the dirty rectangle to use for               imageContentChanged(). This
   doesn't make sense to be stored in files,               it does make sense on a cluster, though,
   that's why it's external.
*/
/*! \var Int32           TextureChunkBase::_sfDirtyMaxZ
    Maximum Z coordinate of the dirty rectangle to use for               imageContentChanged(). This
   doesn't make sense to be stored in files,               it does make sense on a cluster, though,
   that's why it's external.
*/
...
/*! \var UInt32          TextureChunkBase::_sfNPOTMatrixScale
    Use the texture matrix to scale the texture coordinates for NPOT images. Only used if neither
   rectangular nor NPOT textures are supported. If set to false, the image is scaled to the next
   power of two before being used as a texture. For convenience xFlip/ yFlip can also be set. Note
   that this will interfere with other TextureTransform and TexGen chunks. Do not use it if you need
   to use those chunks!
*/
...
FieldDescription* TextureChunkBase::_desc[] = {
    ...
    new FieldDescription(SFGLenum::getClassType(), "internalFormat", InternalFormatFieldId,
        InternalFormatFieldMask, false, (FieldAccessMethod)&TextureChunkBase::getSFInternalFormat),
    new FieldDescription(SFGLenum::getClassType(), "externalFormat", ExternalFormatFieldId,
        ExternalFormatFieldMask, false, (FieldAccessMethod)&TextureChunkBase::getSFExternalFormat),
    ...
    new FieldDescription(SFGLenum::getClassType(), "minFilter", MinFilterFieldId,
        MinFilterFieldMask, false, (FieldAccessMethod)&TextureChunkBase::getSFMinFilter),
    new FieldDescription(SFGLenum::getClassType(), "magFilter", MagFilterFieldId,
        MagFilterFieldMask, false, (FieldAccessMethod)&TextureChunkBase::getSFMagFilter),
    new FieldDescription(SFGLenum::getClassType(), "wrapS", WrapSFieldId, WrapSFieldMask, false,
        (FieldAccessMethod)&TextureChunkBase::getSFWrapS),
    new FieldDescription(SFGLenum::getClassType(), "wrapT", WrapTFieldId, WrapTFieldMask, false,
        (FieldAccessMethod)&TextureChunkBase::getSFWrapT),
    new FieldDescription(SFGLenum::getClassType(), "wrapR", WrapRFieldId, WrapRFieldMask, false,
    ...
    new FieldDescription(SFGLenum::getClassType(), "envMode", EnvModeFieldId, EnvModeFieldMask,
        false, (FieldAccessMethod)&TextureChunkBase::getSFEnvMode),
    new FieldDescription(SFColor4f::getClassType(), "envColor", EnvColorFieldId, EnvColorFieldMask,
        false, (FieldAccessMethod)&TextureChunkBase::getSFEnvColor),
    new FieldDescription(SFGLenum::getClassType(), "envCombineRGB", EnvCombineRGBFieldId,
        EnvCombineRGBFieldMask, false, (FieldAccessMethod)&TextureChunkBase::getSFEnvCombineRGB),
    new FieldDescription(SFGLenum::getClassType(), "envCombineAlpha", EnvCombineAlphaFieldId,
        EnvCombineAlphaFieldMask, false,
        (FieldAccessMethod)&TextureChunkBase::getSFEnvCombineAlpha),
    new FieldDescription(SFReal32::getClassType(), "envScaleRGB", EnvScaleRGBFieldId,
        EnvScaleRGBFieldMask, false, (FieldAccessMethod)&TextureChunkBase::getSFEnvScaleRGB),
    new FieldDescription(SFReal32::getClassType(), "envScaleAlpha", EnvScaleAlphaFieldId,
        EnvScaleAlphaFieldMask, false, (FieldAccessMethod)&TextureChunkBase::getSFEnvScaleAlpha),
    new FieldDescription(SFGLenum::getClassType(), "envSource0RGB", EnvSource0RGBFieldId,
        EnvSource0RGBFieldMask, false, (FieldAccessMethod)&TextureChunkBase::getSFEnvSource0RGB),
    new FieldDescription(SFGLenum::getClassType(), "envSource1RGB", EnvSource1RGBFieldId,
        EnvSource1RGBFieldMask, false, (FieldAccessMethod)&TextureChunkBase::getSFEnvSource1RGB),
    new FieldDescription(SFGLenum::getClassType(), "envSource2RGB", EnvSource2RGBFieldId,
        EnvSource2RGBFieldMask, false, (FieldAccessMethod)&TextureChunkBase::getSFEnvSource2RGB),
    new FieldDescription(SFGLenum::getClassType(), "envSource0Alpha", EnvSource0AlphaFieldId,
        EnvSource0AlphaFieldMask, false,
        (FieldAccessMethod)&TextureChunkBase::getSFEnvSource0Alpha),
    new FieldDescription(SFGLenum::getClassType(), "envSource1Alpha", EnvSource1AlphaFieldId,
        EnvSource1AlphaFieldMask, false,
        (FieldAccessMethod)&TextureChunkBase::getSFEnvSource1Alpha),
    new FieldDescription(SFGLenum::getClassType(), "envSource2Alpha", EnvSource2AlphaFieldId,
        EnvSource2AlphaFieldMask, false,
        (FieldAccessMethod)&TextureChunkBase::getSFEnvSource2Alpha),
    new FieldDescription(SFGLenum::getClassType(), "envOperand0RGB", EnvOperand0RGBFieldId,
        EnvOperand0RGBFieldMask, false, (FieldAccessMethod)&TextureChunkBase::getSFEnvOperand0RGB),
    new FieldDescription(SFGLenum::getClassType(), "envOperand1RGB", EnvOperand1RGBFieldId,
        EnvOperand1RGBFieldMask, false, (FieldAccessMethod)&TextureChunkBase::getSFEnvOperand1RGB),
    new FieldDescription(SFGLenum::getClassType(), "envOperand2RGB", EnvOperand2RGBFieldId,
        EnvOperand2RGBFieldMask, false, (FieldAccessMethod)&TextureChunkBase::getSFEnvOperand2RGB),
    new FieldDescription(SFGLenum::getClassType(), "envOperand0Alpha", EnvOperand0AlphaFieldId,
        EnvOperand0AlphaFieldMask, false,
        (FieldAccessMethod)&TextureChunkBase::getSFEnvOperand0Alpha),
    new FieldDescription(SFGLenum::getClassType(), "envOperand1Alpha", EnvOperand1AlphaFieldId,
        EnvOperand1AlphaFieldMask, false,
        (FieldAccessMethod)&TextureChunkBase::getSFEnvOperand1Alpha),
    new FieldDescription(SFGLenum::getClassType(), "envOperand2Alpha", EnvOperand2AlphaFieldId,
        EnvOperand2AlphaFieldMask, false,
        (FieldAccessMethod)&TextureChunkBase::getSFEnvOperand2Alpha),
    new FieldDescription(SFGLenum::getClassType(), "GLId", GLIdFieldId, GLIdFieldMask, true,
        (FieldAccessMethod)&TextureChunkBase::getSFGLId),
    new FieldDescription(SFInt32::getClassType(), "IgnoreGLForAspect", IgnoreGLForAspectFieldId,
        IgnoreGLForAspectFieldMask, true,
        (FieldAccessMethod)&TextureChunkBase::getSFIgnoreGLForAspect),
    new FieldDescription(SFBool::getClassType(), "pointSprite", PointSpriteFieldId,
        PointSpriteFieldMask, false, (FieldAccessMethod)&TextureChunkBase::getSFPointSprite),
    new FieldDescription(SFReal32::getClassType(), "priority", PriorityFieldId, PriorityFieldMask,
        false, (FieldAccessMethod)&TextureChunkBase::getSFPriority),
    new FieldDescription(SFGLenum::getClassType(), "shaderOperation", ShaderOperationFieldId,
        ShaderOperationFieldMask, false,
        (FieldAccessMethod)&TextureChunkBase::getSFShaderOperation),
    new FieldDescription(SFGLenum::getClassType(), "shaderInput", ShaderInputFieldId,
        ShaderInputFieldMask, false, (FieldAccessMethod)&TextureChunkBase::getSFShaderInput),
    new FieldDescription(MFReal32::getClassType(), "shaderOffsetMatrix", ShaderOffsetMatrixFieldId,
        ShaderOffsetMatrixFieldMask, false,
        (FieldAccessMethod)&TextureChunkBase::getMFShaderOffsetMatrix),
    new FieldDescription(SFReal32::getClassType(), "shaderOffsetScale", ShaderOffsetScaleFieldId,
        ShaderOffsetScaleFieldMask, false,
        (FieldAccessMethod)&TextureChunkBase::getSFShaderOffsetScale),
    new FieldDescription(SFReal32::getClassType(), "shaderOffsetBias", ShaderOffsetBiasFieldId,
        ShaderOffsetBiasFieldMask, false,
        (FieldAccessMethod)&TextureChunkBase::getSFShaderOffsetBias),
    new FieldDescription(SFGLenum::getClassType(), "shaderRGBADotProduct",
        ShaderRGBADotProductFieldId, ShaderRGBADotProductFieldMask, false,
        (FieldAccessMethod)&TextureChunkBase::getSFShaderRGBADotProduct),
    new FieldDescription(SFUInt8::getClassType(), "shaderCullModes", ShaderCullModesFieldId,
        ShaderCullModesFieldMask, false,
        (FieldAccessMethod)&TextureChunkBase::getSFShaderCullModes),
    new FieldDescription(SFVec3f::getClassType(), "shaderConstEye", ShaderConstEyeFieldId,
        ShaderConstEyeFieldMask, false, (FieldAccessMethod)&TextureChunkBase::getSFShaderConstEye),
    new FieldDescription(SFReal32::getClassType(), "lodBias", LodBiasFieldId, LodBiasFieldMask,
        false, (FieldAccessMethod)&TextureChunkBase::getSFLodBias),
    new FieldDescription(SFGLenum::getClassType(), "target", TargetFieldId, TargetFieldMask, false,
        (FieldAccessMethod)&TextureChunkBase::getSFTarget),
    new FieldDescription(SFInt32::getClassType(), "dirtyLeft", DirtyLeftFieldId, DirtyLeftFieldMask,
        false, (FieldAccessMethod)&TextureChunkBase::getSFDirtyLeft),
    new FieldDescription(SFInt32::getClassType(), "dirtyMinX", DirtyMinXFieldId, DirtyMinXFieldMask,
        false, (FieldAccessMethod)&TextureChunkBase::getSFDirtyMinX),
    new FieldDescription(SFInt32::getClassType(), "dirtyMaxX", DirtyMaxXFieldId, DirtyMaxXFieldMask,
        false, (FieldAccessMethod)&TextureChunkBase::getSFDirtyMaxX),
    new FieldDescription(SFInt32::getClassType(), "dirtyMinY", DirtyMinYFieldId, DirtyMinYFieldMask,
        false, (FieldAccessMethod)&TextureChunkBase::getSFDirtyMinY),
    new FieldDescription(SFInt32::getClassType(), "dirtyMaxY", DirtyMaxYFieldId, DirtyMaxYFieldMask,
        false, (FieldAccessMethod)&TextureChunkBase::getSFDirtyMaxY),
    new FieldDescription(SFInt32::getClassType(), "dirtyMinZ", DirtyMinZFieldId, DirtyMinZFieldMask,
        false, (FieldAccessMethod)&TextureChunkBase::getSFDirtyMinZ),
    new FieldDescription(SFInt32::getClassType(), "dirtyMaxZ", DirtyMaxZFieldId, DirtyMaxZFieldMask,
        false, (FieldAccessMethod)&TextureChunkBase::getSFDirtyMaxZ),
    new FieldDescription(SFReal32::getClassType(), "anisotropy", AnisotropyFieldId,
        AnisotropyFieldMask, false, (FieldAccessMethod)&TextureChunkBase::getSFAnisotropy),
    new FieldDescription(SFColor4f::getClassType(), "borderColor", BorderColorFieldId,
        BorderColorFieldMask, false, (FieldAccessMethod)&TextureChunkBase::getSFBorderColor),
    new FieldDescription(SFUInt32::getClassType(), "borderWidth", BorderWidthFieldId,
        BorderWidthFieldMask, false, (FieldAccessMethod)&TextureChunkBase::getSFBorderWidth),
    new FieldDescription(SFUInt32::getClassType(), "NPOTMatrixScale", NPOTMatrixScaleFieldId,
        NPOTMatrixScaleFieldMask, false,
        (FieldAccessMethod)&TextureChunkBase::getSFNPOTMatrixScale)};

FieldContainerType TextureChunkBase::_type("TextureChunk", "StateChunk", NULL,
    (PrototypeCreateF)&TextureChunkBase::createEmpty, TextureChunk::initMethod, _desc,
    sizeof(_desc));
...
void TextureChunkBase::executeSync(FieldContainer& other, const BitVector& whichField) {
  this->executeSyncImpl((TextureChunkBase*)&other, whichField);
}
#else
void TextureChunkBase::executeSync(
    FieldContainer& other, const BitVector& whichField, const SyncInfo& sInfo) {
  this->executeSyncImpl((TextureChunkBase*)&other, whichField, sInfo);
}
void TextureChunkBase::execBeginEdit(
...
void TextureChunkBase::copyToBin(BinaryDataHandler& pMem, const BitVector& whichField) {
...
void TextureChunkBase::copyFromBin(BinaryDataHandler& pMem, const BitVector& whichField) {
...
#if !defined(OSG_FIXED_MFIELDSYNC)
void TextureChunkBase::executeSyncImpl(TextureChunkBase* pOther, const BitVector& whichField) {
...
#else
void TextureChunkBase::executeSyncImpl(
    TextureChunkBase* pOther, const BitVector& whichField, const SyncInfo& sInfo) {
...
void TextureChunkBase::execBeginEditImpl(
    const BitVector& whichField, UInt32 uiAspect, UInt32 uiContainerSize) {
