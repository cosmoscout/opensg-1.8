...
typedef void(OSG_APIENTRY* OSGGLSHADERSOURCEARBPROC)(
    GLuint shaderObj, GLsizei count, const char** strings, const GLint* length);
typedef void(OSG_APIENTRY* OSGGLCOMPILESHADERARBPROC)(GLuint shaderObj);
typedef void(OSG_APIENTRY* OSGGLGETOBJECTPARAMETERIVARBPROC)(
    GLuint obj, GLenum pname, GLint* params);
typedef void(OSG_APIENTRY* OSGGLGETINFOLOGARBPROC)(
...
typedef void(OSG_APIENTRY* OSGGLUNIFORMMATRIXFVARBPROC)(
    GLint location, GLsizei count, GLboolean transpose, GLfloat* value);

typedef void(OSG_APIENTRY* OSGGLGETUNIFORMFIARBPROC)(
    GLuint programObj, GLint location, GLint* value);
typedef void(OSG_APIENTRY* OSGGLGETUNIFORMFVARBPROC)(
    GLuint programObj, GLint location, GLfloat* value);
...
SHLChunk::SHLChunk(void)
  ...
  _funcCreateProgramObject =
      Window::registerFunction(OSG_DLSYM_UNDERSCORE "glCreateProgramObjectARB", _shl_extension);

  _funcProgramParameteri =
      Window::registerFunction(OSG_DLSYM_UNDERSCORE "glProgramParameteriEXT", _geometry_extension);

  _funcCreateShaderObject =
      Window::registerFunction(OSG_DLSYM_UNDERSCORE "glCreateShaderObjectARB", _shl_extension);
  _funcDeleteObject =
      Window::registerFunction(OSG_DLSYM_UNDERSCORE "glDeleteObjectARB", _shl_extension);

  _funcDetachObject =
      Window::registerFunction(OSG_DLSYM_UNDERSCORE "glDetachObjectARB", _shl_extension);

  _funcAttachObject =
      Window::registerFunction(OSG_DLSYM_UNDERSCORE "glAttachObjectARB", _shl_extension);

  _funcShaderSource =
      Window::registerFunction(OSG_DLSYM_UNDERSCORE "glShaderSourceARB", _shl_extension);

  _funcCompileShader =
      Window::registerFunction(OSG_DLSYM_UNDERSCORE "glCompileShaderARB", _shl_extension);

  _funcLinkProgram =
      Window::registerFunction(OSG_DLSYM_UNDERSCORE "glLinkProgramARB", _shl_extension);

  _funcGetInfoLog =
      Window::registerFunction(OSG_DLSYM_UNDERSCORE "glGetInfoLogARB", _shl_extension);

  _funcUseProgramObject =
      Window::registerFunction(OSG_DLSYM_UNDERSCORE "glUseProgramObjectARB", _shl_extension);

  _funcGetObjectParameteriv =
      Window::registerFunction(OSG_DLSYM_UNDERSCORE "glGetObjectParameterivARB", _shl_extension);

  _funcGetObjectParameterfv =
      Window::registerFunction(OSG_DLSYM_UNDERSCORE "glGetObjectParameterfvARB", _shl_extension);

  _funcGetUniformLocation =
      Window::registerFunction(OSG_DLSYM_UNDERSCORE "glGetUniformLocationARB", _shl_extension);

  _funcBindAttribLocation =
      Window::registerFunction(OSG_DLSYM_UNDERSCORE "glBindAttribLocationARB", _shl_extension);

  _funcGetAttribLocation =
      Window::registerFunction(OSG_DLSYM_UNDERSCORE "glGetAttribLocationARB", _shl_extension);

  _funcUniform1i = Window::registerFunction(OSG_DLSYM_UNDERSCORE "glUniform1iARB", _shl_extension);

  _funcUniform1iv =
      Window::registerFunction(OSG_DLSYM_UNDERSCORE "glUniform1ivARB", _shl_extension);

  _funcUniform2iv =
      Window::registerFunction(OSG_DLSYM_UNDERSCORE "glUniform2ivARB", _shl_extension);

  _funcUniform3iv =
      Window::registerFunction(OSG_DLSYM_UNDERSCORE "glUniform3ivARB", _shl_extension);

  _funcUniform4iv =
      Window::registerFunction(OSG_DLSYM_UNDERSCORE "glUniform4ivARB", _shl_extension);

  _funcUniform1f = Window::registerFunction(OSG_DLSYM_UNDERSCORE "glUniform1fARB", _shl_extension);

  _funcUniform1fv =
      Window::registerFunction(OSG_DLSYM_UNDERSCORE "glUniform1fvARB", _shl_extension);

  _funcUniform2fv =
      Window::registerFunction(OSG_DLSYM_UNDERSCORE "glUniform2fvARB", _shl_extension);

  _funcUniform3fv =
      Window::registerFunction(OSG_DLSYM_UNDERSCORE "glUniform3fvARB", _shl_extension);

  _funcUniform4fv =
      Window::registerFunction(OSG_DLSYM_UNDERSCORE "glUniform4fvARB", _shl_extension);

  _funcUniformMatrix4fv =
      Window::registerFunction(OSG_DLSYM_UNDERSCORE "glUniformMatrix4fvARB", _shl_extension);

  _funcGetUniformiv =
      Window::registerFunction(OSG_DLSYM_UNDERSCORE "glGetUniformivARB", _shl_extension);

  _funcGetUniformfv =
      Window::registerFunction(OSG_DLSYM_UNDERSCORE "glGetUniformfvARB", _shl_extension);
}
...
void SHLChunk::onCreate(const SHLChunk* source) {
  ...
  if (Thread::getAspect() != _sfIgnoreGLForAspect.getValue()) {
    ...
    setGLId(
        Window::registerGLObject(osgTypedMethodVoidFunctor2ObjCPtrPtr<SHLChunkPtr, Window, UInt32>(
                                     tmpPtr, &SHLChunk::handleGL),
            1));
...
void SHLChunk::changed(BitVector whichField, UInt32 origin) {
  if (Thread::getAspect() != _sfIgnoreGLForAspect.getValue()) {
    if (getGLId() == 0) {
      ...
      setGLId(Window::registerGLObject(
          osgTypedMethodVoidFunctor2ObjCPtrPtr<SHLChunkPtr, Window, UInt32>(
              tmpPtr, &SHLChunk::handleGL),
          1));
  ...
  if ((whichField & VertexProgramFieldMask) || (whichField & FragmentProgramFieldMask) ||
      (whichField & GeometryProgramFieldMask) || (whichField & CgFrontEndFieldMask)) {
    if (Thread::getAspect() != _sfIgnoreGLForAspect.getValue()) {
      Window::reinitializeGLObject(getGLId());
    }
  }

  if ((whichField & ParametersFieldMask) || (whichField & ProgramParameterNamesFieldMask) ||
...
void SHLChunk::dump(UInt32, const BitVector) const {
...
void SHLChunk::handleGL(Window* win, UInt32 idstatus) {
  ...
  if (mode == Window::destroy) {
    ...
    SWARNING << "SHLChunk(" << this << "::handleGL: Illegal mode: " << mode << " for id " << id
             << std::endl;
  }
}
...
void SHLChunk::updateProgram(Window* win) {
  ...
  OSGGLCREATEPROGRAMOBJECTARBPROC createProgramObject =
      (OSGGLCREATEPROGRAMOBJECTARBPROC)win->getFunction(_funcCreateProgramObject);
  ...
  OSGGLCREATESHADEROBJECTARBPROC createShaderObject =
      (OSGGLCREATESHADEROBJECTARBPROC)win->getFunction(_funcCreateShaderObject);

  // get "glShaderSourceARB" function pointer
  OSGGLSHADERSOURCEARBPROC shaderSource =
      (OSGGLSHADERSOURCEARBPROC)win->getFunction(_funcShaderSource);

  // get "glCompileShaderARB" function pointer
  OSGGLCOMPILESHADERARBPROC compileShader =
      (OSGGLCOMPILESHADERARBPROC)win->getFunction(_funcCompileShader);

  // get "glGetObjectParameterivARB" function pointer
  OSGGLGETOBJECTPARAMETERIVARBPROC getObjectParameteriv =
      (OSGGLGETOBJECTPARAMETERIVARBPROC)win->getFunction(_funcGetObjectParameteriv);

  // get "glGetInfoLogARB" function pointer
  OSGGLGETINFOLOGARBPROC getInfoLog = (OSGGLGETINFOLOGARBPROC)win->getFunction(_funcGetInfoLog);

  // get "glAttachObjectARB" function pointer
  OSGGLATTACHOBJECTARBPROC attachObject =
      (OSGGLATTACHOBJECTARBPROC)win->getFunction(_funcAttachObject);

  // get "glLinkProgramARB" function pointer
  OSGGLLINKPROGRAMARBPROC linkProgram = (OSGGLLINKPROGRAMARBPROC)win->getFunction(_funcLinkProgram);

  // get "glUseProgramObjectARB" function pointer
  OSGGLUSEPROGRAMOBJECTARBPROC useProgramObject =
      (OSGGLUSEPROGRAMOBJECTARBPROC)win->getFunction(_funcUseProgramObject);
...
void SHLChunk::updateParameterLocation(
    Window* win, GLuint program, const ShaderParameterPtr& parameter) {
  if (program == 0) {
  ...
  OSGGLGETUNIFORMLOCATIONARBPROC getUniformLocation =
      (OSGGLGETUNIFORMLOCATIONARBPROC)win->getFunction(_funcGetUniformLocation);
...
void SHLChunk::updateParameterLocations(Window* win, const MFShaderParameterPtr& parameters) {
  GLuint program = (GLuint)win->getGLObjectId(getGLId());
...
void SHLChunk::updateParameters(Window* win, const MFShaderParameterPtr& parameters,
    bool useProgram, bool force, bool keepProgramActive) {
  GLuint program = (GLuint)win->getGLObjectId(getGLId());
  ...
  for (UInt32 i = 0; i < parameters.size(); ++i) {
    ...
    if (parameter->getName().size() > 3 && parameter->getName()[0] == 'O' &&
        parameter->getName()[1] == 'S' && parameter->getName()[2] == 'G') {
      continue;
    }
    ...
    case ShaderParameter::SHPTypeBool: {
      ...
      OSGGLUNIFORM1IARBPROC uniform1i = (OSGGLUNIFORM1IARBPROC)win->getFunction(_funcUniform1i);
    ...
    case ShaderParameter::SHPTypeReal: {
      ...
      OSGGLUNIFORM1FARBPROC uniform1f = (OSGGLUNIFORM1FARBPROC)win->getFunction(_funcUniform1f);
    ...
    case ShaderParameter::SHPTypeVec2f: {
      ...
      OSGGLUNIFORMFVARBPROC uniform2fv = (OSGGLUNIFORMFVARBPROC)win->getFunction(_funcUniform2fv);
    ...
    case ShaderParameter::SHPTypeVec3f: {
      ...
      OSGGLUNIFORMFVARBPROC uniform3fv = (OSGGLUNIFORMFVARBPROC)win->getFunction(_funcUniform3fv);
    ...
    case ShaderParameter::SHPTypeVec4f: {
      ...
      OSGGLUNIFORMFVARBPROC uniform4fv = (OSGGLUNIFORMFVARBPROC)win->getFunction(_funcUniform4fv);
    ...
    case ShaderParameter::SHPTypeMatrix: {
      ...
      OSGGLUNIFORMMATRIXFVARBPROC uniformMatrix4fv =
          (OSGGLUNIFORMMATRIXFVARBPROC)win->getFunction(_funcUniformMatrix4fv);

      if (p->getLocation() == -1)
        updateParameterLocation(win, program, p);
      if (p->getLocation() != -1)
        uniformMatrix4fv(p->getLocation(), 1, GL_FALSE, p->getValue().getValues());
      else
        FWARNING(("Unknown parameter '%s'!\n", p->getName().c_str()));
    } break;
    // arrays
    case ShaderParameter::SHPTypeMInt: {
      ...
      OSGGLUNIFORMIVARBPROC uniform1iv = (OSGGLUNIFORMIVARBPROC)win->getFunction(_funcUniform1iv);
    ...
    case ShaderParameter::SHPTypeMReal: {
      ...
      OSGGLUNIFORMFVARBPROC uniform1fv = (OSGGLUNIFORMFVARBPROC)win->getFunction(_funcUniform1fv);
    ...
    case ShaderParameter::SHPTypeMMatrix: {
      ...
      if (p->getLocation() != -1 && !p->getValue().empty())
        uniformMatrix4fv(
            p->getLocation(), p->getValue().getSize(), GL_FALSE, p->getValue()[0].getValues());
      else
        FWARNING(("Unknown parameter '%s'!\n", p->getName().c_str()));
    } break;
    default:
...
void SHLChunk::checkOSGParameters(bool force) {
  ...
  if (!force && getParameters().getSize() == _oldParameterSize)
    return;
  ...
  for (UInt32 i = 0; i < parameters.size(); ++i) {
    ...
    if (parameter->getName().size() > 3 && parameter->getName()[0] == 'O' &&
      ...
      if (parameter->getName() == "OSGWorldMatrix") {
        ...
        _osgParametersCallbacks.push_back(std::make_pair(std::make_pair(oldfp, fp), parameter));
        ...
        userParameterCallbacksMap::iterator it = _userParameterCallbacks.find(parameter->getName());
...
void SHLChunk::addParameterCallback(const char* name, parametercbfp fp) {
  ...
  _userParameterCallbacks.insert(std::make_pair(name, std::make_pair(fp, nullfp)));
}
...
void SHLChunk::addParameterCallback(const char* name, osgparametercbfp fp) {
  ...
  setUniformParameter(name, 0);
  _userParameterCallbacks.insert(std::make_pair(name, std::make_pair(nullfp, fp)));
}
...
void SHLChunk::updateOSGParameters(DrawActionBase* action, GLuint program, bool update) {
  // get "glGetUniformLocationARB" function pointer
  OSGGLGETUNIFORMLOCATIONARBPROC getUniformLocation =
      (OSGGLGETUNIFORMLOCATIONARBPROC)action->getWindow()->getFunction(_funcGetUniformLocation);
  ...
  for (UInt32 i = 0; i < _osgParametersCallbacks.size(); ++i) {
    ...
    if (oldfp != NULL) {
      ...
      parameter->setFlags(update ? ShaderParameter::SHPFlagUpdate : ShaderParameter::SHPFlagNone);
      fp(parameter, action, program);
    }
  }
}

void SHLChunk::updateWorldMatrix(
    const ShaderParameterPtr& parameter, DrawActionBase* action, GLuint program) {
  ...
  // get "glUniformMatrix4fvARB" function pointer
  OSGGLUNIFORMMATRIXFVARBPROC uniformMatrix4fv =
      (OSGGLUNIFORMMATRIXFVARBPROC)action->getWindow()->getFunction(_funcUniformMatrix4fv);
...
void SHLChunk::updateInvWorldMatrix(
    const ShaderParameterPtr& parameter, DrawActionBase* action, GLuint program) {
  // this parameter needs to be updated for each object because it
  // is dependend from the object transformation!
  if (action->getCamera() == NULL || action->getViewport() == NULL) {
...
void SHLChunk::updateTransInvWorldMatrix(
    const ShaderParameterPtr& parameter, DrawActionBase* action, GLuint program) {
  // this parameter needs to be updated for each object because it
  // is dependend from the object transformation!
  if (action->getCamera() == NULL || action->getViewport() == NULL) {
...
void SHLChunk::updateCameraPosition(
  ...
  OSGGLUNIFORMFVARBPROC uniform3fv =
      (OSGGLUNIFORMFVARBPROC)action->getWindow()->getFunction(_funcUniform3fv);
  if (parameter->getLocation() == -1)
    updateParameterLocation(action->getWindow(), program, parameter);
  if (parameter->getLocation() != -1)
...
void SHLChunk::updateStereoLeftEye(
  ...
  OSGGLUNIFORM1IARBPROC uniform1i =
      (OSGGLUNIFORM1IARBPROC)action->getWindow()->getFunction(_funcUniform1i);
  if (parameter->getLocation() == -1)
    updateParameterLocation(action->getWindow(), program, parameter);
  if (parameter->getLocation() != -1)
...
void SHLChunk::activate(DrawActionBase* action, UInt32 /*idx*/) {
  ...
  // get "glUseProgramObjectARB" function pointer
  OSGGLUSEPROGRAMOBJECTARBPROC useProgramObject =
      (OSGGLUSEPROGRAMOBJECTARBPROC)action->getWindow()->getFunction(_funcUseProgramObject);
...
void SHLChunk::changeFrom(DrawActionBase* action, StateChunk* old_chunk, UInt32 /*idx*/) {
