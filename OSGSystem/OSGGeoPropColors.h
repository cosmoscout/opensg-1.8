...
OSG_FC_DLLEXPORT_DECL(GeoProperty, GeoColors3fPropertyDesc, OSG_SYSTEMLIB_DLLTMPLMAPPING)
#endif
...
#if !defined(OSG_COMPILEGEOPROPCOLORINST) && !defined(OSG_DO_DOC)
OSG_FC_DLLEXPORT_DECL(GeoProperty, GeoColors4fPropertyDesc, OSG_SYSTEMLIB_DLLTMPLMAPPING)
#endif
...
#if !defined(OSG_COMPILEGEOPROPCOLORINST) && !defined(OSG_DO_DOC)
OSG_FC_DLLEXPORT_DECL(GeoProperty, GeoColors3ubPropertyDesc, OSG_SYSTEMLIB_DLLTMPLMAPPING)
#endif
...
#if !defined(OSG_COMPILEGEOPROPCOLORINST) && !defined(OSG_DO_DOC)
OSG_FC_DLLEXPORT_DECL(GeoProperty, GeoColors4ubPropertyDesc, OSG_SYSTEMLIB_DLLTMPLMAPPING)
#endif
