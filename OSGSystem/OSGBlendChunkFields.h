...
template <>
struct FieldDataTraits<BlendChunkPtr> : public FieldTraitsRecurseMapper<BlendChunkPtr, true> {
  ...
  static const char* getSName(void) {
    return "SFBlendChunkPtr";
  }
  static const char* getMName(void) {
    return "MFBlendChunkPtr";
  }
};

#if !defined(OSG_DOC_DEV_TRAITS)
/*! \class  FieldTraitsRecurseMapper<BlendChunkPtr, true>
    \hideinhierarchy
 */
#endif
...
#define OSGBLENDCHUNKFIELDS_HEADER_CVSID                                                           \
