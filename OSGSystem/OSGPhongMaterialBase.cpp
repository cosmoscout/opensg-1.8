...
FieldDescription* PhongMaterialBase::_desc[] = {
    ...
    new FieldDescription(SFGLenum::getClassType(), "colorMaterial", ColorMaterialFieldId,
        ColorMaterialFieldMask, false, (FieldAccessMethod)&PhongMaterialBase::getSFColorMaterial)};

FieldContainerType PhongMaterialBase::_type("PhongMaterial", "ChunkMaterial", NULL,
    (PrototypeCreateF)&PhongMaterialBase::createEmpty, PhongMaterial::initMethod, _desc,
    sizeof(_desc));
...
void PhongMaterialBase::executeSync(FieldContainer& other, const BitVector& whichField) {
  this->executeSyncImpl((PhongMaterialBase*)&other, whichField);
}
#else
void PhongMaterialBase::executeSync(
    FieldContainer& other, const BitVector& whichField, const SyncInfo& sInfo) {
  this->executeSyncImpl((PhongMaterialBase*)&other, whichField, sInfo);
}
void PhongMaterialBase::execBeginEdit(
...
void PhongMaterialBase::copyToBin(BinaryDataHandler& pMem, const BitVector& whichField) {
...
void PhongMaterialBase::copyFromBin(BinaryDataHandler& pMem, const BitVector& whichField) {
...
#if !defined(OSG_FIXED_MFIELDSYNC)
void PhongMaterialBase::executeSyncImpl(PhongMaterialBase* pOther, const BitVector& whichField) {
...
#else
void PhongMaterialBase::executeSyncImpl(
    PhongMaterialBase* pOther, const BitVector& whichField, const SyncInfo& sInfo) {
...
void PhongMaterialBase::execBeginEditImpl(
    const BitVector& whichField, UInt32 uiAspect, UInt32 uiContainerSize) {
