...
FieldDescription* SimpleMaterialBase::_desc[] = {
    ...
    new FieldDescription(SFGLenum::getClassType(), "colorMaterial", ColorMaterialFieldId,
        ColorMaterialFieldMask, false, (FieldAccessMethod)&SimpleMaterialBase::getSFColorMaterial)};

FieldContainerType SimpleMaterialBase::_type("SimpleMaterial", "ChunkMaterial", NULL,
    (PrototypeCreateF)&SimpleMaterialBase::createEmpty, SimpleMaterial::initMethod, _desc,
    sizeof(_desc));
...
void SimpleMaterialBase::executeSync(FieldContainer& other, const BitVector& whichField) {
  this->executeSyncImpl((SimpleMaterialBase*)&other, whichField);
}
#else
void SimpleMaterialBase::executeSync(
    FieldContainer& other, const BitVector& whichField, const SyncInfo& sInfo) {
  this->executeSyncImpl((SimpleMaterialBase*)&other, whichField, sInfo);
}
void SimpleMaterialBase::execBeginEdit(
    const BitVector& whichField, UInt32 uiAspect, UInt32 uiContainerSize) {
  this->execBeginEditImpl(whichField, uiAspect, uiContainerSize);
}

void SimpleMaterialBase::onDestroyAspect(UInt32 uiId, UInt32 uiAspect) {
...
void SimpleMaterialBase::copyToBin(BinaryDataHandler& pMem, const BitVector& whichField) {
...
void SimpleMaterialBase::copyFromBin(BinaryDataHandler& pMem, const BitVector& whichField) {
...
#if !defined(OSG_FIXED_MFIELDSYNC)
void SimpleMaterialBase::executeSyncImpl(SimpleMaterialBase* pOther, const BitVector& whichField) {
...
#else
void SimpleMaterialBase::executeSyncImpl(
...
void SimpleMaterialBase::execBeginEditImpl(
    const BitVector& whichField, UInt32 uiAspect, UInt32 uiContainerSize) {
