...
typedef FCPtr<GroupPtr, MaterialGroup> MaterialGroupPtr;
...
template <>
struct FieldDataTraits<MaterialGroupPtr> : public FieldTraitsRecurseMapper<MaterialGroupPtr, true> {
  ...
  static const char* getSName(void) {
    return "SFMaterialGroupPtr";
  }
  static const char* getMName(void) {
    return "MFMaterialGroupPtr";
  }
};
...
#define OSGMATERIALGROUPFIELDS_HEADER_CVSID                                                        \
