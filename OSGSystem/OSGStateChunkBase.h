...
#else
  void executeSyncImpl(StateChunkBase* pOther, const BitVector& whichField, const SyncInfo& sInfo);
...
typedef osgIF<StateChunkBase::isNodeCore, CoredNodePtr<StateChunk>,
    FieldContainer::attempt_to_create_CoredNodePtr_on_non_NodeCore_FC>::_IRet StateChunkNodePtr;

typedef RefPtr<StateChunkPtr> StateChunkRefPtr;

OSG_END_NAMESPACE

#define OSGSTATECHUNKBASE_HEADER_CVSID                                                             \
