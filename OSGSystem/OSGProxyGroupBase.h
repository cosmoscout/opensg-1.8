...
#else
  void executeSyncImpl(ProxyGroupBase* pOther, const BitVector& whichField, const SyncInfo& sInfo);
...
typedef osgIF<ProxyGroupBase::isNodeCore, CoredNodePtr<ProxyGroup>,
    FieldContainer::attempt_to_create_CoredNodePtr_on_non_NodeCore_FC>::_IRet ProxyGroupNodePtr;

typedef RefPtr<ProxyGroupPtr> ProxyGroupRefPtr;

OSG_END_NAMESPACE

#define OSGPROXYGROUPBASE_HEADER_CVSID                                                             \
