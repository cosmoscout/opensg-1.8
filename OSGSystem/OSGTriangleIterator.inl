...
*/
inline Int32 TriangleIterator::getIndex(void) const {
  return _triIndex;
}

inline Int32 TriangleIterator::getPositionIndex(Int32 which) const {
  return Inherited::getPositionIndex(_triPntIndex[which]);
}

inline Pnt3f TriangleIterator::getPosition(Int32 which) const {
  Int32 ind = getPositionIndex(which);

  return getGeometry()->getPositions()->getValue(ind);
}

inline Int32 TriangleIterator::getNormalIndex(Int32 which) const {
  return Inherited::getNormalIndex(_triPntIndex[which]);
}

inline Vec3f TriangleIterator::getNormal(Int32 which) const {
...
inline Int32 TriangleIterator::getColorIndex(Int32 which) const {
  return Inherited::getColorIndex(_triPntIndex[which]);
}

inline Color3f TriangleIterator::getColor(Int32 which) const {
...
inline Int32 TriangleIterator::getSecondaryColorIndex(Int32 which) const {
  return Inherited::getSecondaryColorIndex(_triPntIndex[which]);
}

inline Color3f TriangleIterator::getSecondaryColor(Int32 which) const {
...
inline Int32 TriangleIterator::getTexCoordsIndex(Int32 which) const {
  return Inherited::getTexCoordsIndex(_triPntIndex[which]);
}

inline Vec2f TriangleIterator::getTexCoords(Int32 which) const {
...
inline Int32 TriangleIterator::getTexCoordsIndex1(Int32 which) const {
  return Inherited::getTexCoordsIndex1(_triPntIndex[which]);
}

inline Vec2f TriangleIterator::getTexCoords1(Int32 which) const {
...
inline Int32 TriangleIterator::getTexCoordsIndex2(Int32 which) const {
  return Inherited::getTexCoordsIndex2(_triPntIndex[which]);
}

inline Vec2f TriangleIterator::getTexCoords2(Int32 which) const {
...
inline Int32 TriangleIterator::getTexCoordsIndex3(Int32 which) const {
  return Inherited::getTexCoordsIndex3(_triPntIndex[which]);
}

inline Vec2f TriangleIterator::getTexCoords3(Int32 which) const {
...
inline Int32 TriangleIterator::getTexCoordsIndex4(Int32 which) const {
  return Inherited::getTexCoordsIndex4(_triPntIndex[which]);
}

inline Vec2f TriangleIterator::getTexCoords4(Int32 which) const {
...
inline Int32 TriangleIterator::getTexCoordsIndex5(Int32 which) const {
  return Inherited::getTexCoordsIndex5(_triPntIndex[which]);
}

inline Vec2f TriangleIterator::getTexCoords5(Int32 which) const {
...
inline Int32 TriangleIterator::getTexCoordsIndex6(Int32 which) const {
  return Inherited::getTexCoordsIndex6(_triPntIndex[which]);
}

inline Vec2f TriangleIterator::getTexCoords6(Int32 which) const {
...
inline Int32 TriangleIterator::getTexCoordsIndex7(Int32 which) const {
  return Inherited::getTexCoordsIndex7(_triPntIndex[which]);
}

inline Vec2f TriangleIterator::getTexCoords7(Int32 which) const {
...
inline Int32 TriangleIterator::getIndexIndex(Int32 which) const {
