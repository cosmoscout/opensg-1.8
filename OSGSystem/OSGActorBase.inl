...
inline ActorBase::ActorBaseState::ActorBaseState(void) {
}

/*! Copy constructor.
 */

inline ActorBase::ActorBaseState::ActorBaseState(const ActorBaseState& source) {
}
...
inline bool ActorBase::getEnterNodeFlag(void) const {
...
inline bool ActorBase::getLeaveNodeFlag(void) const {
...
inline void ActorBase::setEnterNodeFlag(bool enter) {
...
inline void ActorBase::setLeaveNodeFlag(bool leave) {
...
inline const NewActionBase* ActorBase::getAction(void) const {
  return _pAction;
}

inline NewActionBase* ActorBase::getAction(void) {
  return _pAction;
}

inline UInt32 ActorBase::getActorId(void) const {
  return _actorId;
}
...
inline bool ActorBase::getChildrenListEnabled(void) const {
...
inline void ActorBase::setChildrenListEnabled(bool enabled) {
...
inline NodePtr ActorBase::getNode(void) const {
...
inline UInt32 ActorBase::getNumChildren(void) const {
...
inline NodePtr ActorBase::getChild(UInt32 childIndex) const {
...
inline bool ActorBase::getChildActive(UInt32 childIndex) const {
...
inline void ActorBase::setChildActive(UInt32 childIndex, bool active) {
...
inline ActorBase::PriorityType ActorBase::getChildPriority(UInt32 childIndex) const {
...
inline void ActorBase::setChildPriority(UInt32 childIndex, PriorityType prio) {
...
inline UInt32 ActorBase::getNumExtraChildren(void) const {
...
inline NodePtr ActorBase::getExtraChild(UInt32 childIndex) const {
...
inline bool ActorBase::getExtraChildActive(UInt32 childIndex) const {
...
inline void ActorBase::setExtraChildActive(UInt32 childIndex, bool active) {
...
inline ActorBase::PriorityType ActorBase::getExtraChildPriority(UInt32 childIndex) const {
...
inline void ActorBase::setExtraChildPriority(UInt32 childIndex, PriorityType prio) {
...
inline UInt32 ActorBase::getNumPasses(void) const {
...
inline void ActorBase::beginEditState(void) {
...
inline void ActorBase::endEditState(void) {
...
inline const ActorBase::ActorBaseState* ActorBase::getState(void) const {
  return _pState;
}
...
inline ActorBase::ActorBaseState* ActorBase::getState(void) {
  return _pState;
}
...
inline void ActorBase::setState(ActorBaseState* pState) {
  _pState = pState;
}
...
inline const ActorBase::StateSlotMap& ActorBase::getSlotMap(void) const {
...
inline ActorBase::StateSlotMap& ActorBase::getSlotMap(void) {
  return _stateSlotMap;
}
...
#define OSGACTORBASE_INLINE_CVSID                                                                  \
  "@(#)$Id: OSGActorBase.inl,v 1.6 2004/09/17 14:09:42 neumannc Exp $"
