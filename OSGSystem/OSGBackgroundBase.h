...
#else
  void executeSyncImpl(BackgroundBase* pOther, const BitVector& whichField, const SyncInfo& sInfo);
...
typedef osgIF<BackgroundBase::isNodeCore, CoredNodePtr<Background>,
    FieldContainer::attempt_to_create_CoredNodePtr_on_non_NodeCore_FC>::_IRet BackgroundNodePtr;

typedef RefPtr<BackgroundPtr> BackgroundRefPtr;

OSG_END_NAMESPACE

#define OSGBACKGROUNDBASE_HEADER_CVSID                                                             \
