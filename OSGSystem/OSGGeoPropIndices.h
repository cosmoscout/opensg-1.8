...
struct GeoIndicesUI32PropertyDesc : public GeoIndicesPropertyDesc {
  ...
  static const Char8* getTypeName(void) {
    return "GeoIndicesUI32";
  }
  static const Char8* getClassName(void) {
    return "GeoIndicesUI32Property";
  }
...
OSG_FC_DLLEXPORT_DECL(GeoProperty, GeoIndicesUI32PropertyDesc, OSG_SYSTEMLIB_DLLTMPLMAPPING)
#endif
...
struct GeoIndicesUI16PropertyDesc : public GeoIndicesPropertyDesc {
  ...
  static const Char8* getTypeName(void) {
    return "GeoIndicesUI16";
  }
  static const Char8* getClassName(void) {
    return "GeoIndicesUI16Property";
  }
  static const Char8* getFieldName(void) {
    return "indices";
  }
...
#if !defined(OSG_COMPILEGEOPROPINDEXINST) && !defined(OSG_DO_DOC)
OSG_FC_DLLEXPORT_DECL(GeoProperty, GeoIndicesUI16PropertyDesc, OSG_SYSTEMLIB_DLLTMPLMAPPING)
#endif
