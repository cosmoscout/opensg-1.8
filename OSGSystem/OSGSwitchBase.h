...
class OSG_SYSTEMLIB_DLLMAPPING SwitchBase : public Group {
 ...
 public:
  ...
  enum { ChoiceFieldId = Inherited::NextFieldId, NextFieldId = ChoiceFieldId + 1 };
...
#else
  void executeSyncImpl(SwitchBase* pOther, const BitVector& whichField, const SyncInfo& sInfo);
...
typedef osgIF<SwitchBase::isNodeCore, CoredNodePtr<Switch>,
    FieldContainer::attempt_to_create_CoredNodePtr_on_non_NodeCore_FC>::_IRet SwitchNodePtr;

typedef RefPtr<SwitchPtr> SwitchRefPtr;

OSG_END_NAMESPACE

#define OSGSWITCHBASE_HEADER_CVSID                                                                 \
