...
#if !defined(OSG_DOC_DEV_TRAITS)
/*! \class  FieldTraitsRecurseMapper<PolygonForegroundPtr, true>
    \hideinhierarchy
 */
#endif
...
typedef SField<PolygonForegroundPtr> SFPolygonForegroundPtr;
#endif

#ifndef OSG_COMPILEPOLYGONFOREGROUNDINST
OSG_DLLEXPORT_DECL1(SField, PolygonForegroundPtr, OSG_SYSTEMLIB_DLLTMPLMAPPING)
#endif

#if !defined(OSG_DO_DOC) || defined(OSG_DOC_FIELD_TYPEDEFS)
/*! \ingroup GrpSystemFieldMulti */

typedef MField<PolygonForegroundPtr> MFPolygonForegroundPtr;
#endif

#ifndef OSG_COMPILEPOLYGONFOREGROUNDINST
OSG_DLLEXPORT_DECL1(MField, PolygonForegroundPtr, OSG_SYSTEMLIB_DLLTMPLMAPPING)
#endif
