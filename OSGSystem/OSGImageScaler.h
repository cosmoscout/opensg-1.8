...
class OSG_SYSTEMLIB_DLLMAPPING ImageScaler {
 public:
  static bool scale(ImagePtr& srcImg, ImagePtr& dstImg, OSG::Int32 width, OSG::Int32 height,
      OSG::Int32 depth, const ImageGenericFilter& filter);
 ...
 private:
  ...
  static void calcContributions(UInt32 axis, Int32 uResSize, Int32 uSrcSize,
