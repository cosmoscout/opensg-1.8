...
class OSG_SYSTEMLIB_DLLMAPPING ShaderParameterMatrixBase : public ShaderParameter {
 ...
 protected:
  ...
  void executeSyncImpl(ShaderParameterMatrixBase* pOther, const BitVector& whichField);
...
typedef osgIF<ShaderParameterMatrixBase::isNodeCore, CoredNodePtr<ShaderParameterMatrix>,
...
#define OSGSHADERPARAMETERMATRIXBASE_HEADER_CVSID                                                  \
  "@(#)$Id: OSGShaderParameterMatrixBase.h,v 1.6 2006/02/20 17:04:38 dirk Exp $"
