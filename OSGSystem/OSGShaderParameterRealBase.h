...
class OSG_SYSTEMLIB_DLLMAPPING ShaderParameterRealBase : public ShaderParameter {
 ...
 protected:
  ...
  void executeSyncImpl(ShaderParameterRealBase* pOther, const BitVector& whichField);
...
typedef osgIF<ShaderParameterRealBase::isNodeCore, CoredNodePtr<ShaderParameterReal>,
...
#define OSGSHADERPARAMETERREALBASE_HEADER_CVSID                                                    \
  "@(#)$Id: OSGShaderParameterRealBase.h,v 1.6 2006/02/20 17:04:38 dirk Exp $"
