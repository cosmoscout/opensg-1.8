 ...
 */
class OSG_SYSTEMLIB_DLLMAPPING TextMacBackend : public TextBackend {
  /*==========================  PUBLIC  =================================*/
 public:
...
#define OSGTEXTMACBACKEND_HEADER_CVSID                                                             \
  "@(#)$Id: OSGTextMacBackend.h,v 1.1 2005/03/03 13:43:07 a-m-z Exp $"
