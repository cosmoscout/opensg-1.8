...
class OSG_SYSTEMLIB_DLLMAPPING PointLightBase : public Light {
 private:
  typedef Light Inherited;

  /*==========================  PUBLIC  =================================*/
 public:
  typedef PointLightPtr Ptr;
...
#else
  void executeSyncImpl(PointLightBase* pOther, const BitVector& whichField, const SyncInfo& sInfo);
...
typedef osgIF<PointLightBase::isNodeCore, CoredNodePtr<PointLight>,
    FieldContainer::attempt_to_create_CoredNodePtr_on_non_NodeCore_FC>::_IRet PointLightNodePtr;

typedef RefPtr<PointLightPtr> PointLightRefPtr;

OSG_END_NAMESPACE

#define OSGPOINTLIGHTBASE_HEADER_CVSID                                                             \
