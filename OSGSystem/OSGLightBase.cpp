...
const OSG::BitVector LightBase::OnFieldMask = (TypeTraits<BitVector>::One << LightBase::OnFieldId);
...
/*! \var UInt32          LightBase::_sfShadowMode
    possible values are CAST_SHADOW_AUTO, CAST_SHADOW_ON, CAST_SHADOW_OFF in auto mode the light
   source casts shadows if the light is on and the shadow intensity is greater than zero.
*/
...
FieldDescription* LightBase::_desc[] = {
    ...
    new FieldDescription(SFReal32::getClassType(), "linearAttenuation", LinearAttenuationFieldId,
        LinearAttenuationFieldMask, false, (FieldAccessMethod)&LightBase::getSFLinearAttenuation),
    ...
    new FieldDescription(SFReal32::getClassType(), "shadowIntensity", ShadowIntensityFieldId,
        ShadowIntensityFieldMask, false, (FieldAccessMethod)&LightBase::getSFShadowIntensity),
    new FieldDescription(SFUInt32::getClassType(), "shadowMode", ShadowModeFieldId,
        ShadowModeFieldMask, false, (FieldAccessMethod)&LightBase::getSFShadowMode)};

FieldContainerType LightBase::_type(
    "Light", "Group", NULL, NULL, Light::initMethod, _desc, sizeof(_desc));
...
void LightBase::executeSync(FieldContainer& other, const BitVector& whichField) {
  this->executeSyncImpl((LightBase*)&other, whichField);
}
#else
void LightBase::executeSync(
    FieldContainer& other, const BitVector& whichField, const SyncInfo& sInfo) {
  this->executeSyncImpl((LightBase*)&other, whichField, sInfo);
}
void LightBase::execBeginEdit(
...
void LightBase::copyToBin(BinaryDataHandler& pMem, const BitVector& whichField) {
...
void LightBase::copyFromBin(BinaryDataHandler& pMem, const BitVector& whichField) {
...
#if !defined(OSG_FIXED_MFIELDSYNC)
void LightBase::executeSyncImpl(LightBase* pOther, const BitVector& whichField) {
...
#else
void LightBase::executeSyncImpl(
    LightBase* pOther, const BitVector& whichField, const SyncInfo& sInfo) {
...
void LightBase::execBeginEditImpl(
    const BitVector& whichField, UInt32 uiAspect, UInt32 uiContainerSize) {
