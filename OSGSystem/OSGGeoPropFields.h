...
template <>
struct FieldDataTraits<GeoPositionsPtr> : public FieldTraitsRecurseMapper<GeoPositionsPtr, true> {
  /*---------------------------------------------------------------------*/
  /*! \name                    Struct Specific                           */
  /*! \{                                                                 */
  ...
  static Char8* getSName(void) {
    return "SFGeoPositionsPtr";
  }
  static Char8* getMName(void) {
    return "MFGeoPositionsPtr";
  }
...
template <>
struct FieldDataTraits<GeoNormalsPtr> : public FieldTraitsRecurseMapper<GeoNormalsPtr, true> {
  /*---------------------------------------------------------------------*/
  /*! \name                    Struct Specific                           */
  /*! \{                                                                 */
  ...
  static Char8* getSName(void) {
    return "SFGeoNormalsPtr";
  }
  static Char8* getMName(void) {
    return "MFGeoNormalsPtr";
  }
...
template <>
struct FieldDataTraits<GeoColorsPtr> : public FieldTraitsRecurseMapper<GeoColorsPtr, true> {
  /*---------------------------------------------------------------------*/
  /*! \name                    Struct Specific                           */
  /*! \{                                                                 */
  ...
  static Char8* getSName(void) {
    return "SFGeoColorsPtr";
  }
  static Char8* getMName(void) {
    return "MFGeoColorsPtr";
  }
...
template <>
struct FieldDataTraits<GeoTexCoordsPtr> : public FieldTraitsRecurseMapper<GeoTexCoordsPtr, true> {
  /*---------------------------------------------------------------------*/
  /*! \name                    Struct Specific                           */
  /*! \{                                                                 */
  ...
  static Char8* getSName(void) {
    return "SFGeoTexCoordsPtr";
  }
  static Char8* getMName(void) {
    return "MFGeoTexCoordsPtr";
  }
...
template <>
struct FieldDataTraits<GeoIndicesPtr> : public FieldTraitsRecurseMapper<GeoIndicesPtr, true> {
  /*---------------------------------------------------------------------*/
  /*! \name                    Struct Specific                           */
  /*! \{                                                                 */
  ...
  static Char8* getSName(void) {
    return "SFGeoIndicesPtr";
  }
  static Char8* getMName(void) {
    return "MFGeoIndicesPtr";
  }
...
template <>
struct FieldDataTraits<GeoPTypesPtr> : public FieldTraitsRecurseMapper<GeoPTypesPtr, true> {
  /*---------------------------------------------------------------------*/
  /*! \name                    Struct Specific                           */
  /*! \{                                                                 */
  ...
  static Char8* getSName(void) {
    return "SFGeoPTypesPtr";
  }
  static Char8* getMName(void) {
    return "MFGeoPTypesPtr";
  }
...
template <>
struct FieldDataTraits<GeoPLengthsPtr> : public FieldTraitsRecurseMapper<GeoPLengthsPtr, true> {
  /*---------------------------------------------------------------------*/
  /*! \name                    Struct Specific                           */
  /*! \{                                                                 */
  ...
  static char* getSName(void) {
    return "SFGeoPLengthsPtr";
  }
  static char* getMName(void) {
    return "MFGeoPLengthsPtr";
  }
