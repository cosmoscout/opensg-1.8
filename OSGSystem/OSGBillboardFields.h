...
template <>
struct FieldDataTraits<BillboardPtr> : public FieldTraitsRecurseMapper<BillboardPtr, true> {
  ...
  static const char* getSName(void) {
    return "SFBillboardPtr";
  }
  static const char* getMName(void) {
    return "MFBillboardPtr";
  }
};
...
#define OSGBILLBOARDFIELDS_HEADER_CVSID                                                            \
