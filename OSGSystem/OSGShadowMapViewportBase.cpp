...
FieldDescription* ShadowMapViewportBase::_desc[] = {
    new FieldDescription(SFReal32::getClassType(), "offBias", OffBiasFieldId, OffBiasFieldMask,
        false, (FieldAccessMethod)&ShadowMapViewportBase::getSFOffBias),
    new FieldDescription(SFReal32::getClassType(), "offFactor", OffFactorFieldId,
        OffFactorFieldMask, false, (FieldAccessMethod)&ShadowMapViewportBase::getSFOffFactor),
    new FieldDescription(SFNodePtr::getClassType(), "sceneRoot", SceneRootFieldId,
        SceneRootFieldMask, false, (FieldAccessMethod)&ShadowMapViewportBase::getSFSceneRoot),
    new FieldDescription(SFColor4f::getClassType(), "shadowColor", ShadowColorFieldId,
        ShadowColorFieldMask, false, (FieldAccessMethod)&ShadowMapViewportBase::getSFShadowColor),
    new FieldDescription(SFUInt32::getClassType(), "mapSize", MapSizeFieldId, MapSizeFieldMask,
        false, (FieldAccessMethod)&ShadowMapViewportBase::getSFMapSize),
    new FieldDescription(MFNodePtr::getClassType(), "lightNodes", LightNodesFieldId,
        LightNodesFieldMask, false, (FieldAccessMethod)&ShadowMapViewportBase::getMFLightNodes),
    new FieldDescription(MFNodePtr::getClassType(), "excludeNodes", ExcludeNodesFieldId,
        ExcludeNodesFieldMask, false, (FieldAccessMethod)&ShadowMapViewportBase::getMFExcludeNodes),
    new FieldDescription(SFBool::getClassType(), "shadowOn", ShadowOnFieldId, ShadowOnFieldMask,
        false, (FieldAccessMethod)&ShadowMapViewportBase::getSFShadowOn),
    new FieldDescription(SFBool::getClassType(), "mapAutoUpdate", MapAutoUpdateFieldId,
        MapAutoUpdateFieldMask, false,
        (FieldAccessMethod)&ShadowMapViewportBase::getSFMapAutoUpdate),
    new FieldDescription(SFUInt32::getClassType(), "shadowMapTextureIndex",
        ShadowMapTextureIndexFieldId, ShadowMapTextureIndexFieldMask, false,
        (FieldAccessMethod)&ShadowMapViewportBase::getSFShadowMapTextureIndex)};

FieldContainerType ShadowMapViewportBase::_type("ShadowMapViewport", "StereoBufferViewport", NULL,
    (PrototypeCreateF)&ShadowMapViewportBase::createEmpty, ShadowMapViewport::initMethod, _desc,
    sizeof(_desc));
...
void ShadowMapViewportBase::executeSync(FieldContainer& other, const BitVector& whichField) {
  this->executeSyncImpl((ShadowMapViewportBase*)&other, whichField);
}
#else
void ShadowMapViewportBase::executeSync(
    FieldContainer& other, const BitVector& whichField, const SyncInfo& sInfo) {
  this->executeSyncImpl((ShadowMapViewportBase*)&other, whichField, sInfo);
}
void ShadowMapViewportBase::execBeginEdit(
...
void ShadowMapViewportBase::copyToBin(BinaryDataHandler& pMem, const BitVector& whichField) {
...
void ShadowMapViewportBase::copyFromBin(BinaryDataHandler& pMem, const BitVector& whichField) {
...
#if !defined(OSG_FIXED_MFIELDSYNC)
void ShadowMapViewportBase::executeSyncImpl(
    ShadowMapViewportBase* pOther, const BitVector& whichField) {
...
void ShadowMapViewportBase::execBeginEditImpl(
    const BitVector& whichField, UInt32 uiAspect, UInt32 uiContainerSize) {
...
DataType FieldDataTraits<ShadowMapViewportPtr>::_type(
    "ShadowMapViewportPtr", "StereoBufferViewportPtr");
#endif
