...
#ifndef WIN32
OSG_ABSTR_FIELD_CONTAINER_INL_TMPL_DEF(AbstractGeoProperty, GeoPropertyDesc, PtrType)
#else
OSG_ABSTR_GEO_PROP_INL_TMPL_DEF(AbstractGeoProperty, GeoPropertyDesc, PtrType)
#endif

template <class GeoPropertyDesc>
inline AbstractGeoProperty<GeoPropertyDesc>::AbstractGeoProperty(void)
    : LocalInherited()
...
template <class GeoPropertyDesc>
inline AbstractGeoProperty<GeoPropertyDesc>::AbstractGeoProperty(const AbstractGeoProperty& source)
    :
...
template <class GeoPropertyDesc>
inline void AbstractGeoProperty<GeoPropertyDesc>::dump(
    UInt32 uiIndent, const BitVector bvFlags) const {
...
#ifndef WIN32
OSG_FIELD_CONTAINER_INL_TMPL_DEF(GeoProperty, GeoPropertyDesc, PtrType)
#else
OSG_GEO_PROP_INL_TMPL_DEF(GeoProperty, GeoPropertyDesc, PtrType)
#endif

#ifdef OSG_MICROSOFT_COMPILER_HACKS
template <class GeoPropertyDesc>
inline FieldAccessMethod GeoProperty<GeoPropertyDesc>::getFPtrAccessMethod(void) {
...
template <class GeoPropertyDesc>
inline GeoProperty<GeoPropertyDesc>::GeoProperty(const GeoProperty& source)
    :
...
template <class GeoPropertyDesc>
inline void GeoProperty<GeoPropertyDesc>::executeSync(
    FieldContainer& other, const BitVector& whichField) {
  this->executeSyncImpl((GeoProperty*)&other, whichField);
}

template <class GeoPropertyDesc>
inline void GeoProperty<GeoPropertyDesc>::executeSyncImpl(
    GeoProperty* pOther, const BitVector& whichField) {
...
template <class GeoPropertyDesc>
inline void GeoProperty<GeoPropertyDesc>::executeSyncImpl(
    GeoProperty* pOther, const BitVector& whichField, const SyncInfo& sInfo) {
...
template <class GeoPropertyDesc>
inline void GeoProperty<GeoPropertyDesc>::execBeginEditImpl(
...
template <class GeoPropertyDesc>
inline void GeoProperty<GeoPropertyDesc>::execBeginEdit(
    const BitVector& whichField, UInt32 uiAspect, UInt32 uiContainerSize) {
  this->execBeginEditImpl(whichField, uiAspect, uiContainerSize);
}

template <class GeoPropertyDesc>
inline void GeoProperty<GeoPropertyDesc>::onDestroyAspect(UInt32 uiId, UInt32 uiAspect) {
  _field.terminateShare(uiAspect, this->getContainerSize());
}
#endif

template <class GeoPropertyDesc>
inline void GeoProperty<GeoPropertyDesc>::changed(BitVector whichField, UInt32 origin) {
...
template <class GeoPropertyDesc>
inline UInt32 GeoProperty<GeoPropertyDesc>::getBinSize(const BitVector& whichField) {
...
template <class GeoPropertyDesc>
inline void GeoProperty<GeoPropertyDesc>::copyToBin(
...
template <class GeoPropertyDesc>
inline void GeoProperty<GeoPropertyDesc>::copyFromBin(
    BinaryDataHandler& pMem, const BitVector& whichField) {
...
*/
template <class GeoPropertyDesc>
inline typename GeoProperty<GeoPropertyDesc>::StoredFieldType*
...
*/
template <class GeoPropertyDesc>
inline const typename GeoProperty<GeoPropertyDesc>::StoredFieldType&
GeoProperty<GeoPropertyDesc>::getField(void) const {
  return _field;
}

template <class GeoPropertyDesc>
inline typename GeoProperty<GeoPropertyDesc>::LocalInheritedPtr GeoProperty<GeoPropertyDesc>::clone(
    void) {
...
template <class GeoPropertyDesc>
inline UInt32 GeoProperty<GeoPropertyDesc>::getFormat(void) const {
  return GeoPropertyDesc::getFormat();
}

template <class GeoPropertyDesc>
inline UInt32 GeoProperty<GeoPropertyDesc>::getFormatSize(void) const {
...
template <class GeoPropertyDesc>
inline typename GeoProperty<GeoPropertyDesc>::StoredGenericType
...
template <class GeoPropertyDesc>
inline void GeoProperty<GeoPropertyDesc>::getValue(StoredGenericType& val, const UInt32 index) {
  new (&val) StoredGenericType(_field[index]);
}

template <class GeoPropertyDesc>
inline void GeoProperty<GeoPropertyDesc>::getValue(
    StoredGenericType& val, const UInt32 index) const {
  new (&val) StoredGenericType(_field[index]);
}

template <class GeoPropertyDesc>
inline void GeoProperty<GeoPropertyDesc>::setValue(
    const StoredGenericType& value, const UInt32 index) {
  // CHECKCHECK do conversion constructor iff necessary
  _field[index] = StoredType(value);
}

template <class GeoPropertyDesc>
inline void GeoProperty<GeoPropertyDesc>::addValue(const StoredGenericType& value) {
  // CHECKCHECK do conversion constructor iff necessary
  _field.push_back(StoredType(value));
}

template <class GeoPropertyDesc>
inline bool GeoProperty<GeoPropertyDesc>::insertValue(
    const StoredGenericType& val, const UInt32 index) {
...
template <class GeoPropertyDesc>
inline void GeoProperty<GeoPropertyDesc>::clear(void) {
  _field.clear();
}

template <class GeoPropertyDesc>
inline void GeoProperty<GeoPropertyDesc>::push_back(const StoredGenericType& value) {
  addValue(value);
}

template <class GeoPropertyDesc>
inline void GeoProperty<GeoPropertyDesc>::resize(size_t newsize) {
  _field.resize(newsize);
}

template <class GeoPropertyDesc>
inline void GeoProperty<GeoPropertyDesc>::shrink(void) {
  StoredFieldType(_field).swap(_field);
}

template <class GeoPropertyDesc>
inline void GeoProperty<GeoPropertyDesc>::dump(UInt32 uiIndent, const BitVector bvFlags) const {
  LocalInherited::dump(uiIndent, bvFlags);
}
