...
struct FieldDataTraits<ShaderParameterChunkPtr>
  ...
  static const char* getSName(void) {
    return "SFShaderParameterChunkPtr";
  }
  static const char* getMName(void) {
    return "MFShaderParameterChunkPtr";
  }
};
...
#define OSGSHADERPARAMETERCHUNKFIELDS_HEADER_CVSID                                                 \
  "@(#)$Id: OSGShaderParameterChunkFields.h,v 1.5 2006/02/20 17:04:38 dirk Exp $"
