...
typedef FCPtr<GeometryPtr, Surface> SurfacePtr;
...
template <>
struct FieldDataTraits<SurfacePtr> : public FieldTraitsRecurseMapper<SurfacePtr, true> {
...
#define OSGSURFACEFIELDS_HEADER_CVSID                                                              \
