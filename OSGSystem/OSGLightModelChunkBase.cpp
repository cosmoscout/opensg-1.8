...
/*! \var GLenum          LightModelChunkBase::_sfColorControl
    GL_LIGHT_MODEL_COLOR_CONTROL is set to this value.  Legal values are directly taken from the
   glLightModel() manpage.
*/
...
FieldDescription* LightModelChunkBase::_desc[] = {
    new FieldDescription(SFColor4f::getClassType(), "ambient", AmbientFieldId, AmbientFieldMask,
        false, (FieldAccessMethod)&LightModelChunkBase::getSFAmbient),
    new FieldDescription(SFGLenum::getClassType(), "colorControl", ColorControlFieldId,
        ColorControlFieldMask, false, (FieldAccessMethod)&LightModelChunkBase::getSFColorControl),
    new FieldDescription(SFBool::getClassType(), "localViewer", LocalViewerFieldId,
        LocalViewerFieldMask, false, (FieldAccessMethod)&LightModelChunkBase::getSFLocalViewer)};

FieldContainerType LightModelChunkBase::_type("LightModelChunk", "StateChunk", NULL,
    (PrototypeCreateF)&LightModelChunkBase::createEmpty, LightModelChunk::initMethod, _desc,
    sizeof(_desc));
...
void LightModelChunkBase::executeSync(FieldContainer& other, const BitVector& whichField) {
  this->executeSyncImpl((LightModelChunkBase*)&other, whichField);
}
#else
void LightModelChunkBase::executeSync(
    FieldContainer& other, const BitVector& whichField, const SyncInfo& sInfo) {
  this->executeSyncImpl((LightModelChunkBase*)&other, whichField, sInfo);
}
void LightModelChunkBase::execBeginEdit(
...
void LightModelChunkBase::copyToBin(BinaryDataHandler& pMem, const BitVector& whichField) {
...
void LightModelChunkBase::copyFromBin(BinaryDataHandler& pMem, const BitVector& whichField) {
...
#if !defined(OSG_FIXED_MFIELDSYNC)
void LightModelChunkBase::executeSyncImpl(
    LightModelChunkBase* pOther, const BitVector& whichField) {
...
void LightModelChunkBase::execBeginEditImpl(
    const BitVector& whichField, UInt32 uiAspect, UInt32 uiContainerSize) {
