...
#else
  void executeSyncImpl(ShaderChunkBase* pOther, const BitVector& whichField, const SyncInfo& sInfo);
...
typedef osgIF<ShaderChunkBase::isNodeCore, CoredNodePtr<ShaderChunk>,
    FieldContainer::attempt_to_create_CoredNodePtr_on_non_NodeCore_FC>::_IRet ShaderChunkNodePtr;

typedef RefPtr<ShaderChunkPtr> ShaderChunkRefPtr;

OSG_END_NAMESPACE

#define OSGSHADERCHUNKBASE_HEADER_CVSID                                                            \
  "@(#)$Id: OSGShaderChunkBase.h,v 1.8 2006/11/17 17:16:04 a-m-z Exp $"
