...
OSG_ABSTR_FC_DLLEXPORT_DECL(DynFieldAttachment, GenericAttDesc, )
#else
OSG_ABSTR_FC_DLLEXPORT_DECL(DynFieldAttachment, GenericAttDesc, OSG_SYSTEMLIB_DLLTMPLMAPPING)
#endif
#endif
...
template <>
struct FieldDataTraits<GenericAttPtr> : public FieldTraitsRecurseMapper<GenericAttPtr, true> {
  ...
  static Char8* getSName(void) {
    return "SFGenericAttPtr";
  }
  static Char8* getMName(void) {
    return "MFGenericAttPtr";
  }
};
...
class OSG_SYSTEMLIB_DLLMAPPING VRMLNodeDesc {
 ...
 public:
  ...
  virtual void getFieldAndDesc(FieldContainerPtr pFC, const Char8* szFieldname, Field*& pField,
  ...
  virtual bool prototypeAddField(
  ...
  virtual FieldContainerPtr beginNode(
      const Char8* szTypename, const Char8* szName, FieldContainerPtr pCurrentFC);
 ...
 protected:
  ...
  typedef OSG_STDEXTENSION_NAMESPACE::hash_map<const Char8*, UInt32, HashCmpString>
      FieldNameTypeHash;
#else
  typedef OSG_STDEXTENSION_NAMESPACE::hash_map<const Char8*, UInt32,
  ...
  Field* getField(FieldContainerPtr pFC1, FieldContainerPtr pFC2, GenericAttPtr pGenAtt,
