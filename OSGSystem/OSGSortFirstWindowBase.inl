...
inline SortFirstWindowPtr SortFirstWindowBase::create(void) {
  ...
  if (getClassType().getPrototype() != OSG::NullFC) {
    fc = SortFirstWindowPtr::dcast(getClassType().getPrototype()->shallowCopy());
  }
...
inline SFString* SortFirstWindowBase::getSFCompression(void) {
  return &_sfCompression;
}

//! Get the SortFirstWindow::_sfSubtileSize field.
inline SFUInt32* SortFirstWindowBase::getSFSubtileSize(void) {
  return &_sfSubtileSize;
}

//! Get the SortFirstWindow::_sfCompose field.
inline SFBool* SortFirstWindowBase::getSFCompose(void) {
  return &_sfCompose;
}

//! Get the SortFirstWindow::_mfRegion field.
inline MFUInt32* SortFirstWindowBase::getMFRegion(void) {
  return &_mfRegion;
}

//! Get the SortFirstWindow::_sfUseFaceDistribution field.
inline SFBool* SortFirstWindowBase::getSFUseFaceDistribution(void) {
  return &_sfUseFaceDistribution;
}

//! Get the value of the SortFirstWindow::_sfCompression field.
inline std::string& SortFirstWindowBase::getCompression(void) {
  return _sfCompression.getValue();
}

//! Get the value of the SortFirstWindow::_sfCompression field.
inline const std::string& SortFirstWindowBase::getCompression(void) const {
  return _sfCompression.getValue();
}

//! Set the value of the SortFirstWindow::_sfCompression field.
inline void SortFirstWindowBase::setCompression(const std::string& value) {
  _sfCompression.setValue(value);
}

//! Get the value of the SortFirstWindow::_sfSubtileSize field.
inline UInt32& SortFirstWindowBase::getSubtileSize(void) {
  return _sfSubtileSize.getValue();
}

//! Get the value of the SortFirstWindow::_sfSubtileSize field.
inline const UInt32& SortFirstWindowBase::getSubtileSize(void) const {
  return _sfSubtileSize.getValue();
}

//! Set the value of the SortFirstWindow::_sfSubtileSize field.
inline void SortFirstWindowBase::setSubtileSize(const UInt32& value) {
  _sfSubtileSize.setValue(value);
}

//! Get the value of the SortFirstWindow::_sfCompose field.
inline bool& SortFirstWindowBase::getCompose(void) {
  return _sfCompose.getValue();
}

//! Get the value of the SortFirstWindow::_sfCompose field.
inline const bool& SortFirstWindowBase::getCompose(void) const {
  return _sfCompose.getValue();
}

//! Set the value of the SortFirstWindow::_sfCompose field.
inline void SortFirstWindowBase::setCompose(const bool& value) {
  _sfCompose.setValue(value);
}

//! Get the value of the SortFirstWindow::_sfUseFaceDistribution field.
inline bool& SortFirstWindowBase::getUseFaceDistribution(void) {
  return _sfUseFaceDistribution.getValue();
}

//! Get the value of the SortFirstWindow::_sfUseFaceDistribution field.
inline const bool& SortFirstWindowBase::getUseFaceDistribution(void) const {
  return _sfUseFaceDistribution.getValue();
}

//! Set the value of the SortFirstWindow::_sfUseFaceDistribution field.
inline void SortFirstWindowBase::setUseFaceDistribution(const bool& value) {
  _sfUseFaceDistribution.setValue(value);
}

//! Get the value of the \a index element the SortFirstWindow::_mfRegion field.
inline UInt32& SortFirstWindowBase::getRegion(const UInt32 index) {
  return _mfRegion[index];
}

//! Get the SortFirstWindow::_mfRegion field.
inline MFUInt32& SortFirstWindowBase::getRegion(void) {
  return _mfRegion;
}

//! Get the SortFirstWindow::_mfRegion field.
inline const MFUInt32& SortFirstWindowBase::getRegion(void) const {
  return _mfRegion;
}

OSG_END_NAMESPACE

#define OSGSORTFIRSTWINDOWBASE_INLINE_CVSID                                                        \
