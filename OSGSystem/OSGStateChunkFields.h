...
template <>
struct FieldDataTraits<StateChunkPtr> : public FieldTraitsRecurseMapper<StateChunkPtr, true> {
  ...
  static const char* getSName(void) {
    return "SFStateChunkPtr";
  }
  static const char* getMName(void) {
    return "MFStateChunkPtr";
  }
};
...
#define OSGSTATECHUNKFIELDS_HEADER_CVSID                                                           \
