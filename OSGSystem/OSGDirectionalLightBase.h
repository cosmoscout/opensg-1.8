...
class OSG_SYSTEMLIB_DLLMAPPING DirectionalLightBase : public Light {
 private:
...
typedef osgIF<DirectionalLightBase::isNodeCore, CoredNodePtr<DirectionalLight>,
...
#define OSGDIRECTIONALLIGHTBASE_HEADER_CVSID                                                       \
