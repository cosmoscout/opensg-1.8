...
/*! \var GeoPTypesPtr    GeometryBase::_sfTypes
    The types property contains the primitive's types. Legal values are          everything that can
   be passed to glBegin(). There have to be as many          types as lengths.
*/
/*! \var GeoPLengthsPtr  GeometryBase::_sfLengths
    The lengths property contains the number of vertices to use for the          corresponding
   primitive. There have to be as many  lengths as types.
*/
...
/*! \var GeoColorsPtr    GeometryBase::_sfColors
    The colors property contains the color data. See \ref          PageSystemMaterialChunk for
   details on when these colors are used.
*/
/*! \var GeoColorsPtr    GeometryBase::_sfSecondaryColors
    The secondaryColors property contains the secondary colors data.         Secondary colors are
   used for some higher level shaders.
*/
...
/*! \var GeoTexCoordsPtr GeometryBase::_sfTexCoords1
    The texCoords1 property contains the texture coordinate data for the         second texture. See
   \ref PageSystemTextureChunk for multi-texturing.
*/
/*! \var GeoTexCoordsPtr GeometryBase::_sfTexCoords2
    The texCoords2 property contains the texture coordinate data for the         third texture. See
   \ref PageSystemTextureChunk for multi-texturing.
*/
/*! \var GeoTexCoordsPtr GeometryBase::_sfTexCoords3
    The texCoords3 property contains the texture coordinate data for the         fourth texture. See
   \ref PageSystemTextureChunk for multi-texturing.
*/
/*! \var GeoTexCoordsPtr GeometryBase::_sfTexCoords4
    The texCoords4 property contains the texture coordinate data for the         fifth texture. See
   \ref PageSystemTextureChunk for multi-texturing.
*/
/*! \var GeoTexCoordsPtr GeometryBase::_sfTexCoords5
    The texCoords5 property contains the texture coordinate data for the         sixth texture. See
   \ref PageSystemTextureChunk for multi-texturing.
*/
/*! \var GeoTexCoordsPtr GeometryBase::_sfTexCoords6
    The texCoords6 property contains the texture coordinate data for the         seventh texture.
   See \ref PageSystemTextureChunk for multi-texturing.
*/
/*! \var GeoTexCoordsPtr GeometryBase::_sfTexCoords7
    The texCoords7 property contains the texture coordinate data for the         eighth texture. See
   \ref PageSystemTextureChunk for multi-texturing.
*/
/*! \var GeoIndicesPtr   GeometryBase::_sfIndices
    The indices property contains the index data. See \ref          PageSystemGeoIndexing for a
   description of the indexing options.
*/
/*! \var UInt16          GeometryBase::_mfIndexMapping
    The indexMapping property contains the definition which index element         is used for which
   attribute data. See \ref PageSystemGeoIndexing for         a description of the indexing options.
*/
...
FieldDescription* GeometryBase::_desc[] = {
    new FieldDescription(SFGeoPTypesPtr::getClassType(), "types", TypesFieldId, TypesFieldMask,
        false, (FieldAccessMethod)&GeometryBase::getSFTypes),
    new FieldDescription(SFGeoPLengthsPtr::getClassType(), "lengths", LengthsFieldId,
        LengthsFieldMask, false, (FieldAccessMethod)&GeometryBase::getSFLengths),
    new FieldDescription(SFGeoPositionsPtr::getClassType(), "positions", PositionsFieldId,
        PositionsFieldMask, false, (FieldAccessMethod)&GeometryBase::getSFPositions),
    new FieldDescription(SFGeoNormalsPtr::getClassType(), "normals", NormalsFieldId,
        NormalsFieldMask, false, (FieldAccessMethod)&GeometryBase::getSFNormals),
    new FieldDescription(SFGeoColorsPtr::getClassType(), "colors", ColorsFieldId, ColorsFieldMask,
        false, (FieldAccessMethod)&GeometryBase::getSFColors),
    new FieldDescription(SFGeoColorsPtr::getClassType(), "secondaryColors", SecondaryColorsFieldId,
        SecondaryColorsFieldMask, false, (FieldAccessMethod)&GeometryBase::getSFSecondaryColors),
    new FieldDescription(SFGeoTexCoordsPtr::getClassType(), "texCoords", TexCoordsFieldId,
        TexCoordsFieldMask, false, (FieldAccessMethod)&GeometryBase::getSFTexCoords),
    new FieldDescription(SFGeoTexCoordsPtr::getClassType(), "texCoords1", TexCoords1FieldId,
        TexCoords1FieldMask, false, (FieldAccessMethod)&GeometryBase::getSFTexCoords1),
    new FieldDescription(SFGeoTexCoordsPtr::getClassType(), "texCoords2", TexCoords2FieldId,
        TexCoords2FieldMask, false, (FieldAccessMethod)&GeometryBase::getSFTexCoords2),
    new FieldDescription(SFGeoTexCoordsPtr::getClassType(), "texCoords3", TexCoords3FieldId,
        TexCoords3FieldMask, false, (FieldAccessMethod)&GeometryBase::getSFTexCoords3),
    new FieldDescription(SFGeoTexCoordsPtr::getClassType(), "texCoords4", TexCoords4FieldId,
        TexCoords4FieldMask, false, (FieldAccessMethod)&GeometryBase::getSFTexCoords4),
    new FieldDescription(SFGeoTexCoordsPtr::getClassType(), "texCoords5", TexCoords5FieldId,
        TexCoords5FieldMask, false, (FieldAccessMethod)&GeometryBase::getSFTexCoords5),
    new FieldDescription(SFGeoTexCoordsPtr::getClassType(), "texCoords6", TexCoords6FieldId,
        TexCoords6FieldMask, false, (FieldAccessMethod)&GeometryBase::getSFTexCoords6),
    new FieldDescription(SFGeoTexCoordsPtr::getClassType(), "texCoords7", TexCoords7FieldId,
        TexCoords7FieldMask, false, (FieldAccessMethod)&GeometryBase::getSFTexCoords7),
    new FieldDescription(SFGeoIndicesPtr::getClassType(), "indices", IndicesFieldId,
        IndicesFieldMask, false, (FieldAccessMethod)&GeometryBase::getSFIndices),
    new FieldDescription(MFUInt16::getClassType(), "indexMapping", IndexMappingFieldId,
        IndexMappingFieldMask, false, (FieldAccessMethod)&GeometryBase::getMFIndexMapping),
    new FieldDescription(SFBool::getClassType(), "dlistCache", DlistCacheFieldId,
        DlistCacheFieldMask, false, (FieldAccessMethod)&GeometryBase::getSFDlistCache),
    new FieldDescription(SFInt32::getClassType(), "GLId", GLIdFieldId, GLIdFieldMask, true,
    ...
    new FieldDescription(SFInt32::getClassType(), "IgnoreGLForAspect", IgnoreGLForAspectFieldId,
        IgnoreGLForAspectFieldMask, true, (FieldAccessMethod)&GeometryBase::getSFIgnoreGLForAspect),
    new FieldDescription(SFUInt32::getClassType(), "minindex", MinindexFieldId, MinindexFieldMask,
        true, (FieldAccessMethod)&GeometryBase::getSFMinindex),
    new FieldDescription(SFUInt32::getClassType(), "maxindex", MaxindexFieldId, MaxindexFieldMask,
        true, (FieldAccessMethod)&GeometryBase::getSFMaxindex),
    new FieldDescription(MFUInt32::getClassType(), "lowindices", LowindicesFieldId,
        LowindicesFieldMask, true, (FieldAccessMethod)&GeometryBase::getMFLowindices),
    new FieldDescription(MFUInt32::getClassType(), "highindices", HighindicesFieldId,
        HighindicesFieldMask, true, (FieldAccessMethod)&GeometryBase::getMFHighindices),
    new FieldDescription(SFBool::getClassType(), "vbo", VboFieldId, VboFieldMask, false,
        (FieldAccessMethod)&GeometryBase::getSFVbo)};

FieldContainerType GeometryBase::_type("Geometry", "MaterialDrawable", NULL,
    (PrototypeCreateF)&GeometryBase::createEmpty, Geometry::initMethod, _desc, sizeof(_desc));
...
void GeometryBase::executeSync(FieldContainer& other, const BitVector& whichField) {
  this->executeSyncImpl((GeometryBase*)&other, whichField);
}
#else
void GeometryBase::executeSync(
    FieldContainer& other, const BitVector& whichField, const SyncInfo& sInfo) {
  this->executeSyncImpl((GeometryBase*)&other, whichField, sInfo);
}
void GeometryBase::execBeginEdit(
...
void GeometryBase::copyToBin(BinaryDataHandler& pMem, const BitVector& whichField) {
...
void GeometryBase::copyFromBin(BinaryDataHandler& pMem, const BitVector& whichField) {
...
#if !defined(OSG_FIXED_MFIELDSYNC)
void GeometryBase::executeSyncImpl(GeometryBase* pOther, const BitVector& whichField) {
...
#else
void GeometryBase::executeSyncImpl(
    GeometryBase* pOther, const BitVector& whichField, const SyncInfo& sInfo) {
...
void GeometryBase::execBeginEditImpl(
    const BitVector& whichField, UInt32 uiAspect, UInt32 uiContainerSize) {
