...
FieldDescription* RegisterCombinersChunkBase::_desc[] = {
    new FieldDescription(SFColor4f::getClassType(), "color0", Color0FieldId, Color0FieldMask, false,
        (FieldAccessMethod)&RegisterCombinersChunkBase::getSFColor0),
    new FieldDescription(SFColor4f::getClassType(), "color1", Color1FieldId, Color1FieldMask, false,
        (FieldAccessMethod)&RegisterCombinersChunkBase::getSFColor1),
    new FieldDescription(SFBool::getClassType(), "colorSumClamp", ColorSumClampFieldId,
        ColorSumClampFieldMask, false,
        (FieldAccessMethod)&RegisterCombinersChunkBase::getSFColorSumClamp),
    new FieldDescription(MFGLenum::getClassType(), "variableArgb", VariableArgbFieldId,
        VariableArgbFieldMask, false,
        (FieldAccessMethod)&RegisterCombinersChunkBase::getMFVariableArgb),
    new FieldDescription(MFGLenum::getClassType(), "variableBrgb", VariableBrgbFieldId,
        VariableBrgbFieldMask, false,
        (FieldAccessMethod)&RegisterCombinersChunkBase::getMFVariableBrgb),
    new FieldDescription(MFGLenum::getClassType(), "variableCrgb", VariableCrgbFieldId,
        VariableCrgbFieldMask, false,
        (FieldAccessMethod)&RegisterCombinersChunkBase::getMFVariableCrgb),
    new FieldDescription(MFGLenum::getClassType(), "variableDrgb", VariableDrgbFieldId,
        VariableDrgbFieldMask, false,
        (FieldAccessMethod)&RegisterCombinersChunkBase::getMFVariableDrgb),
    new FieldDescription(MFGLenum::getClassType(), "variableAalpha", VariableAalphaFieldId,
        VariableAalphaFieldMask, false,
        (FieldAccessMethod)&RegisterCombinersChunkBase::getMFVariableAalpha),
    new FieldDescription(MFGLenum::getClassType(), "variableBalpha", VariableBalphaFieldId,
        VariableBalphaFieldMask, false,
        (FieldAccessMethod)&RegisterCombinersChunkBase::getMFVariableBalpha),
    new FieldDescription(MFGLenum::getClassType(), "variableCalpha", VariableCalphaFieldId,
        VariableCalphaFieldMask, false,
        (FieldAccessMethod)&RegisterCombinersChunkBase::getMFVariableCalpha),
    new FieldDescription(MFGLenum::getClassType(), "variableDalpha", VariableDalphaFieldId,
        VariableDalphaFieldMask, false,
        (FieldAccessMethod)&RegisterCombinersChunkBase::getMFVariableDalpha),
    new FieldDescription(MFGLenum::getClassType(), "outputABrgb", OutputABrgbFieldId,
        OutputABrgbFieldMask, false,
        (FieldAccessMethod)&RegisterCombinersChunkBase::getMFOutputABrgb),
    new FieldDescription(MFGLenum::getClassType(), "outputCDrgb", OutputCDrgbFieldId,
        OutputCDrgbFieldMask, false,
        (FieldAccessMethod)&RegisterCombinersChunkBase::getMFOutputCDrgb),
    new FieldDescription(MFGLenum::getClassType(), "outputSumrgb", OutputSumrgbFieldId,
        OutputSumrgbFieldMask, false,
        (FieldAccessMethod)&RegisterCombinersChunkBase::getMFOutputSumrgb),
    new FieldDescription(MFGLenum::getClassType(), "scalergb", ScalergbFieldId, ScalergbFieldMask,
        false, (FieldAccessMethod)&RegisterCombinersChunkBase::getMFScalergb),
    new FieldDescription(MFGLenum::getClassType(), "biasrgb", BiasrgbFieldId, BiasrgbFieldMask,
        false, (FieldAccessMethod)&RegisterCombinersChunkBase::getMFBiasrgb),
    new FieldDescription(MFGLenum::getClassType(), "outputABalpha", OutputABalphaFieldId,
        OutputABalphaFieldMask, false,
        (FieldAccessMethod)&RegisterCombinersChunkBase::getMFOutputABalpha),
    new FieldDescription(MFGLenum::getClassType(), "outputCDalpha", OutputCDalphaFieldId,
        OutputCDalphaFieldMask, false,
        (FieldAccessMethod)&RegisterCombinersChunkBase::getMFOutputCDalpha),
    new FieldDescription(MFGLenum::getClassType(), "outputSumalpha", OutputSumalphaFieldId,
        OutputSumalphaFieldMask, false,
        (FieldAccessMethod)&RegisterCombinersChunkBase::getMFOutputSumalpha),
    new FieldDescription(MFUInt8::getClassType(), "dotABrgb", DotABrgbFieldId, DotABrgbFieldMask,
        false, (FieldAccessMethod)&RegisterCombinersChunkBase::getMFDotABrgb),
    new FieldDescription(MFUInt8::getClassType(), "dotCDrgb", DotCDrgbFieldId, DotCDrgbFieldMask,
        false, (FieldAccessMethod)&RegisterCombinersChunkBase::getMFDotCDrgb),
    new FieldDescription(MFUInt8::getClassType(), "muxSumrgb", MuxSumrgbFieldId, MuxSumrgbFieldMask,
        false, (FieldAccessMethod)&RegisterCombinersChunkBase::getMFMuxSumrgb),
    new FieldDescription(MFGLenum::getClassType(), "scalealpha", ScalealphaFieldId,
        ScalealphaFieldMask, false,
        (FieldAccessMethod)&RegisterCombinersChunkBase::getMFScalealpha),
    new FieldDescription(MFGLenum::getClassType(), "biasalpha", BiasalphaFieldId,
        BiasalphaFieldMask, false, (FieldAccessMethod)&RegisterCombinersChunkBase::getMFBiasalpha),
    new FieldDescription(MFUInt8::getClassType(), "muxSumalpha", MuxSumalphaFieldId,
        MuxSumalphaFieldMask, false,
        (FieldAccessMethod)&RegisterCombinersChunkBase::getMFMuxSumalpha),
    new FieldDescription(MFGLenum::getClassType(), "variableE", VariableEFieldId,
        VariableEFieldMask, false, (FieldAccessMethod)&RegisterCombinersChunkBase::getMFVariableE),
    new FieldDescription(MFGLenum::getClassType(), "variableF", VariableFFieldId,
        VariableFFieldMask, false, (FieldAccessMethod)&RegisterCombinersChunkBase::getMFVariableF),
    new FieldDescription(MFGLenum::getClassType(), "variableG", VariableGFieldId,
        VariableGFieldMask, false, (FieldAccessMethod)&RegisterCombinersChunkBase::getMFVariableG),
    new FieldDescription(MFColor4f::getClassType(), "combinerColor0", CombinerColor0FieldId,
        CombinerColor0FieldMask, false,
        (FieldAccessMethod)&RegisterCombinersChunkBase::getMFCombinerColor0),
    new FieldDescription(MFColor4f::getClassType(), "combinerColor1", CombinerColor1FieldId,
        CombinerColor1FieldMask, false,
        (FieldAccessMethod)&RegisterCombinersChunkBase::getMFCombinerColor1),
    new FieldDescription(SFUInt8::getClassType(), "perStageConstants", PerStageConstantsFieldId,
        PerStageConstantsFieldMask, true,
        (FieldAccessMethod)&RegisterCombinersChunkBase::getSFPerStageConstants)};

FieldContainerType RegisterCombinersChunkBase::_type("RegisterCombinersChunk", "StateChunk", NULL,
    (PrototypeCreateF)&RegisterCombinersChunkBase::createEmpty, RegisterCombinersChunk::initMethod,
    _desc, sizeof(_desc));
...
void RegisterCombinersChunkBase::executeSync(FieldContainer& other, const BitVector& whichField) {
  this->executeSyncImpl((RegisterCombinersChunkBase*)&other, whichField);
}
#else
void RegisterCombinersChunkBase::executeSync(
    FieldContainer& other, const BitVector& whichField, const SyncInfo& sInfo) {
  this->executeSyncImpl((RegisterCombinersChunkBase*)&other, whichField, sInfo);
}
void RegisterCombinersChunkBase::execBeginEdit(
...
void RegisterCombinersChunkBase::copyToBin(BinaryDataHandler& pMem, const BitVector& whichField) {
...
void RegisterCombinersChunkBase::copyFromBin(BinaryDataHandler& pMem, const BitVector& whichField) {
...
#if !defined(OSG_FIXED_MFIELDSYNC)
void RegisterCombinersChunkBase::executeSyncImpl(
    RegisterCombinersChunkBase* pOther, const BitVector& whichField) {
...
void RegisterCombinersChunkBase::execBeginEditImpl(
    const BitVector& whichField, UInt32 uiAspect, UInt32 uiContainerSize) {
...
DataType FieldDataTraits<RegisterCombinersChunkPtr>::_type(
    "RegisterCombinersChunkPtr", "StateChunkPtr");
#endif
