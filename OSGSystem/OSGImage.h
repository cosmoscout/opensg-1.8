...
/*** RGBA_DXT5 ***/
  ...
  bool set(UInt32 pixelFormat, Int32 width, Int32 height = 1, Int32 depth = 1,
      Int32 mipmapCount = 1, Int32 frameCount = 1, Time frameDelay = 0.0, const UInt8* data = 0,
      Int32 type = OSG_UINT8_IMAGEDATA, bool allocMem = true, Int32 sideCount = 1);

  bool set(ImagePtr image);
  bool setData(const UInt8* data = 0);
  void clearData(void);
  bool setSubData(
      Int32 offX, Int32 offY, Int32 offZ, Int32 srcW, Int32 srcH, Int32 srcD, const UInt8* data);
  ...
  bool subImage(Int32 offX, Int32 offY, Int32 offZ, Int32 destW, Int32 destH, Int32 destD,
  ...
  inline unsigned long getSize(
      bool withMipmap = true, bool withFrames = true, bool withSides = true) const;
  ...
  inline const UInt8* getData(UInt32 mipmapNum = 0, UInt32 frameNum = 0, UInt32 sideNum = 0) const;
  inline UInt8*       getData(UInt32 mipmapNum = 0, UInt32 frameNum = 0, UInt32 sideNum = 0);
 ...
 private:
  ...
  bool scaleData(UInt8* srcData, Int32 srcW, Int32 srcH, Int32 srcD, UInt8* destData, Int32 destW,
      Int32 destH, Int32 destD);
