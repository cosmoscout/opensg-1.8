...
/*! \var Pnt3f           ProjectionCameraDecoratorBase::_mfSurface
    4 points describing the rectangular projection surface, in the camera coordinate system.
   Counterclockwise, starting at lower left corner of the screen.
*/
...
FieldDescription* ProjectionCameraDecoratorBase::_desc[] = {
    new FieldDescription(SFNodePtr::getClassType(), "user", UserFieldId, UserFieldMask, false,
        (FieldAccessMethod)&ProjectionCameraDecoratorBase::getSFUser),
    new FieldDescription(MFPnt3f::getClassType(), "surface", SurfaceFieldId, SurfaceFieldMask,
        false, (FieldAccessMethod)&ProjectionCameraDecoratorBase::getMFSurface),
    new FieldDescription(SFPlane::getClassType(), "left", LeftFieldId, LeftFieldMask, true,
        (FieldAccessMethod)&ProjectionCameraDecoratorBase::getSFLeft),
    new FieldDescription(SFPlane::getClassType(), "bottom", BottomFieldId, BottomFieldMask, true,
        (FieldAccessMethod)&ProjectionCameraDecoratorBase::getSFBottom),
    new FieldDescription(SFPlane::getClassType(), "normal", NormalFieldId, NormalFieldMask, true,
        (FieldAccessMethod)&ProjectionCameraDecoratorBase::getSFNormal),
    new FieldDescription(SFReal32::getClassType(), "width", WidthFieldId, WidthFieldMask, true,
        (FieldAccessMethod)&ProjectionCameraDecoratorBase::getSFWidth),
    new FieldDescription(SFReal32::getClassType(), "height", HeightFieldId, HeightFieldMask, true,
        (FieldAccessMethod)&ProjectionCameraDecoratorBase::getSFHeight)};

FieldContainerType ProjectionCameraDecoratorBase::_type("ProjectionCameraDecorator",
    "StereoCameraDecorator", NULL, (PrototypeCreateF)&ProjectionCameraDecoratorBase::createEmpty,
    ProjectionCameraDecorator::initMethod, _desc, sizeof(_desc));
...
void ProjectionCameraDecoratorBase::executeSync(
...
void ProjectionCameraDecoratorBase::execBeginEdit(
...
ProjectionCameraDecoratorBase::ProjectionCameraDecoratorBase(
    const ProjectionCameraDecoratorBase& source)
...
void ProjectionCameraDecoratorBase::copyToBin(
...
void ProjectionCameraDecoratorBase::copyFromBin(
    BinaryDataHandler& pMem, const BitVector& whichField) {
...
#if !defined(OSG_FIXED_MFIELDSYNC)
void ProjectionCameraDecoratorBase::executeSyncImpl(
    ProjectionCameraDecoratorBase* pOther, const BitVector& whichField) {
...
void ProjectionCameraDecoratorBase::execBeginEditImpl(
    const BitVector& whichField, UInt32 uiAspect, UInt32 uiContainerSize) {
...
DataType FieldDataTraits<ProjectionCameraDecoratorPtr>::_type(
    "ProjectionCameraDecoratorPtr", "StereoCameraDecoratorPtr");
#endif
