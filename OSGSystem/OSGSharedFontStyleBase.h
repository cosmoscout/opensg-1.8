...
class OSG_SYSTEMLIB_DLLMAPPING SharedFontStyleBase : public FieldContainer {
 ...
 protected:
  ...
  void executeSyncImpl(SharedFontStyleBase* pOther, const BitVector& whichField);
...
typedef osgIF<SharedFontStyleBase::isNodeCore, CoredNodePtr<SharedFontStyle>,
    FieldContainer::attempt_to_create_CoredNodePtr_on_non_NodeCore_FC>::_IRet
    SharedFontStyleNodePtr;

typedef RefPtr<SharedFontStylePtr> SharedFontStyleRefPtr;

OSG_END_NAMESPACE

#define OSGSHAREDFONTSTYLEBASE_HEADER_CVSID                                                        \
