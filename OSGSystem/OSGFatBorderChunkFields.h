...
typedef FCPtr<VertexProgramChunkPtr, FatBorderChunk> FatBorderChunkPtr;
...
template <>
struct FieldDataTraits<FatBorderChunkPtr>
    : public FieldTraitsRecurseMapper<FatBorderChunkPtr, true> {
  ...
  static const char* getSName(void) {
    return "SFFatBorderChunkPtr";
  }
  static const char* getMName(void) {
    return "MFFatBorderChunkPtr";
  }
};

#if !defined(OSG_DOC_DEV_TRAITS)
/*! \class  FieldTraitsRecurseMapper<FatBorderChunkPtr, true>
    \hideinhierarchy
 */
#endif
...
#define OSGFATBORDERCHUNKFIELDS_HEADER_CVSID                                                       \
