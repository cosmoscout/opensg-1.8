...
FieldContainerType ScaleManipulatorBase::_type("ScaleManipulator", "Manipulator", NULL,
    (PrototypeCreateF)&ScaleManipulatorBase::createEmpty, ScaleManipulator::initMethod, NULL, 0);
...
void ScaleManipulatorBase::executeSync(FieldContainer& other, const BitVector& whichField) {
  this->executeSyncImpl((ScaleManipulatorBase*)&other, whichField);
}
#else
void ScaleManipulatorBase::executeSync(
    FieldContainer& other, const BitVector& whichField, const SyncInfo& sInfo) {
  this->executeSyncImpl((ScaleManipulatorBase*)&other, whichField, sInfo);
}
void ScaleManipulatorBase::execBeginEdit(
...
void ScaleManipulatorBase::copyToBin(BinaryDataHandler& pMem, const BitVector& whichField) {
  Inherited::copyToBin(pMem, whichField);
}

void ScaleManipulatorBase::copyFromBin(BinaryDataHandler& pMem, const BitVector& whichField) {
  Inherited::copyFromBin(pMem, whichField);
}

#if !defined(OSG_FIXED_MFIELDSYNC)
void ScaleManipulatorBase::executeSyncImpl(
    ScaleManipulatorBase* pOther, const BitVector& whichField) {

  Inherited::executeSyncImpl(pOther, whichField);
}
#else
void ScaleManipulatorBase::executeSyncImpl(
    ScaleManipulatorBase* pOther, const BitVector& whichField, const SyncInfo& sInfo) {

  Inherited::executeSyncImpl(pOther, whichField, sInfo);
}

void ScaleManipulatorBase::execBeginEditImpl(
    const BitVector& whichField, UInt32 uiAspect, UInt32 uiContainerSize) {
