...
class OSG_SYSTEMLIB_DLLMAPPING PhongMaterialBase : public ChunkMaterial {
 private:
...
typedef osgIF<PhongMaterialBase::isNodeCore, CoredNodePtr<PhongMaterial>,
    FieldContainer::attempt_to_create_CoredNodePtr_on_non_NodeCore_FC>::_IRet PhongMaterialNodePtr;

typedef RefPtr<PhongMaterialPtr> PhongMaterialRefPtr;

OSG_END_NAMESPACE

#define OSGPHONGMATERIALBASE_HEADER_CVSID                                                          \
