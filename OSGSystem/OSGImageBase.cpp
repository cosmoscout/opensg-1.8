...
/*! \var Int32           ImageBase::_sfComponentSize
    Size (in byte) of a single component of the image. Necessary         for High Dynamic Range and
   other higher-level image types.
*/
...
/*! \var bool            ImageBase::_sfForceCompressedData
    Set to true if using the image to keep unknown data for textures.         Generally used in
   conjunction with TextureChunk::externalFormat.
*/
...
/*! \var bool            ImageBase::_sfForceAlphaBinary
    Set to true if using the image to prevent depth sorting for          SimpleTexturedMaterials
   using this Image.
*/
...
FieldDescription* ImageBase::_desc[] = {
    new FieldDescription(MFFieldContainerPtr::getClassType(), "parents", ParentsFieldId,
        ParentsFieldMask, false, (FieldAccessMethod)&ImageBase::getMFParents),
    new FieldDescription(SFInt32::getClassType(), "dimension", DimensionFieldId, DimensionFieldMask,
        false, (FieldAccessMethod)&ImageBase::getSFDimension),
    new FieldDescription(SFInt32::getClassType(), "width", WidthFieldId, WidthFieldMask, false,
        (FieldAccessMethod)&ImageBase::getSFWidth),
    new FieldDescription(SFInt32::getClassType(), "height", HeightFieldId, HeightFieldMask, false,
        (FieldAccessMethod)&ImageBase::getSFHeight),
    new FieldDescription(SFInt32::getClassType(), "depth", DepthFieldId, DepthFieldMask, false,
        (FieldAccessMethod)&ImageBase::getSFDepth),
    new FieldDescription(SFInt32::getClassType(), "bpp", BppFieldId, BppFieldMask, false,
        (FieldAccessMethod)&ImageBase::getSFBpp),
    new FieldDescription(SFInt32::getClassType(), "mipMapCount", MipMapCountFieldId,
        MipMapCountFieldMask, false, (FieldAccessMethod)&ImageBase::getSFMipMapCount),
    new FieldDescription(SFInt32::getClassType(), "frameCount", FrameCountFieldId,
        FrameCountFieldMask, false, (FieldAccessMethod)&ImageBase::getSFFrameCount),
    new FieldDescription(SFTime::getClassType(), "frameDelay", FrameDelayFieldId,
        FrameDelayFieldMask, false, (FieldAccessMethod)&ImageBase::getSFFrameDelay),
    new FieldDescription(SFUInt32::getClassType(), "pixelFormat", PixelFormatFieldId,
        PixelFormatFieldMask, false, (FieldAccessMethod)&ImageBase::getSFPixelFormat),
    new FieldDescription(MFUInt8::getClassType(), "pixel", PixelFieldId, PixelFieldMask, false,
        (FieldAccessMethod)&ImageBase::getMFPixel),
    new FieldDescription(SFInt32::getClassType(), "frameSize", FrameSizeFieldId, FrameSizeFieldMask,
        true, (FieldAccessMethod)&ImageBase::getSFFrameSize),
    new FieldDescription(SFString::getClassType(), "name", NameFieldId, NameFieldMask, false,
        (FieldAccessMethod)&ImageBase::getSFName),
    new FieldDescription(SFInt32::getClassType(), "dataType", DataTypeFieldId, DataTypeFieldMask,
        false, (FieldAccessMethod)&ImageBase::getSFDataType),
    new FieldDescription(SFInt32::getClassType(), "componentSize", ComponentSizeFieldId,
        ComponentSizeFieldMask, true, (FieldAccessMethod)&ImageBase::getSFComponentSize),
    new FieldDescription(SFInt32::getClassType(), "sideCount", SideCountFieldId, SideCountFieldMask,
        false, (FieldAccessMethod)&ImageBase::getSFSideCount),
    new FieldDescription(SFInt32::getClassType(), "sideSize", SideSizeFieldId, SideSizeFieldMask,
        true, (FieldAccessMethod)&ImageBase::getSFSideSize),
    new FieldDescription(SFBool::getClassType(), "forceCompressedData", ForceCompressedDataFieldId,
        ForceCompressedDataFieldMask, false,
        (FieldAccessMethod)&ImageBase::getSFForceCompressedData),
    new FieldDescription(SFBool::getClassType(), "forceAlphaChannel", ForceAlphaChannelFieldId,
        ForceAlphaChannelFieldMask, false, (FieldAccessMethod)&ImageBase::getSFForceAlphaChannel),
    new FieldDescription(SFBool::getClassType(), "forceColorChannel", ForceColorChannelFieldId,
        ForceColorChannelFieldMask, false, (FieldAccessMethod)&ImageBase::getSFForceColorChannel),
    new FieldDescription(SFBool::getClassType(), "forceAlphaBinary", ForceAlphaBinaryFieldId,
        ForceAlphaBinaryFieldMask, false, (FieldAccessMethod)&ImageBase::getSFForceAlphaBinary),
    new FieldDescription(SFReal32::getClassType(), "resX", ResXFieldId, ResXFieldMask, false,
        (FieldAccessMethod)&ImageBase::getSFResX),
    new FieldDescription(SFReal32::getClassType(), "resY", ResYFieldId, ResYFieldMask, false,
        (FieldAccessMethod)&ImageBase::getSFResY),
    new FieldDescription(SFUInt16::getClassType(), "resUnit", ResUnitFieldId, ResUnitFieldMask,
        false, (FieldAccessMethod)&ImageBase::getSFResUnit)};

FieldContainerType ImageBase::_type("Image", "AttachmentContainer", NULL,
    (PrototypeCreateF)&ImageBase::createEmpty, Image::initMethod, _desc, sizeof(_desc));
...
void ImageBase::executeSync(FieldContainer& other, const BitVector& whichField) {
  this->executeSyncImpl((ImageBase*)&other, whichField);
}
#else
void ImageBase::executeSync(
    FieldContainer& other, const BitVector& whichField, const SyncInfo& sInfo) {
  this->executeSyncImpl((ImageBase*)&other, whichField, sInfo);
}
void ImageBase::execBeginEdit(
...
void ImageBase::copyToBin(BinaryDataHandler& pMem, const BitVector& whichField) {
...
void ImageBase::copyFromBin(BinaryDataHandler& pMem, const BitVector& whichField) {
...
#if !defined(OSG_FIXED_MFIELDSYNC)
void ImageBase::executeSyncImpl(ImageBase* pOther, const BitVector& whichField) {
...
#else
void ImageBase::executeSyncImpl(
    ImageBase* pOther, const BitVector& whichField, const SyncInfo& sInfo) {
...
void ImageBase::execBeginEditImpl(
    const BitVector& whichField, UInt32 uiAspect, UInt32 uiContainerSize) {
