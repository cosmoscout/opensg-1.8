...
class OSG_SYSTEMLIB_DLLMAPPING PassiveBackgroundBase : public Background {
 private:
...
typedef osgIF<PassiveBackgroundBase::isNodeCore, CoredNodePtr<PassiveBackground>,
...
#define OSGPASSIVEBACKGROUNDBASE_HEADER_CVSID                                                      \
