...
typedef osgIF<TextureChunkBase::isNodeCore, CoredNodePtr<TextureChunk>,
    FieldContainer::attempt_to_create_CoredNodePtr_on_non_NodeCore_FC>::_IRet TextureChunkNodePtr;

typedef RefPtr<TextureChunkPtr> TextureChunkRefPtr;

OSG_END_NAMESPACE

#define OSGTEXTURECHUNKBASE_HEADER_CVSID                                                           \
