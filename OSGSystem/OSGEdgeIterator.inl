...
inline Int32 EdgeIterator::getIndex(void) const {
  return _edgeIndex;
}
...
*/
inline UInt32 EdgeIterator::getLength(void) const {
  if (getType() == GL_LINES)
    return 2;
  else
...
inline Int32 EdgeIterator::getPositionIndex(Int32 which) const {
  if (getType() == GL_LINES)
...
inline Pnt3f EdgeIterator::getPosition(Int32 which) const {
  Int32 ind = getPositionIndex(which);

  return getGeometry()->getPositions()->getValue(ind);
}

inline Int32 EdgeIterator::getNormalIndex(Int32 which) const {
  if (getType() == GL_LINES)
...
inline Vec3f EdgeIterator::getNormal(Int32 which) const {
  Int32 ind = getNormalIndex(which);

  return getGeometry()->getNormals()->getValue(ind);
}

inline Int32 EdgeIterator::getColorIndex(Int32 which) const {
  if (getType() == GL_LINES)
...
inline Color3f EdgeIterator::getColor(Int32 which) const {
  Int32 ind = getColorIndex(which);

  return getGeometry()->getColors()->getValue(ind);
}

inline Int32 EdgeIterator::getSecondaryColorIndex(Int32 which) const {
  if (getType() == GL_LINES)
...
inline Color3f EdgeIterator::getSecondaryColor(Int32 which) const {
  Int32 ind = getSecondaryColorIndex(which);

  return getGeometry()->getSecondaryColors()->getValue(ind);
}

inline Int32 EdgeIterator::getTexCoordsIndex(Int32 which) const {
  if (getType() == GL_LINES)
...
inline Vec2f EdgeIterator::getTexCoords(Int32 which) const {
  Int32 ind = getTexCoordsIndex(which);

  return getGeometry()->getTexCoords()->getValue(ind);
}

inline Int32 EdgeIterator::getTexCoordsIndex1(Int32 which) const {
  if (getType() == GL_LINES)
...
inline Vec2f EdgeIterator::getTexCoords1(Int32 which) const {
  Int32 ind = getTexCoordsIndex1(which);

  return getGeometry()->getTexCoords1()->getValue(ind);
}

inline Int32 EdgeIterator::getTexCoordsIndex2(Int32 which) const {
  if (getType() == GL_LINES)
...
inline Vec2f EdgeIterator::getTexCoords2(Int32 which) const {
  Int32 ind = getTexCoordsIndex2(which);

  return getGeometry()->getTexCoords2()->getValue(ind);
}

inline Int32 EdgeIterator::getTexCoordsIndex3(Int32 which) const {
  if (getType() == GL_LINES)
...
inline Vec2f EdgeIterator::getTexCoords3(Int32 which) const {
  Int32 ind = getTexCoordsIndex3(which);

  return getGeometry()->getTexCoords3()->getValue(ind);
}

inline Int32 EdgeIterator::getTexCoordsIndex4(Int32 which) const {
  if (getType() == GL_LINES)
...
inline Vec2f EdgeIterator::getTexCoords4(Int32 which) const {
  Int32 ind = getTexCoordsIndex4(which);

  return getGeometry()->getTexCoords4()->getValue(ind);
}

inline Int32 EdgeIterator::getTexCoordsIndex5(Int32 which) const {
  if (getType() == GL_LINES)
...
inline Vec2f EdgeIterator::getTexCoords5(Int32 which) const {
  Int32 ind = getTexCoordsIndex5(which);

  return getGeometry()->getTexCoords5()->getValue(ind);
}

inline Int32 EdgeIterator::getTexCoordsIndex6(Int32 which) const {
  if (getType() == GL_LINES)
...
inline Vec2f EdgeIterator::getTexCoords6(Int32 which) const {
  Int32 ind = getTexCoordsIndex6(which);

  return getGeometry()->getTexCoords6()->getValue(ind);
}

inline Int32 EdgeIterator::getTexCoordsIndex7(Int32 which) const {
  if (getType() == GL_LINES)
...
inline Vec2f EdgeIterator::getTexCoords7(Int32 which) const {
  Int32 ind = getTexCoordsIndex7(which);

  return getGeometry()->getTexCoords7()->getValue(ind);
}

inline Int32 EdgeIterator::getIndexIndex(Int32 which) const {
  if (getType() == GL_LINES)
    return Inherited::getIndexIndex(_edgePntIndex[which]);
  else
    return Inherited::getIndexIndex(which);
}
