...
class XMLPP_API xmlnode {
 ...
 public:
  ...
  xmlstring get_attribute(xmlstring& attr) {
  ...
  //! sets new cdata
  void set_cdata(xmlstring& ncdata) {
    cdata = ncdata;
  }
  //! sets new attribute value
  void set_attribute(xmlstring& attr, xmlstring& value) {
