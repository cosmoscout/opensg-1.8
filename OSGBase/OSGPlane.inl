 ...
 */
inline Real32 Plane::distance(const Pnt3f& pnt) const {
  return _normalVec.dot(pnt) - _distance;
}

/*! Check if the point is on the plane.
 */
inline bool Plane::isOnPlane(const Pnt3f& point) const {
 ...
 */
inline bool Plane::isInHalfSpace(const Pnt3f& point) const {
  Real32 scalar = _normalVec.dot(point) - _distance;
 ...
 */
inline bool Plane::isInHalfSpace(const Pnt3f& min, const Pnt3f& max) const {
  Pnt3f p;
 ...
 */
inline bool Plane::isOutHalfSpace(const Pnt3f& min, const Pnt3f& max) const {
  Pnt3f p;
 ...
 */
inline void Plane::set(const Vec3f& normal, Real32 distance) {
  _normalVec = normal;
  _distance  = distance;
...
inline void Plane::set(Real32 x, Real32 y, Real32 z, Real32 distance) {
...
inline void Plane::set(const Vec4f& plane) {
...
inline const Vec3f& Plane::getNormal(void) const {
  return _normalVec;
}

inline Real32 Plane::getDistanceFromOrigin(void) const {
  return _distance;
}
...
inline void Plane::setDirectionIndexPoint(
    const Pnt3f& min, const Pnt3f& max, const UInt8 index, Pnt3f& pnt) const {
  if (index & 0x1) {
    pnt[0] = min[0];
  } else {
    pnt[0] = max[0];
