...
template <>
struct OSG_BASE_DLLMAPPING FieldDataTraits<Int8> : public FieldTraitsIntegralRecurseMapper<Int8> {
  static DataType               _type;
  ...
  static Int8 getDefault(void) {
    return 0;
  }

  static bool getFromString(Int8& outVal, const Char8*& inVal) {
    outVal = TypeTraits<Int8>::getFromString(inVal);

    return true;
  }

  static void putToString(const Int8& inVal, std::string& outStr) {
...
template <>
struct OSG_BASE_DLLMAPPING FieldDataTraits<UInt8> : public FieldTraitsIntegralRecurseMapper<UInt8> {
  static DataType                _type;
...
template <>
struct OSG_BASE_DLLMAPPING FieldDataTraits<Int16> : public FieldTraitsIntegralRecurseMapper<Int16> {
  static DataType                _type;
  ...
  static Int16 getDefault(void) {
    return 0;
  }

  static bool getFromString(Int16& outVal, const Char8*& inVal) {
    outVal = TypeTraits<Int16>::getFromString(inVal);

    return true;
  }

  static void putToString(const Int16& inVal, std::string& outStr) {
...
template <>
struct OSG_BASE_DLLMAPPING FieldDataTraits<Int32> : public FieldTraitsIntegralRecurseMapper<Int32> {
  static DataType                _type;
...
template <>
struct OSG_BASE_DLLMAPPING FieldDataTraits<Int64> : public FieldTraitsIntegralRecurseMapper<Int64> {
  static DataType                _type;
  ...
  static Int64 getDefault(void) {
    return 0;
  }

  static bool getFromString(Int64& outVal, const Char8*& inVal) {
    outVal = TypeTraits<Int64>::getFromString(inVal);

    return false;
  }

  static void putToString(const Int64& inVal, std::string& outStr) {
...
struct OSG_BASE_DLLMAPPING FieldDataTraits<UInt64>
  ...
  static bool getFromString(UInt64& outVal, const Char8*& inVal) {
    outVal = TypeTraits<UInt64>::getFromString(inVal);

    return false;
  }

  static void putToString(const UInt64& inVal, std::string& outStr) {
...
struct OSG_BASE_DLLMAPPING FieldDataTraits<Real16>
  ...
  static Real16 getDefault(void) {
    return 0.f;
  }

  static bool getFromString(Real16& outVal, const Char8*& inVal) {
    outVal = TypeTraits<Real16>::getFromString(inVal);

    return true;
  }

  static void putToString(const Real16& inVal, std::string& outStr) {
...
struct OSG_BASE_DLLMAPPING FieldDataTraits<Real64>
  ...
  static Real64 getDefault(void) {
    return 0.;
  }

  static bool getFromString(Real64& outVal, const Char8*& inVal) {
    outVal = TypeTraits<Real64>::getFromString(inVal);

    return true;
  }

  static void putToString(const Real64& inVal, std::string& outStr) {
...
template <>
struct OSG_BASE_DLLMAPPING FieldDataTraits<void*> : public FieldTraitsRecurseBase<void*> {
  static DataType                _type;
  ...
  static bool getFromString(FieldTypeT& voidP, const Char8* inStr) {
    if (inStr[0] == '0' && tolower(inStr[1]) == 'x') {
      ...
      if (sscanf(inStr, "%lu", reinterpret_cast<unsigned long*>(&voidP)) != 1) {
        voidP = NULL;
        FWARNING(("FieldDataTraits<void *>::getFromString: '%s' "
                  "not understood!\n",
            inStr));
