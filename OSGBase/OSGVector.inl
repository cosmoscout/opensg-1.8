...
template <class ValueTypeT>
inline VecStorage2<ValueTypeT>::VecStorage2(void) {
...
template <class ValueTypeT>
inline void VecStorage2<ValueTypeT>::setValues(const ValueTypeT rVal1, const ValueTypeT rVal2) {
  _values[0] = rVal1;
  _values[1] = rVal2;
}

template <class ValueTypeT>
inline void VecStorage2<ValueTypeT>::getSeparateValues(ValueTypeT& rVal1, ValueTypeT& rVal2) const {
  rVal1 = _values[0];
  rVal2 = _values[1];
}

template <class ValueTypeT>
inline ValueTypeT VecStorage2<ValueTypeT>::x(void) const {
  return _values[0];
}

template <class ValueTypeT>
inline ValueTypeT VecStorage2<ValueTypeT>::y(void) const {
  return _values[1];
}
...
template <class ValueTypeT>
inline VecStorage3<ValueTypeT>::VecStorage3(void) {
  for (UInt32 i = 0; i < _iSize; i++) {
    _values[i] = TypeTraits<ValueTypeT>::getZeroElement();
  }
}
...
template <class ValueTypeT>
inline void VecStorage3<ValueTypeT>::setValues(
    const ValueTypeT rVal1, const ValueTypeT rVal2, const ValueTypeT rVal3) {
  _values[0] = rVal1;
  _values[1] = rVal2;
  _values[2] = rVal3;
}
...
template <class ValueTypeT>
inline void VecStorage3<ValueTypeT>::getSeparateValues(
    ValueTypeT& rVal1, ValueTypeT& rVal2, ValueTypeT& rVal3) const {
  rVal1 = _values[0];
  rVal2 = _values[1];
  rVal3 = _values[2];
}
...
template <class ValueTypeT>
inline ValueTypeT VecStorage3<ValueTypeT>::x(void) const {
  return _values[0];
}

template <class ValueTypeT>
inline ValueTypeT VecStorage3<ValueTypeT>::y(void) const {
  return _values[1];
}

template <class ValueTypeT>
inline ValueTypeT VecStorage3<ValueTypeT>::z(void) const {
  return _values[2];
}
...
#if defined(__hpux)
template <class ValueTypeT>
inline const UInt32 VecStorage4<ValueTypeT>::_iSize;
#endif

template <class ValueTypeT>
inline VecStorage4<ValueTypeT>::VecStorage4(void) {
  for (UInt32 i = 0; i < _iSize; i++) {
    _values[i] = TypeTraits<ValueTypeT>::getZeroElement();
  }
}
...
template <class ValueTypeT>
inline void VecStorage4<ValueTypeT>::setValues(const ValueTypeT rVal1, const ValueTypeT rVal2,
...
template <class ValueTypeT>
inline void VecStorage4<ValueTypeT>::getSeparateValues(
    ValueTypeT& rVal1, ValueTypeT& rVal2, ValueTypeT& rVal3, ValueTypeT& rVal4) const {
  rVal1 = _values[0];
  rVal2 = _values[1];
  rVal3 = _values[2];
  rVal4 = _values[3];
...
template <class ValueTypeT>
inline ValueTypeT VecStorage4<ValueTypeT>::x(void) const {
  return _values[0];
}

template <class ValueTypeT>
inline ValueTypeT VecStorage4<ValueTypeT>::y(void) const {
  return _values[1];
}

template <class ValueTypeT>
inline ValueTypeT VecStorage4<ValueTypeT>::z(void) const {
  return _values[2];
}

template <class ValueTypeT>
inline ValueTypeT VecStorage4<ValueTypeT>::w(void) const {
  return _values[3];
}
...
template <class ValueTypeT, class StorageInterfaceT>
inline PointInterface<ValueTypeT, StorageInterfaceT>::PointInterface(void)
    : Inherited() {
}

template <class ValueTypeT, class StorageInterfaceT>
template <class ValueType2T, class StorageInterface2T>
inline PointInterface<ValueTypeT, StorageInterfaceT>::PointInterface(
...
template <class ValueTypeT, class StorageInterfaceT>
inline PointInterface<ValueTypeT, StorageInterfaceT>::PointInterface(const ValueTypeT* pVals)
    : Inherited() {
  if (pVals == NULL) {
    for (UInt32 i = 0; i < Self::_iSize; i++) {
      Self::_values[i] = TypeTraits<ValueTypeT>::getZeroElement();
...
template <class ValueTypeT, class StorageInterfaceT>
inline PointInterface<ValueTypeT, StorageInterfaceT>::PointInterface(ValueTypeT* pVals)
    : Inherited() {
  if (pVals == NULL) {
    for (UInt32 i = 0; i < Self::_iSize; i++) {
      Self::_values[i] = TypeTraits<ValueTypeT>::getZeroElement();
...
template <class ValueTypeT, class StorageInterfaceT>
inline PointInterface<ValueTypeT, StorageInterfaceT>::PointInterface(const PointInterface& source)
    :
...
template <class ValueTypeT, class StorageInterfaceT>
inline PointInterface<ValueTypeT, StorageInterfaceT>::PointInterface(const ValueTypeT rVal1) {
  UInt32 i;
...
template <class ValueTypeT, class StorageInterfaceT>
inline PointInterface<ValueTypeT, StorageInterfaceT>::PointInterface(
    const ValueTypeT rVal1, const ValueTypeT rVal2)
    : Inherited() {
  Self::_values[0] = rVal1;
...
template <class ValueTypeT, class StorageInterfaceT>
inline PointInterface<ValueTypeT, StorageInterfaceT>::PointInterface(
    const ValueTypeT rVal1, const ValueTypeT rVal2, const ValueTypeT rVal3, const ValueTypeT rVal4)
    : Inherited() {
  Self::_values[0] = rVal1;
...
template <class ValueTypeT, class StorageInterfaceT>
inline void PointInterface<ValueTypeT, StorageInterfaceT>::setNull(void) {
  for (UInt32 i = 0; i < Self::_iSize; i++) {
    Self::_values[i] = TypeTraits<ValueTypeT>::getZeroElement();
  }
}
...
template <class ValueTypeT, class StorageInterfaceT>
inline void PointInterface<ValueTypeT, StorageInterfaceT>::setValue(const PointInterface& vec) {
  for (UInt32 i = 0; i < Self::_iSize; i++) {
...
template <class ValueTypeT, class StorageInterfaceT>
template <class ValueType2T, class StorageInterface2T>
inline void PointInterface<ValueTypeT, StorageInterfaceT>::setValue(
    const PointInterface<ValueType2T, StorageInterface2T>& vec) {
  typedef PointInterface<ValueType2T, StorageInterface2T> VectorT;
...
template <class ValueTypeT, class StorageInterfaceT>
inline void PointInterface<ValueTypeT, StorageInterfaceT>::setValue(const ValueTypeT* pVals) {
  for (UInt32 i = 0; i < Self::_iSize; i++) {
    Self::_values[i] = pVals[i];
  }
}
...
template <class ValueTypeT, class StorageInterfaceT>
inline void PointInterface<ValueTypeT, StorageInterfaceT>::setValue(ValueTypeT* pVals) {
...
template <class ValueTypeT, class StorageInterfaceT>
inline void PointInterface<ValueTypeT, StorageInterfaceT>::setValueFromCString(
  ...
  for (i = 0; i < numOfToken; c++) {
    ...
    case '\0':
      if (tokenC) {
        *tokenC            = 0;
        Self::_values[i++] = TypeTraits<ValueTypeT>::getFromString(token);
      }
...
template <class ValueTypeT, class StorageInterfaceT>
inline void PointInterface<ValueTypeT, StorageInterfaceT>::setValueFromCString(Char8* szString) {
  setValueFromCString(static_cast<const Char8*>(szString));
}

#ifndef OSG_DISABLE_DEPRECATED
template <class ValueTypeT, class StorageInterfaceT>
inline void PointInterface<ValueTypeT, StorageInterfaceT>::setValue(const Char8* szString) {
  setValueFromCString(szString);
}

template <class ValueTypeT, class StorageInterfaceT>
inline void PointInterface<ValueTypeT, StorageInterfaceT>::setValue(Char8* szString) {
  setValueFromCString(szString);
}
#endif
...
template <class ValueTypeT, class StorageInterfaceT>
inline ValueTypeT* PointInterface<ValueTypeT, StorageInterfaceT>::getValues(void) {
  return Self::_values;
}
...
template <class ValueTypeT, class StorageInterfaceT>
inline const ValueTypeT* PointInterface<ValueTypeT, StorageInterfaceT>::getValues(void) const {
  return Self::_values;
}
...
template <class ValueTypeT, class StorageInterfaceT>
inline bool PointInterface<ValueTypeT, StorageInterfaceT>::isZero(void) const {
  bool returnValue = true;

  for (UInt32 i = 0; i < Self::_iSize; i++) {
    returnValue &= ((Self::_values[i] <= Eps) && (Self::_values[i] >= -Eps));
  }
...
template <class ValueTypeT, class StorageInterfaceT>
inline void PointInterface<ValueTypeT, StorageInterfaceT>::negate(void) {
  for (UInt32 i = 0; i < Self::_iSize; i++) {
...
template <class ValueTypeT, class StorageInterfaceT>
inline bool PointInterface<ValueTypeT, StorageInterfaceT>::equals(
    const PointInterface& vec, const ValueTypeT tolerance) const {
  bool returnValue = true;

  for (UInt32 i = 0; i < Self::_iSize; i++) {
    returnValue &= ((Self::_values[i] - vec._values[i] <= tolerance) &&
...
template <class ValueTypeT, class StorageInterfaceT>
inline typename PointInterface<ValueTypeT, StorageInterfaceT>::VecInterface&
PointInterface<ValueTypeT, StorageInterfaceT>::subZero(void) {
...
template <class ValueTypeT, class StorageInterfaceT>
inline const typename PointInterface<ValueTypeT, StorageInterfaceT>::VecInterface&
PointInterface<ValueTypeT, StorageInterfaceT>::subZero(void) const {
...
template <class ValueTypeT, class StorageInterfaceT>
inline typename PointInterface<ValueTypeT, StorageInterfaceT>::RealReturnType
PointInterface<ValueTypeT, StorageInterfaceT>::dist(const PointInterface& vec) const {
...
template <class ValueTypeT, class StorageInterfaceT>
inline typename PointInterface<ValueTypeT, StorageInterfaceT>::RealReturnType
PointInterface<ValueTypeT, StorageInterfaceT>::dist2(const PointInterface& vec) const {
...
template <class ValueTypeT, class StorageInterfaceT>
inline typename PointInterface<ValueTypeT, StorageInterfaceT>::RealReturnType
PointInterface<ValueTypeT, StorageInterfaceT>::maxValue(void) const {
...
template <class ValueTypeT, class StorageInterfaceT>
inline void PointInterface<ValueTypeT, StorageInterfaceT>::operator*=(const ValueTypeT val) {
  for (UInt32 i = 0; i < Self::_iSize; i++) {
    Self::_values[i] *= val;
  }
}
...
template <class ValueTypeT, class StorageInterfaceT>
inline typename PointInterface<ValueTypeT, StorageInterfaceT>::VecInterface
PointInterface<ValueTypeT, StorageInterfaceT>::operator-(const PointInterface& vec) const {
...
template <class ValueTypeT, class StorageInterfaceT>
inline PointInterface<ValueTypeT, StorageInterfaceT>
PointInterface<ValueTypeT, StorageInterfaceT>::operator+(const VecInterface& vec) const {
...
template <class ValueTypeT, class StorageInterfaceT>
inline PointInterface<ValueTypeT, StorageInterfaceT>
PointInterface<ValueTypeT, StorageInterfaceT>::operator*(const ValueTypeT rVal) const {
  PointInterface<ValueTypeT, StorageInterfaceT> returnValue;
...
template <class ValueTypeT, class StorageInterfaceT>
inline void PointInterface<ValueTypeT, StorageInterfaceT>::operator+=(const VecInterface& vec) {
  for (UInt32 i = 0; i < Self::_iSize; i++) {
    Self::_values[i] += vec._values[i];
  }
}
...
template <class ValueTypeT, class StorageInterfaceT>
inline ValueTypeT& PointInterface<ValueTypeT, StorageInterfaceT>::operator[](const UInt32 uiVal) {
  return Self::_values[uiVal];
}

template <class ValueTypeT, class StorageInterfaceT>
inline const ValueTypeT& PointInterface<ValueTypeT, StorageInterfaceT>::operator[](
...
template <class ValueTypeT, class StorageInterfaceT>
inline PointInterface<ValueTypeT, StorageInterfaceT>&
PointInterface<ValueTypeT, StorageInterfaceT>::operator=(const PointInterface& source) {
  if (this == &source)
    return *this;
...
template <class ValueTypeT, class StorageInterfaceT>
inline PointInterface<ValueTypeT, StorageInterfaceT>&
PointInterface<ValueTypeT, StorageInterfaceT>::operator=(const VecInterface& source) {
  static PointInterface<ValueTypeT, StorageInterfaceT> dummy;
  PointInterface<ValueTypeT, StorageInterfaceT>::error_cannot_assign_vector;
  return dummy;
}
...
template <class ValueTypeT, class StorageInterfaceT>
inline bool PointInterface<ValueTypeT, StorageInterfaceT>::operator<(
...
template <class ValueTypeT, class StorageInterfaceT>
inline PointInterface<ValueTypeT, StorageInterfaceT> operator*(
    const ValueTypeT val, const PointInterface<ValueTypeT, StorageInterfaceT>& vec) {
  PointInterface<ValueTypeT, StorageInterfaceT> returnValue;
...
inline std::ostream& operator<<(
    std::ostream& os, const PointInterface<ValueTypeT, StorageInterfaceT>& obj) {
  for (UInt32 i = 0; i < StorageInterfaceT::_iSize; i++) {
    os << obj[i];
...
template <class ValueTypeT, class StorageInterfaceT>
inline VectorInterface<ValueTypeT, StorageInterfaceT>::VectorInterface(void)
    : Inherited() {
  for (UInt32 i = 0; i < Self::_iSize; i++) {
    Self::_values[i] = TypeTraits<ValueTypeT>::getZeroElement();
  }
...
template <class ValueTypeT, class StorageInterfaceT>
inline VectorInterface<ValueTypeT, StorageInterfaceT>::VectorInterface(const ValueTypeT* pVals)
    : Inherited(pVals) {
}
...
template <class ValueTypeT, class StorageInterfaceT>
inline VectorInterface<ValueTypeT, StorageInterfaceT>::VectorInterface(ValueTypeT* pVals)
    : Inherited(pVals) {
}

template <class ValueTypeT, class StorageInterfaceT>
template <class ValueType2T, class StorageInterface2T>
inline VectorInterface<ValueTypeT, StorageInterfaceT>::VectorInterface(
    const PointInterface<ValueType2T, StorageInterface2T>& vec)
    : Inherited(vec) {
}
...
template <class ValueTypeT, class StorageInterfaceT>
inline VectorInterface<ValueTypeT, StorageInterfaceT>::VectorInterface(const ValueTypeT rVal1) {
  UInt32 i;
...
template <class ValueTypeT, class StorageInterfaceT>
inline typename VectorInterface<ValueTypeT, StorageInterfaceT>::RealReturnType
...
VectorInterface<ValueTypeT, StorageInterfaceT>::squareLength(void) const {
  RealReturnType rTmpVal = RealReturnType(Self::_values[0] * Self::_values[0]);
...
template <class ValueTypeT, class StorageInterfaceT>
inline void VectorInterface<ValueTypeT, StorageInterfaceT>::normalize(void) {
...
template <class ValueTypeT, class StorageInterfaceT>
inline VectorInterface<ValueTypeT, StorageInterfaceT>
VectorInterface<ValueTypeT, StorageInterfaceT>::cross(const VectorInterface& vec) const {
  VectorInterface<ValueTypeT, StorageInterfaceT> returnValue;

  if (Self::_iSize >= 3) {
    returnValue[0] = Self::_values[1] * vec._values[2] - Self::_values[2] * vec._values[1];
    returnValue[1] = Self::_values[2] * vec._values[0] - Self::_values[0] * vec._values[2];
    returnValue[2] = Self::_values[0] * vec._values[1] - Self::_values[1] * vec._values[0];
  } else {
    // Must be changed
...
template <class ValueTypeT, class StorageInterfaceT>
inline VectorInterface<ValueTypeT, StorageInterfaceT>
VectorInterface<ValueTypeT, StorageInterfaceT>::operator%(const VectorInterface& vec) const {
...
template <class ValueTypeT, class StorageInterfaceT>
inline void VectorInterface<ValueTypeT, StorageInterfaceT>::crossThis(const VectorInterface& vec) {
  if (Self::_iSize >= 3) {
    ValueTypeT rTmp[2];

    rTmp[0] = Self::_values[1] * vec._values[2] - Self::_values[2] * vec._values[1];
    rTmp[1] = Self::_values[2] * vec._values[0] - Self::_values[0] * vec._values[2];

    Self::_values[2] = Self::_values[0] * vec._values[1] - Self::_values[1] * vec._values[0];
...
template <class ValueTypeT, class StorageInterfaceT>
inline ValueTypeT VectorInterface<ValueTypeT, StorageInterfaceT>::dot(
...
template <class ValueTypeT, class StorageInterfaceT>
inline ValueTypeT VectorInterface<ValueTypeT, StorageInterfaceT>::operator*(
    const VectorInterface& vec) const {
  return this->dot(vec);
}
...
template <class ValueTypeT, class StorageInterfaceT>
inline typename VectorInterface<ValueTypeT, StorageInterfaceT>::RealReturnType
VectorInterface<ValueTypeT, StorageInterfaceT>::enclosedAngle(const VectorInterface& vec) const {
...
template <class ValueTypeT, class StorageInterfaceT>
inline typename VectorInterface<ValueTypeT, StorageInterfaceT>::RealReturnType
VectorInterface<ValueTypeT, StorageInterfaceT>::projectTo(const VectorInterface& toVec) {
...
template <class ValueTypeT, class StorageInterfaceT>
inline const typename VectorInterface<ValueTypeT, StorageInterfaceT>::PntInterface&
VectorInterface<ValueTypeT, StorageInterfaceT>::addToZero(void) const {
...
template <class ValueTypeT, class StorageInterfaceT>
inline typename VectorInterface<ValueTypeT, StorageInterfaceT>::PntInterface&
VectorInterface<ValueTypeT, StorageInterfaceT>::addToZero(void) {
...
template <class ValueTypeT, class StorageInterfaceT>
inline const VectorInterface<ValueTypeT, StorageInterfaceT>&
...
template <class ValueTypeT, class StorageInterfaceT>
inline VectorInterface<ValueTypeT, StorageInterfaceT>
VectorInterface<ValueTypeT, StorageInterfaceT>::operator*(const ValueTypeT rVal) const {
  VectorInterface<ValueTypeT, StorageInterfaceT> returnValue;
...
template <class ValueTypeT, class StorageInterfaceT>
inline VectorInterface<ValueTypeT, StorageInterfaceT>&
VectorInterface<ValueTypeT, StorageInterfaceT>::operator=(const VectorInterface& source) {
  if (this == &source)
    return *this;

  *(static_cast<Inherited*>(this)) = static_cast<const Inherited&>(source);
...
template <class ValueTypeT, class StorageInterfaceT>
inline bool VectorInterface<ValueTypeT, StorageInterfaceT>::operator<(
...
template <class ValueTypeT, class StorageInterfaceT>
inline VectorInterface<ValueTypeT, StorageInterfaceT> operator*(
    const ValueTypeT val, const VectorInterface<ValueTypeT, StorageInterfaceT>& vec) {
  VectorInterface<ValueTypeT, StorageInterfaceT> returnValue;
...
template <class ValueTypeT, class StorageInterfaceT>
inline std::ostream& operator<<(
    std::ostream& os, const VectorInterface<ValueTypeT, StorageInterfaceT>& obj) {
  for (UInt32 i = 0; i < StorageInterfaceT::_iSize; i++) {
    os << obj[i];
