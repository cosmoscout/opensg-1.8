...
struct FieldTraitsRecurseVecStoreBase : public FieldTraits {
  ...
  typedef typename osgIF<uiTest == 1, const ValueTypeT, const ValueTypeT&>::_IRet ArgumentType;
#else
  typedef typename osgIF<!TypeTraits<ValueTypeT>::IsPOD, const ValueTypeT, const ValueTypeT&>::_IRet
      ArgumentType;
#endif
  ...
  static void copyToBin(
      BinaryDataHandler& pMem, const ValueTypeT* pObjectStore, UInt32 uiNumObjects) {
...
template <class ValueTypeT>
struct FieldTraitsRecurseVecStore2Base : public FieldTraitsRecurseVecStoreBase<ValueTypeT> {
  enum { bHasParent = 0x00 };
};
...
template <class ValueTypeT>
struct FieldTraitsRecurseVecStore3Base : public FieldTraitsRecurseVecStoreBase<ValueTypeT> {
  enum { bHasParent = 0x00 };
};
...
template <class ValueTypeT>
struct FieldTraitsRecurseVecStore4Base : public FieldTraitsRecurseVecStoreBase<ValueTypeT> {
  enum { bHasParent = 0x00 };
};
...
struct OSG_BASE_DLLMAPPING FieldDataTraits<Vec2ub>
  ...
  enum { StringConvertable = Self::ToStringConvertable | Self::FromStringConvertable };
  ...
  static Vec2ub getDefault(void) {
    return Vec2ub();
  }

  static bool getFromString(Vec2ub& outVal, const Char8*& inVal) {
    outVal.setValueFromCString(inVal);

    return true;
  }

  static void putToString(const Vec2ub& inVal, std::string& outStr) {
...
struct OSG_BASE_DLLMAPPING FieldDataTraits<Vec3ub>
  ...
  static Vec3ub getDefault(void) {
    return Vec3ub();
  }

  static bool getFromString(Vec3ub& outVal, const Char8*& inVal) {
    outVal.setValueFromCString(inVal);

    return true;
  }

  static void putToString(const Vec3ub& inVal, std::string& outStr) {
...
template <>
struct OSG_BASE_DLLMAPPING FieldDataTraits<Vec2b> : public FieldTraitsRecurseVecStore2Base<Vec2b> {
  static DataType                _type;
  ...
  static Vec2b getDefault(void) {
    return Vec2b();
  }

  static bool getFromString(Vec2b& outVal, const Char8*& inVal) {
    outVal.setValueFromCString(inVal);

    return true;
  }

  static void putToString(const Vec2b& inVal, std::string& outStr) {
...
template <>
struct OSG_BASE_DLLMAPPING FieldDataTraits<Vec3b> : public FieldTraitsRecurseVecStore2Base<Vec3b> {
  static DataType                _type;
...
template <>
struct OSG_BASE_DLLMAPPING FieldDataTraits<Vec4b> : public FieldTraitsRecurseVecStore2Base<Vec4b> {
  static DataType                _type;
  ...
  static Vec4b getDefault(void) {
    return Vec4b();
  }

  static bool getFromString(Vec4b& outVal, const Char8*& inVal) {
    outVal.setValueFromCString(inVal);

    return true;
  }

  static void putToString(const Vec4b& inVal, std::string& outStr) {
...
struct OSG_BASE_DLLMAPPING FieldDataTraits<Vec2us>
  ...
  static Vec2us getDefault(void) {
    return Vec2us();
  }

  static bool getFromString(Vec2us& outVal, const Char8*& inVal) {
    outVal.setValueFromCString(inVal);

    return true;
  }

  static void putToString(const Vec2us& inVal, std::string& outStr) {
...
struct OSG_BASE_DLLMAPPING FieldDataTraits<Vec3us>
  ...
  static Vec3us getDefault(void) {
    return Vec3us();
  }

  static bool getFromString(Vec3us& outVal, const Char8*& inVal) {
    outVal.setValueFromCString(inVal);

    return true;
  }

  static void putToString(const Vec3us& inVal, std::string& outStr) {
...
template <>
struct OSG_BASE_DLLMAPPING FieldDataTraits<Vec2s> : public FieldTraitsRecurseVecStore2Base<Vec2s> {
  static DataType                _type;
...
template <>
struct OSG_BASE_DLLMAPPING FieldDataTraits<Vec3s> : public FieldTraitsRecurseVecStore2Base<Vec3s> {
  static DataType                _type;
  ...
  static Vec3s getDefault(void) {
    return Vec3s();
  }

  static bool getFromString(Vec3s& outVal, const Char8*& inVal) {
    outVal.setValueFromCString(inVal);

    return true;
  }

  static void putToString(const Vec3s& inVal, std::string& outStr) {
...
template <>
struct OSG_BASE_DLLMAPPING FieldDataTraits<Vec4s> : public FieldTraitsRecurseVecStore2Base<Vec4s> {
  static DataType                _type;
  ...
  static Vec4s getDefault(void) {
    return Vec4s();
  }

  static bool getFromString(Vec4s& outVal, const Char8*& inVal) {
    outVal.setValueFromCString(inVal);

    return true;
  }

  static void putToString(const Vec4s& inVal, std::string& outStr) {
...
template <>
struct OSG_BASE_DLLMAPPING FieldDataTraits<Vec2f> : public FieldTraitsRecurseVecStore2Base<Vec2f> {
  static DataType                _type;
...
template <>
struct OSG_BASE_DLLMAPPING FieldDataTraits<Vec3f> : public FieldTraitsRecurseVecStore2Base<Vec3f> {
  static DataType                _type;
...
template <>
struct OSG_BASE_DLLMAPPING FieldDataTraits<Vec4f> : public FieldTraitsRecurseVecStore2Base<Vec4f> {
  static DataType                _type;
  ...
  static Vec4f getDefault(void) {
    return Vec4f();
  }

  static bool getFromString(Vec4f& outVal, const Char8*& inVal) {
    outVal.setValueFromCString(inVal);

    return true;
  }

  static void putToString(const Vec4f& inVal, std::string& outStr) {
...
template <>
struct OSG_BASE_DLLMAPPING FieldDataTraits<Vec2d> : public FieldTraitsRecurseVecStore2Base<Vec2d> {
  static DataType                _type;
...
template <>
struct OSG_BASE_DLLMAPPING FieldDataTraits<Vec3d> : public FieldTraitsRecurseVecStore2Base<Vec3d> {
  static DataType                _type;
  ...
  static Vec3d getDefault(void) {
    return Vec3d();
  }

  static bool getFromString(Vec3d& outVal, const Char8*& inVal) {
    outVal.setValueFromCString(inVal);

    return true;
  }

  static void putToString(const Vec3d& inVal, std::string& outStr) {
...
template <>
struct OSG_BASE_DLLMAPPING FieldDataTraits<Vec4d> : public FieldTraitsRecurseVecStore2Base<Vec4d> {
  static DataType                _type;
...
struct OSG_BASE_DLLMAPPING FieldDataTraits<Vec2ld>
  ...
  static Vec2ld getDefault(void) {
    return Vec2ld();
  }

  static bool getFromString(Vec2ld& outVal, const Char8*& inVal) {
    outVal.setValueFromCString(inVal);

    return true;
  }

  static void putToString(const Vec2ld& inVal, std::string& outStr) {
...
struct OSG_BASE_DLLMAPPING FieldDataTraits<Pnt3ub>
  ...
  static Pnt3ub getDefault(void) {
    return Pnt3ub();
  }

  static bool getFromString(Pnt3ub& outVal, const Char8*& inVal) {
    outVal.setValueFromCString(inVal);

    return true;
  }

  static void putToString(const Pnt3ub& inVal, std::string& outStr) {
...
struct OSG_BASE_DLLMAPPING FieldDataTraits<Pnt4ub>
  ...
  static Pnt4ub getDefault(void) {
    return Pnt4ub();
  }

  static bool getFromString(Pnt4ub& outVal, const Char8*& inVal) {
    outVal.setValueFromCString(inVal);

    return true;
  }

  static void putToString(const Pnt4ub& inVal, std::string& outStr) {
...
template <>
struct OSG_BASE_DLLMAPPING FieldDataTraits<Pnt2b> : public FieldTraitsRecurseVecStore2Base<Pnt2b> {
  static DataType                _type;
...
template <>
struct OSG_BASE_DLLMAPPING FieldDataTraits<Pnt3b> : public FieldTraitsRecurseVecStore2Base<Pnt3b> {
  static DataType                _type;
  ...
  static Pnt3b getDefault(void) {
    return Pnt3b();
  }

  static bool getFromString(Pnt3b& outVal, const Char8*& inVal) {
    outVal.setValueFromCString(inVal);

    return true;
  }

  static void putToString(const Pnt3b& inVal, std::string& outStr) {
...
template <>
struct OSG_BASE_DLLMAPPING FieldDataTraits<Pnt4b> : public FieldTraitsRecurseVecStore2Base<Pnt4b> {
  static DataType                _type;
...
struct OSG_BASE_DLLMAPPING FieldDataTraits<Pnt3us>
  ...
  static Pnt3us getDefault(void) {
    return Pnt3us();
  }

  static bool getFromString(Pnt3us& outVal, const Char8*& inVal) {
    outVal.setValueFromCString(inVal);

    return true;
  }

  static void putToString(const Pnt3us& inVal, std::string& outStr) {
...
template <>
struct OSG_BASE_DLLMAPPING FieldDataTraits<Pnt2s> : public FieldTraitsRecurseVecStore2Base<Pnt2s> {
  static DataType                _type;
  ...
  static Pnt2s getDefault(void) {
    return Pnt2s();
  }

  static bool getFromString(Pnt2s& outVal, const Char8*& inVal) {
    outVal.setValueFromCString(inVal);

    return true;
  }

  static void putToString(const Pnt2s& inVal, std::string& outStr) {
...
template <>
struct OSG_BASE_DLLMAPPING FieldDataTraits<Pnt3s> : public FieldTraitsRecurseVecStore2Base<Pnt3s> {
  static DataType                _type;
...
template <>
struct OSG_BASE_DLLMAPPING FieldDataTraits<Pnt4s> : public FieldTraitsRecurseVecStore2Base<Pnt4s> {
  static DataType                _type;
...
template <>
struct OSG_BASE_DLLMAPPING FieldDataTraits<Pnt2f> : public FieldTraitsRecurseVecStore2Base<Pnt2f> {
  static DataType                _type;
  ...
  static Pnt2f getDefault(void) {
    return Pnt2f();
  }

  static bool getFromString(Pnt2f& outVal, const Char8*& inVal) {
    outVal.setValueFromCString(inVal);

    return true;
  }

  static void putToString(const Pnt2f& inVal, std::string& outStr) {
...
template <>
struct OSG_BASE_DLLMAPPING FieldDataTraits<Pnt3f> : public FieldTraitsRecurseVecStore2Base<Pnt3f> {
  static DataType                _type;
...
template <>
struct OSG_BASE_DLLMAPPING FieldDataTraits<Pnt4f> : public FieldTraitsRecurseVecStore2Base<Pnt4f> {
  static DataType                _type;
  ...
  static Pnt4f getDefault(void) {
    return Pnt4f();
  }

  static bool getFromString(Pnt4f& outVal, const Char8*& inVal) {
    outVal.setValueFromCString(inVal);

    return true;
  }

  static void putToString(const Pnt4f& inVal, std::string& outStr) {
...
template <>
struct OSG_BASE_DLLMAPPING FieldDataTraits<Pnt2d> : public FieldTraitsRecurseVecStore2Base<Pnt2d> {
  static DataType                _type;
...
template <>
struct OSG_BASE_DLLMAPPING FieldDataTraits<Pnt3d> : public FieldTraitsRecurseVecStore2Base<Pnt3d> {
  static DataType                _type;
  ...
  static Pnt3d getDefault(void) {
    return Pnt3d();
  }

  static bool getFromString(Pnt3d& outVal, const Char8*& inVal) {
    outVal.setValueFromCString(inVal);

    return true;
  }

  static void putToString(const Pnt3d& inVal, std::string& outStr) {
...
template <>
struct OSG_BASE_DLLMAPPING FieldDataTraits<Pnt4d> : public FieldTraitsRecurseVecStore2Base<Pnt4d> {
  static DataType                _type;
  ...
  static Pnt4d getDefault(void) {
    return Pnt4d();
  }

  static bool getFromString(Pnt4d& outVal, const Char8*& inVal) {
    outVal.setValueFromCString(inVal);

    return true;
  }

  static void putToString(const Pnt4d& inVal, std::string& outStr) {
