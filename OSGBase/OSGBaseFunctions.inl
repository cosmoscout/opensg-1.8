...
inline Real32 osgsqrt(const Real32 rValue) {
...
inline Real64 osgsqrt(const Real64 rValue) {
#ifdef OSG_USE_STDMATH
  return std::sqrt(rValue);
#else
  return sqrt(rValue);
...
inline Real128 osgsqrt(const Real128 rValue) {
#ifdef OSG_USE_STDMATH
  return std::sqrt(rValue);
#else
  return sqrtl(rValue);
...
inline Real32 osgcos(const Real32 rValue) {
#ifdef OSG_USE_STDMATH
...
inline Real64 osgcos(const Real64 rValue) {
#ifdef OSG_USE_STDMATH
  return std::cos(rValue);
#else
  return cos(rValue);
...
inline Real128 osgcos(const Real128 rValue) {
#ifdef OSG_USE_STDMATH
  return std::cos(rValue);
#else
  return cosl(rValue);
...
inline Real32 osgsin(const Real32 rValue) {
#ifdef OSG_USE_STDMATH
...
inline Real64 osgsin(const Real64 rValue) {
#ifdef OSG_USE_STDMATH
  return std::sin(rValue);
#else
  return sin(rValue);
...
inline Real128 osgsin(const Real128 rValue) {
#ifdef OSG_USE_STDMATH
  return std::sin(rValue);
#else
  return sinl(rValue);
...
inline Real32 osgtan(const Real32 rValue) {
#ifdef OSG_USE_STDMATH
...
inline Real64 osgtan(const Real64 rValue) {
#ifdef OSG_USE_STDMATH
  return std::tan(rValue);
#else
  return tan(rValue);
...
inline Real128 osgtan(const Real128 rValue) {
#ifdef OSG_USE_STDMATH
  return std::tan(rValue);
#else
  return tanl(rValue);
...
inline Real32 osgacos(const Real32 rValue) {
#ifdef OSG_USE_STDMATH
...
inline Real64 osgacos(const Real64 rValue) {
#ifdef OSG_USE_STDMATH
  return std::acos(rValue);
#else
  return acos(rValue);
...
inline Real128 osgacos(const Real128 rValue) {
#ifdef OSG_USE_STDMATH
  return std::acos(rValue);
#else
  return acosl(rValue);
...
inline Real32 osgasin(const Real32 rValue) {
#ifdef OSG_USE_STDMATH
...
inline Real64 osgasin(const Real64 rValue) {
#ifdef OSG_USE_STDMATH
  return std::asin(rValue);
#else
  return asin(rValue);
...
inline Real128 osgasin(const Real128 rValue) {
#ifdef OSG_USE_STDMATH
  return std::asin(rValue);
#else
  return asinl(rValue);
...
inline Real32 osgatan(const Real32 rValue) {
#ifdef OSG_USE_STDMATH
...
inline Real64 osgatan(const Real64 rValue) {
#ifdef OSG_USE_STDMATH
  return std::atan(rValue);
#else
  return atan(rValue);
...
inline Real128 osgatan(const Real128 rValue) {
#ifdef OSG_USE_STDMATH
  return std::atan(rValue);
#else
  return atanl(rValue);
...
inline Real32 osgatan2(const Real32 rValue1, const Real32 rValue2) {
#ifdef OSG_USE_STDMATH
...
inline Real64 osgatan2(const Real64 rValue1, const Real64 rValue2) {
#ifdef OSG_USE_STDMATH
  return std::atan2(rValue1, rValue2);
#else
...
inline Real128 osgatan2(const Real128 rValue1, const Real128 rValue2) {
#ifdef OSG_USE_STDMATH
  return std::atan2(rValue1, rValue2);
#else
...
inline TypeT osgabs(const TypeT rValue) {
...
inline Real32 osgabs(const Real32 rValue) {
#ifdef OSG_USE_STDMATH
...
inline Real64 osgabs(const Real64 rValue) {
#ifdef OSG_USE_STDMATH
  return std::abs(rValue);
#else
  return fabs(rValue);
...
inline Real128 osgabs(const Real128 rValue) {
#ifdef OSG_USE_STDMATH
  return std::abs(rValue);
#else
  return fabsl(rValue);
...
inline Real32 osgpow(const Real32 rValue, const Real32 rExp) {
#ifdef OSG_USE_STDMATH
...
inline Real64 osgpow(const Real64 rValue, const Real64 rExp) {
#ifdef OSG_USE_STDMATH
  return std::pow(rValue, rExp);
#else
...
inline Real128 osgpow(const Real128 rValue, const Real128 rExp) {
#ifdef OSG_USE_STDMATH
  return std::pow(rValue, rExp);
#else
...
inline Real32 osglog(const Real32 rValue) {
#ifdef OSG_USE_STDMATH
...
inline Real64 osglog(const Real64 rValue) {
#ifdef OSG_USE_STDMATH
  return std::log(rValue);
#else
  return log(rValue);
...
inline Real128 osglog(const Real128 rValue) {
#ifdef OSG_USE_STDMATH
  return std::log(rValue);
#else
  return logl(rValue);
...
inline Real32 osgexp(const Real32 rValue) {
#ifdef OSG_USE_STDMATH
...
inline Real64 osgexp(const Real64 rValue) {
#ifdef OSG_USE_STDMATH
  return std::exp(rValue);
#else
  return exp(rValue);
...
inline Real128 osgexp(const Real128 rValue) {
#ifdef OSG_USE_STDMATH
  return std::exp(rValue);
#else
  return expl(rValue);
...
inline Real32 osgfloor(const Real32 rValue) {
#ifdef OSG_USE_STDMATH
...
inline Real64 osgfloor(const Real64 rValue) {
#ifdef OSG_USE_STDMATH
  return std::floor(rValue);
#else
  return floor(rValue);
...
inline Real128 osgfloor(const Real128 rValue) {
#ifdef OSG_USE_STDMATH
  return std::floor(rValue);
#else
...
inline typename TypeTraits<FloatTypeT>::RealReturnType osgceil(const FloatTypeT rValue) {
  ...
  return osgceil(RealType(rValue));
}

/*! \ingroup GrpBaseBaseMathFn
 */

inline Real32 osgceil(const Real32 rValue) {
#ifdef OSG_USE_STDMATH
...
inline Real64 osgceil(const Real64 rValue) {
#ifdef OSG_USE_STDMATH
  return std::ceil(rValue);
#else
  return ceil(rValue);
...
inline Real128 osgceil(const Real128 rValue) {
#ifdef OSG_USE_STDMATH
  return std::ceil(rValue);
#else
  return ceill(rValue);
...
inline TypeT osgMin(const TypeT lVal, const TypeT rValue) {
  return ((lVal < rValue) ? lVal : rValue);
}
...
inline Real32 osgdegree2rad(const Real32 rValue) {
...
inline Real64 osgdegree2rad(const Real64 rValue) {
...
inline Real32 osgrad2degree(const Real32 rValue) {
...
inline Real64 osgrad2degree(const Real64 rValue) {
...
inline bool osgispower2(Int32 rValue) {
  // find the lowest 1 bit
  while (rValue && !(rValue & 1)) {
    rValue >>= 1;
  }
...
inline Int32 osgnextpower2(Int32 rValue) {
...
inline Int64 osgnextpower2(Int64 rValue) {
...
template <>
inline UInt64 osgnextpower2<UInt64>(UInt64 rValue) {
...
inline size_t osgnextpower2(size_t rValue) {
...
indirector<ContentT, IndexT>::indirector(ContentT cont)
    : _cont(cont) {
}
...
inline UInt32 getMaxIndexAbs3(const VecPntT& v) {
  return osgabs(v[0]) > osgabs(v[1]) ? (osgabs(v[0]) > osgabs(v[2]) ? 0 : 2)
...
inline void osgsleep(UInt32 millisecs) {
  ...
  while ((req.tv_sec > 0 || req.tv_nsec > 0) && (ns = nanosleep(&req, &req)) < 0) {
    if (ns < 0 && errno != EINTR) {
      break;
    }
  }
...
inline UInt32 osghtonl(UInt32 src) {
  return ((src & 0x000000ff) << 24) | ((src & 0x0000ff00) << 8) | ((src & 0x00ff0000) >> 8) |
         ((src & 0xff000000) >> 24);
}

inline UInt64 osghtonll(UInt64 src) {
#ifdef OSG_LONGLONG_HAS_LL
  return ((src & 0x00000000000000ffLL) << 56) | ((src & 0x000000000000ff00LL) << 40) |
         ((src & 0x0000000000ff0000LL) << 24) | ((src & 0x00000000ff000000LL) << 8) |
         ((src & 0x000000ff00000000LL) >> 8) | ((src & 0x0000ff0000000000LL) >> 24) |
         ((src & 0x00ff000000000000LL) >> 40) | ((src & 0xff00000000000000LL) >> 56);
#else
  return ((src & 0x00000000000000ff) << 56) | ((src & 0x000000000000ff00) << 40) |
         ((src & 0x0000000000ff0000) << 24) | ((src & 0x00000000ff000000) << 8) |
         ((src & 0x000000ff00000000) >> 8) | ((src & 0x0000ff0000000000) >> 24) |
         ((src & 0x00ff000000000000) >> 40) | ((src & 0xff00000000000000) >> 56);
#endif
}
...
inline Real128 osgntohdd(Real128 src) {
  UInt8* p = (UInt8*)&src;
  std::swap(p[0], p[15]);
  std::swap(p[1], p[14]);
  std::swap(p[2], p[13]);
