...
class OSG_BASE_DLLMAPPING FrustumVolume : public Volume {
 ...
 public:
  ...
  FrustumVolume(void);
  FrustumVolume(const Plane& pnear, const Plane& pfar, const Plane& left, const Plane& right,
  ...
  void setPlanes(const Plane& pnear, const Plane& pfar, const Plane& left, const Plane& right,
      const Plane& top, const Plane& bottom);
  void setPlanes(const Pnt3f& nlt, const Pnt3f& nlb, const Pnt3f& nrt, const Pnt3f& nrb,
      const Pnt3f& flt, const Pnt3f& flb, const Pnt3f& frt, const Pnt3f& frb);
