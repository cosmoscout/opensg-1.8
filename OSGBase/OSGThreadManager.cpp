...
BaseThread* ThreadManager::getThread(const Char8* szName, const Char8* szTypeName) {
...
Barrier* ThreadManager::getBarrier(const Char8* szName, const Char8* szTypeName) {
...
Lock* ThreadManager::getLock(const Char8* szName, const Char8* szTypeName) {
...
LockPool* ThreadManager::getLockPool(const Char8* szName, const Char8* szTypeName) {
...
bool ThreadManager::init(void) {
  ...
  FFASSERT((_pAppThread != NULL), 1, ("OSGTM : could not get application thread \n");)
