...
DataType FieldDataTraits<std::string>::_type("string", "BaseType");
DataType FieldDataTraits1<Time>::_type("Time", "BaseType");
DataType FieldDataTraits<Color3f>::_type("Color3f", "BaseType");
DataType FieldDataTraits<Color4f>::_type("Color4f", "BaseType");
DataType FieldDataTraits<Color3ub>::_type("Color3ub", "BaseType");
DataType FieldDataTraits<Color4ub>::_type("Color4ub", "BaseType");
DataType FieldDataTraits<DynamicVolume>::_type("DynamicVolume", "BaseType");
DataType FieldDataTraits1<BitVector>::_type("BitVector", "BaseType");
DataType FieldDataTraits1<GLenum>::_type("GLenum", "BaseType");
