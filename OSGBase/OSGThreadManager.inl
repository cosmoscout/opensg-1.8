...
inline MPFieldStore<MPFieldT>::MPFieldStore(void) {
}
...
template <class MPFieldT>
inline MPFieldT* MPFieldStore<MPFieldT>::getMPField(const Char8* szName, const Char8* szTypeName) {
...
template <class MPFieldT>
inline MPFieldT* MPFieldStore<MPFieldT>::findMPField(const Char8* szName) {
  MPFieldMapIt gIt;
...
template <class MPFieldT>
inline void MPFieldStore<MPFieldT>::removeMPField(MPFieldT* pField) {
  if (pField == NULL)
    return;
...
template <class MPFieldT>
inline void MPFieldStore<MPFieldT>::clear(void) {
...
template <class MPFieldT>
inline typename MPFieldStore<MPFieldT>::MPFieldType* MPFieldStore<MPFieldT>::findMPFieldType(
...
template <class MPFieldT>
inline UInt32 MPFieldStore<MPFieldT>::registerMPType(MPFieldType* pType) {
  ...
  if (pTmp != NULL) {
    SLOG << "Error could not add second mp type with name " << pType->getCName() << std::endl;
