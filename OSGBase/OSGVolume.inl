...
inline void Volume::setStatic(const bool value) {
  if (value == true)
    _state |= OSGSTATIC;
  else
    _state &= ~OSGSTATIC;
...
inline bool Volume::isStatic(void) const {
  return (_state & OSGSTATIC) ? true : false;
}

/*! set the volume to be valid */

inline void Volume::setValid(const bool value) {
  if (!isStatic()) {
    if (value == true)
      _state |= OSGVALID;
    else
...
inline bool Volume::isValid(void) const {
  return (_state & OSGVALID) ? true : false;
}

/*! set the volume to contain nothing */

inline void Volume::setEmpty(const bool value) {
  if (value == true) {
    _state |= OSGEMPTY;
    _state |= OSGVALID;
    _state &= ~OSGINFINITE;
...
inline bool Volume::isEmpty(void) const {
  return (_state & OSGEMPTY) ? true : false;
}

/** set the volume to be infinite */

inline void Volume::setInfinite(const bool value) {
  if (value == true) {
    _state |= OSGINFINITE;
    _state |= OSGVALID;
    _state &= ~OSGEMPTY;
...
inline bool Volume::isInfinite(void) const {
...
inline bool Volume::isUntouchable(void) const {
  return (_state & (OSGINFINITE | OSGVALID | OSGSTATIC)) != OSGVALID;
}

/*! get the volume's state */

inline UInt16 Volume::getState(void) const {
  return _state;
}

/*! set the volume's state */

inline void Volume::setState(UInt16 val) {
  _state = val;
}
...
inline Pnt3f Volume::getMin(void) const {
  Pnt3f pmin;
  Pnt3f pmax;
...
inline Pnt3f Volume::getMax(void) const {
  Pnt3f pmin;
  Pnt3f pmax;
...
inline Volume::Volume(const Volume& obj)
    : _state(obj._state) {
}
