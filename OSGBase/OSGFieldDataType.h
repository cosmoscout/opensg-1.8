...
struct FieldTraitsRecurseBase : public FieldTraits {
  ...
  typedef typename osgIF<uiTest == 1, const FieldTypeT, const FieldTypeT&>::_IRet ArgumentType;
#else
  typedef typename osgIF<TypeTraits<FieldTypeT>::IsPOD, const FieldTypeT, const FieldTypeT&>::_IRet
      ArgumentType;
#endif
  ...
  static void copyToBin(
      BinaryDataHandler& pMem, const FieldTypeT* pObjectStore, UInt32 uiNumObjects) {
    typedef FieldDataTraits<FieldTypeT> MappedTrait;
...
#if defined(__hpuxX)
template <class FieldTypeT>
inline const UInt32 FieldTraitsRecurseBase<FieldTypeT>::uiTest;
#endif
...
#if defined(__hpuxX)
template <class FieldTypeT>
inline const UInt32 FieldTraitsRecurseBase1<FieldTypeT>::uiTest;
#endif
...
template <class FieldTypeT>
struct FieldTraitsIntegralRecurseMapper : public FieldTraitsRecurseBase<FieldTypeT> {
...
#pragma warning(disable : 4806)
  ...
  typedef typename osgIF<(bTypeHasParent == true), FieldDataTraits<Inherited>,
      FieldTraitsRecurseBase<FieldTypeT>>::_IRet MappedTrait;
...
#pragma warning(disable : 4806)
  ...
  typedef typename osgIF<bTypeHasParent == true, FieldDataTraits1<Inherited>,
      FieldTraitsRecurseBase<FieldTypeT>>::_IRet MappedTrait;
...
#pragma warning(disable : 4806)
  ...
  typedef typename osgIF<bTypeHasParent == true, FieldDataTraits2<Inherited>,
      FieldTraitsRecurseBase<FieldTypeT>>::_IRet MappedTrait;
